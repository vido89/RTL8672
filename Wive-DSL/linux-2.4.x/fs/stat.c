...
#if !defined(__alpha__) && !defined(__sparc__) && !defined(__ia64__) && !defined(CONFIG_ARCH_S390) && !defined(__hppa__) && !defined(__x86_64__) && !defined(__arm__) && !defined(CONFIG_V850)

/*
 * For backward compatibility?  Maybe this should be moved
 * into arch/i386 instead?
 */
#ifdef CONFIG_RTL867X_KERNEL_MIPS16_FS
__NOMIPS16
#endif
