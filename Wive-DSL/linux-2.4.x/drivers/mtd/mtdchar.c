/*
 * $Id: mtdchar.c,v 1.4 2007/09/10 12:07:27 jiunming Exp $
 *
		     ...
		     u_int cmd, u_long arg)
{
	...
	case MEMERASE:
	{
		...
		if (!erase) {
			...
			//printk("arg=0x%x arg+1=0x%x\n",*(u_long *)arg , *( (u_long *)(arg)+1)  );
	...
	case MEMWRITEDATA:
	{
		...
		ret = (mtd->write)(mtd, buf.start, buf.length, &retlen, databuf);
	...
	case MEMREADDATA:
	{
		...
		ret = (mtd->read)(mtd, buf.start, buf.length, &retlen, databuf);
