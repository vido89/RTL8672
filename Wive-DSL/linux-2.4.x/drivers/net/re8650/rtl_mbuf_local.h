...
struct poolstat
{
	...
	union
	{
		uint32     free_buffers;		   /* Total number of free buffers in pool */
		uint32     mbuf_types[MBUFTYPES];	/* per-type mbuf allocations, see mbuf.h, for _mppol only */
	}
	TYPE;
#define iFreebufs		TYPE.free_buffers
#define _iMbufTypes	_MbufStatus.TYPE.mbuf_types
