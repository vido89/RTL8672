...
* All rights reserved.
* 
* $Header: /usr/local/dslrepos/uClinux-dist/linux-2.4.x/drivers/net/re8650/rtl8651_asicRegs.h,v 1.1.1.1 2003/08/18 05:43:22 kaohj Exp $
*
* Abstract: ASIC specific definitions.
*
* $Author: kaohj $
*
* $Log: rtl8651_asicRegs.h,v $
...
#define ACTION_S_DROP               0x02
#define ACTION_S_CPU                0x03
#define ACTION_N_DROP               0x04
#define ACTION_N_CPU                0x05
...
#define INTPENDING_NIC_MASK     (RX_ERR_IP | TX_ERR_IP | TX_ALL_DONE_IP | RX_DONE_IP)
#define INTPENDING_RUN_OUT		(PKTHDR_DESC_RUNOUT_IP | MBUF_DESC_RUNOUT_IP)
...
#define BACKOFF_EXPONENTIAL_3_9		(1<<28)
#define ACPT_MAXLEN_1552_1536           (1 << 26)
...
#define BCR0                               (0x008 + MISC_BASE)     /* Bandwidth control */
#define BCR1                               (0x00C + MISC_BASE)     /* Bandwidth control */
...
#define ISTR                                 (0x001 + PPT_BASE)      /* Status register */
...
#define USBH0IE                             (1 << 30)       /* USB host 0 interrupt enable */
#define USBH1IE                             (1 << 29)       /* USB host 1 interrupt enable */
#define UART1IE                             (1 << 28)       /* UART 1 interrupt enable */
#define UART0IE                             (1 << 27)       /* UART 0 interrupt enable */
#define PPTIE                               (1 << 26)       /* Parallel port interrupt enable */
...
#define IREQ1IE                             (1 << 22)       /* External interrupt 1 enable */
...
#define USBH0IP                             (1 << 30)       /* USB host 0 interrupt pending */
#define USBH1IP                             (1 << 29)       /* USB host 1 interrupt pending */
#define UART1IP                             (1 << 28)       /* UART 1 interrupt pending */
#define UART0IP                             (1 << 27)       /* UART 0 interrupt pending */
#define PPTIP                               (1 << 26)       /* Parallel port interrupt pending */
...
#define IREQ1IP                             (1 << 22)       /* External interrupt 1 pending */
...
#define USB0IRS_OFFSET                      28              /* USB 0 interrupt routing select offset */
#define USB1IRS_OFFSET                      26              /* USB 1 interrupt routing select offset */
...
#define PPTIRS_OFFSET                       20              /* Parallel port interrupt routing select offset */
...
#define IREQ1RS_OFFSET                      12              /* External interrupt 1 routing select offset */
