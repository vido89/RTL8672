/*
  ...
  $Header: /usr/local/dslrepos/uClinux-dist/linux-2.4.x/drivers/scsi/osst.c,v 1.1.1.1 2003/08/18 05:43:14 kaohj Exp $
...
static const char * cvsid = "$Id: osst.c,v 1.1.1.1 2003/08/18 05:43:14 kaohj Exp $";
