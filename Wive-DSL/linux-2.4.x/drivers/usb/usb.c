	...
	*pdev = NULL;
	...
	usb_free_dev(dev);
        ...
        if(IS_6085)
                ...
                usb_led_port = udev->dev.bus_id[2] - '1';
#else
                usb_led_port = 1;
#endif
        usbled.d32 = REG32(USBLED);
        if(0 == usb_led_port)   //port 0 disconnect
                usbled.b.en_usb_led_0_n = USBLED_DISABLE;
        else            //port 1 disconnect
                usbled.b.en_usb_led_1_n = USBLED_DISABLE;
