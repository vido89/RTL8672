...
#if defined(CONFIG_SH_SNAPGEAR4100)
extern ledmap_t	sg4100_std;
extern leddef_t	sg4100_def;
static void sg4100_set(unsigned long bits);
#endif
...
#if defined(CONFIG_SH_SNAPGEAR4100)
	{ "std", sg4100_std, sg4100_def, ledman_bits, ledman_tick, sg4100_set, 1 },
#endif
...
/*
 *	For the SnapGear4100 and ATT Netgate4100, 7 operational LED's.
 *
 *	LED -   POWR  HBEAT  LAN1  LAN2 COM   ONL   VPN
...
static ledmap_t sg4100_std = {
	0x7f, 0x01, 0x02, 0x10, 0x10, 0x10, 0x10, 0x04,
	0x04, 0x08, 0x08, 0x00, 0x00, 0x00, 0x00, 0x54,
	0x28, 0x40, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00,
	0x00
};

static leddef_t	sg4100_def = {
	0x00, 0x01, 0x00, 0x02,
};
...
static void sg4100_set(unsigned long bits)
{
	...
	save_and_cli(flags);
	snapgear4100_led &= 0x80;
	snapgear4100_led |= (~bits & 0x7f);
	writeb(snapgear4100_led, SNAPGEAR_LED_ADDR);
	restore_flags(flags);
}
