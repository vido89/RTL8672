...
/*      Global vars.
 */
char ft_src[] __initdata = "$Source: /usr/local/dslrepos/uClinux-dist/linux-2.4.x/drivers/char/ftape/lowlevel/ftape-init.c,v $";
char ft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char ft_dat[] __initdata = "$Date: 2003/08/18 05:43:17 $";
