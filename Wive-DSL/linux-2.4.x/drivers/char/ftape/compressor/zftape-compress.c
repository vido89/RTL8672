 ...
 */
 ...
 char zftc_src[] ="$Source: /usr/local/dslrepos/uClinux-dist/linux-2.4.x/drivers/char/ftape/compressor/zftape-compress.c,v $";
 char zftc_rev[] = "$Revision: 1.1.1.1 $";
 char zftc_dat[] = "$Date: 2003/08/18 05:43:18 $";
