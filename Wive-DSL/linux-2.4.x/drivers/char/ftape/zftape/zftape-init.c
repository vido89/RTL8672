...
char zft_src[] __initdata = "$Source: /usr/local/dslrepos/uClinux-dist/linux-2.4.x/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2003/08/18 05:43:17 $";
