 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_ext_bits.c,v 1.1 2005/12/07 11:26:55 kaohj Exp $
 */
...
char pfkey_v2_ext_bits_c_version[] = "$Id: pfkey_v2_ext_bits.c,v 1.1 2005/12/07 11:26:55 kaohj Exp $";
