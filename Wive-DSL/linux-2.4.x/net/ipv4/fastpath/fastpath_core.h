...
*/
#define	__IRAM_GEN	__attribute__	((section(".iram")))
...
/* ---------------------------------------------------------------------------------------------------- */
enum LR_RESULT rtl865x_addArp( ip_t ip, ether_addr_t* mac, enum ARP_FLAGS flags );
enum LR_RESULT rtl865x_modifyArp( ip_t ip, ether_addr_t* mac, enum ARP_FLAGS flags );
