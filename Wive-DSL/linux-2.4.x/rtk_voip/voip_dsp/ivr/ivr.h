...
extern void PlayIvrDispatcher( void *pHeader, const void *user );
...
/* PCM handler mix speech wave into playout buffer. */
extern void MixIvrSpeechWaveToPlayoutBuffer( unsigned int chid, uint32 *pMixerTxBuffer );
