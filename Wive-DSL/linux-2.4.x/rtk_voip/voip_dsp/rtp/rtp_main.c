...
extern unsigned char MFFrameNo[MAX_SESS_NUM];
 ...
 #define CODEC_PAYLOAD_DESC_MAP_NUM	32	/* 32 includes most part of RtpPayloadType */
 
 static unsigned int idxMapCodecPayloadDesc[ CODEC_PAYLOAD_DESC_MAP_NUM ] = {
...
void rtp_SetConfig(uint32 chid, uint32 sid, RtpPayloadType uPktFormat, uint32 nFramePerPacket)
{
	...
	PRINT_MSG( pCodecPayloadDesc ->pszSetCodecPrompt );
