...
* $Id: types.h,v 1.2 2007/09/28 14:02:45 eric Exp $
* $Log: types.h,v $
* Revision 1.2  2007/09/28 14:02:45  eric
*
*    Commit for VoIP SDK update to 0.7b
*
* Revision 1.1  2006/07/19 08:01:12  qwert
* Qwert : new voip_dsp paths
*
* Revision 1.2  2006/07/04 06:00:29  thlin
* modify for RTCP use.
*
...
*
* Revision 1.1  2005/09/12 15:00:16  sandro
*
*  Committing in .
*
*  Added Files:
...
*  	rtl_queue.h rtl_types.h types.h voip_support.h
*
* Revision 1.1.1.1  2005/06/29 03:41:55  sandro
* Initial import.
*
