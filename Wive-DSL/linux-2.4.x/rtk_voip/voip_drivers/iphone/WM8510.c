...
void WM8510_init(void)
{
	...
	//set clock (BCLK)
	Audio_clock_setting(BCLK_FRAME_INPUTS, CLKSEL_MCLK, 7);
	...
	//Speaker_mixer_control(BYPASS2SPEAKER, 1, 0);
#elif defined(CONFIG_RTK_VOIP_GPIO_IPP_101)
	Speaker_mixer_control(BYPASS2SPEAKER, 1, 0);    //enable hand set sidetone
#endif
...
#if defined(CONFIG_RTK_VOIP_GPIO_IPP_100)
	Mono_mixer_control(BYPASS2MONO, 1, 0, 0);    //enable hand set sidetone
#elif defined(CONFIG_RTK_VOIP_GPIO_IPP_101)
	//Mono_mixer_control(BYPASS2MONO, 1, 0, 0);
#endif
	//enable mono mixer
