...
void output_ptreg_defines(void)
{
	...
	/*saved in lo/hi*/
	offset("#define PT_M0LL  ", struct pt_regs, radiax[0]);
	offset("#define PT_M0HL  ", struct pt_regs, radiax[1]);
	offset("#define PT_M3LL  ", struct pt_regs, radiax[2]);
	offset("#define PT_M3HL  ", struct pt_regs, radiax[3]);
	offset("#define PT_M03H  ", struct pt_regs, radiax[4]);
