...
//1/25/06' hrchen, limit block device max MAJOR nmuber, see vendor/Realtek/RTL8670/Makefile,
//"romX,b,31,X" has max major number=31
#define MAX_BLKDEV	36
