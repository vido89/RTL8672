...
/* all string process function will be defined in linux-2.4.x/lib/string.c */
#else
...
#endif /* #ifdef CONFIG_RTL867X_KERNEL_MIPS16 */
...
#ifdef CONFIG_RTL867X_KERNEL_MIPS16
/* memscan function will be defined in linux-2.4.x/lib/string.c */
#else
