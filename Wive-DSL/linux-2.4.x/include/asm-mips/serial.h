...
#if defined(CONFIG_RTL8601)
#include <asm/rtl8601/interrupt.h>
#define R8601_UART_REGS_BASE    (0xbd0100c3)
#define UART_REGS_BASE		R8601_UART_REGS_BASE 
#define R8601_BASE_BAUD 115200
#define UART_BASE_BAUD	R8601_BASE_BAUD 
#define R8601_BASE_BAUD_RATE (  R8601_BASE_BAUD / 16 ) 
#define R8601_INT_UART 	3
#define	RTL8601_SERIAL_PORT_DEFNS	\
{ 0,R8601_BASE_BAUD_RATE, R8601_UART_REGS_BASE, R8601_INT_UART, STD_COM_FLAGS,\
	type:PORT_16450},
#else
#define RTL8601_SERIAL_PORT_DEFNS
#endif
...
#define R8670_UART_REGS_BASE    (0xb8002000)
...
#define R8650_UART_REGS_BASE    (0xbd011100)
#define UART_REGS_BASE    	(0xbd011100)
#define R8650_BASE_BAUD 115200
//#define	UART_BASE_BAUD 115200
#define	UART_BASE_BAUD 57600
//#define R8650_BASE_BAUD 38400
#define R8650_BASE_BAUD_RATE (  R8650_BASE_BAUD / 16 ) 
#define	RTL8650_SERIAL_PORT_DEFNS	\
{ 0,R8650_BASE_BAUD_RATE, R8650_UART_REGS_BASE, ICU_UART0, STD_COM_FLAGS,\
	type:PORT_16550},
#else
#define RTL8650_SERIAL_PORT_DEFNS
#endif
