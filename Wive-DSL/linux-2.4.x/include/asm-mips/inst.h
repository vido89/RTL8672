...
#ifdef __MIPSEB__
struct i_format_16 {	/* Jump format */
	unsigned short opcode : 5;
	unsigned short immediate : 11;
};

struct ri_format_16 {	/* Immediate format (addi, lw, ...) */
	unsigned short opcode : 5;
	unsigned short rx : 3;
	unsigned short immediate : 8;
};

struct rri_format_16 {	/* Immediate format (addi, lw, ...) */
	unsigned short opcode : 5;
	unsigned short rs : 3;
	unsigned short rt : 3;
...
union mips16_instruction {
	...
	struct i_format_16 j_format;
	struct ri_format_16 ri_format;
	struct rri_format_16 rri_format;
};
