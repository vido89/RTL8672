...
/*__IRAM*/ static void reschedule_idle(struct task_struct * p)
{
#ifdef CONFIG_SMP
 ...
 */
/*__IRAM*/ static inline int try_to_wake_up(struct task_struct * p, int synchronous)
{
	unsigned long flags;
	int success = 0;
...
#ifdef CONFIG_RTL867X_KERNEL_MIPS16_KERNEL
__NOMIPS16
#endif
/*__IRAM*/ inline int wake_up_process(struct task_struct * p)
{
