...
extern void xcoff64_rtype2howto PARAMS ((arelent *, struct internal_reloc *));
...
static bfd_boolean xcoff64_write_object_contents PARAMS ((bfd *));
static bfd_boolean xcoff64_ppc_relocate_section
PARAMS ((bfd *, struct bfd_link_info *, bfd *, asection *, bfd_byte *,
	 struct internal_reloc *, struct internal_syment *, asection **));
static bfd_boolean xcoff64_slurp_armap PARAMS ((bfd *));
static const bfd_target *xcoff64_archive_p PARAMS ((bfd *));
static bfd *xcoff64_openr_next_archived_file PARAMS ((bfd *, bfd *));
static int xcoff64_sizeof_headers PARAMS ((bfd *, bfd_boolean));
static asection *xcoff64_create_csect_from_smclas
PARAMS ((bfd *, union internal_auxent *, const char *));
static bfd_boolean xcoff64_is_lineno_count_overflow PARAMS ((bfd *, bfd_vma));
static bfd_boolean xcoff64_is_reloc_count_overflow PARAMS ((bfd *, bfd_vma));
...
static bfd_boolean xcoff64_bad_format_hook PARAMS ((bfd *, PTR));

/* Relocation functions */
static bfd_boolean xcoff64_reloc_type_br PARAMS ((XCOFF_RELOC_FUNCTION_ARGS));
     ...
     bfd *abfd;
{
  ...
  internal_a.magic = (abfd->flags & D_PAGED
		      ? RS6K_AOUTHDR_ZMAGIC
		      : (abfd->flags & WP_TEXT
			 ? RS6K_AOUTHDR_NMAGIC : RS6K_AOUTHDR_OMAGIC));
     ...
     bfd *last_file;
{
  ...
  if ((xcoff_ardata (archive) == NULL) || !xcoff_big_format_p (archive))
    {
...
static reloc_howto_type xcoff64_dynamic_reloc = HOWTO (0,	/* type */
						       0,	/* rightshift */
						       4,	/* size (0 = byte, 1 = short, 2 = long) */
						       64,	/* bitsize */
						       FALSE,	/* pc_relative */
