...
static reloc_howto_type elf_howto_table[] = {
  ...
  HOWTO (R_390_TLS_GOTIE64, 0, 4, 64, FALSE, 0, complain_overflow_bitfield,
	 bfd_elf_generic_reloc, "R_390_TLS_GOTIE64", FALSE, 0, MINUS_ONE,
	 FALSE),
  ...
  HOWTO (R_390_TLS_LDM64, 0, 4, 64, FALSE, 0, complain_overflow_bitfield,
	 bfd_elf_generic_reloc, "R_390_TLS_LDM64", FALSE, 0, MINUS_ONE,
	 FALSE),
  ...
  HOWTO (R_390_TLS_LDO64, 0, 4, 64, FALSE, 0, complain_overflow_bitfield,
	 bfd_elf_generic_reloc, "R_390_TLS_LDO64", FALSE, 0, MINUS_ONE,
	 FALSE),
  HOWTO (R_390_TLS_DTPMOD, 0, 4, 64, FALSE, 0, complain_overflow_bitfield,
	 bfd_elf_generic_reloc, "R_390_TLS_DTPMOD", FALSE, 0, MINUS_ONE,
	 FALSE),
  HOWTO (R_390_TLS_DTPOFF, 0, 4, 64, FALSE, 0, complain_overflow_bitfield,
	 bfd_elf_generic_reloc, "R_390_TLS_DTPOFF", FALSE, 0, MINUS_ONE,
	 FALSE),
  HOWTO (R_390_TLS_TPOFF, 0, 4, 64, FALSE, 0, complain_overflow_bitfield,
	 bfd_elf_generic_reloc, "R_390_TLS_TPOFF", FALSE, 0, MINUS_ONE,
	 FALSE),
...
HOWTO (R_390_GNU_VTINHERIT, 0, 4, 0, FALSE, 0, complain_overflow_dont, NULL,
	...
	case R_390_TLS_LDCALL:
	  ...
	  if (r_type == R_390_TLS_LOAD)
	      ...
	      if (!info->shared && (h == NULL || h->dynindx == -1))
		{
		  ...
		  insn1 =
		    bfd_get_16 (input_bfd, contents + rel->r_offset + 4);
		  if (insn1 != 0x0004)
		    invalid_tls_insn (input_bfd, input_section, rel);
		  ry = 0;
	...
	abort ();
      ...
      bfd_put_64 (output_bfd,
		  (htab->splt->output_section->vma
		   + htab->splt->output_offset
		   + h->plt.offset
		   + 14), htab->sgotplt->contents + got_offset);
      ...
      rela.r_addend = 0;
      loc =
	htab->srelplt->contents + plt_index * sizeof (Elf64_External_Rela);
