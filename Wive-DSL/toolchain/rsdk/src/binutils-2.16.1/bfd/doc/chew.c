...
{
  char c;
  while ((c = at (src, idx)), isspace ((unsigned char) c) || (c == '*'
...
static void remchar (void), strip_trailing_newlines (void),
push_number (void);
