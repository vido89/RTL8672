...
static reloc_howto_type *lookup_howto PARAMS ((unsigned int rtype));
...
static bfd_boolean is_unwind_section_name PARAMS ((bfd * abfd, const char *));
...
PARAMS ((bfd * abfd, struct bfd_link_info * info, Elf_Internal_Sym * sym,
	 ...
	 bfd_vma * valp));
static int elfNN_ia64_additional_program_headers PARAMS ((bfd * abfd));
...
static int elfNN_ia64_local_dyn_sym_thunk PARAMS ((void **, PTR));
...
static long global_sym_index PARAMS ((struct elf_link_hash_entry * h));
...
PARAMS ((bfd * abfd, struct bfd_link_info * info,
	 struct elfNN_ia64_dyn_sym_info * dyn_i, bfd_vma value));
static bfd_vma set_pltoff_entry
PARAMS ((bfd * abfd, struct bfd_link_info * info,
	 struct elfNN_ia64_dyn_sym_info * dyn_i, bfd_vma value, bfd_boolean));
static bfd_vma elfNN_ia64_tprel_base PARAMS ((struct bfd_link_info * info));
static bfd_vma elfNN_ia64_dtprel_base PARAMS ((struct bfd_link_info * info));
static int elfNN_ia64_unwind_entry_compare PARAMS ((const PTR, const PTR));
...
static bfd_boolean elfNN_ia64_hpux_vec PARAMS ((const bfd_target * vec));
     ...
     bfd_reloc_code_real_type bfd_code;
{
  ...
  switch (bfd_code)
    ...
    case BFD_RELOC_IA64_DIR32MSB:
      rtype = R_IA64_DIR32MSB;
      break;
    case BFD_RELOC_IA64_DIR32LSB:
      rtype = R_IA64_DIR32LSB;
      break;
    case BFD_RELOC_IA64_DIR64MSB:
      rtype = R_IA64_DIR64MSB;
      break;
    case BFD_RELOC_IA64_DIR64LSB:
      rtype = R_IA64_DIR64LSB;
      break;

    case BFD_RELOC_IA64_GPREL22:
      rtype = R_IA64_GPREL22;
      break;
    case BFD_RELOC_IA64_GPREL64I:
      rtype = R_IA64_GPREL64I;
      break;
    case BFD_RELOC_IA64_GPREL32MSB:
      rtype = R_IA64_GPREL32MSB;
      break;
    case BFD_RELOC_IA64_GPREL32LSB:
      rtype = R_IA64_GPREL32LSB;
      break;
    case BFD_RELOC_IA64_GPREL64MSB:
      rtype = R_IA64_GPREL64MSB;
      break;
    case BFD_RELOC_IA64_GPREL64LSB:
      rtype = R_IA64_GPREL64LSB;
      break;

    case BFD_RELOC_IA64_LTOFF22:
      rtype = R_IA64_LTOFF22;
      break;
    case BFD_RELOC_IA64_LTOFF64I:
      rtype = R_IA64_LTOFF64I;
      break;
    ...
    case BFD_RELOC_IA64_PLTOFF64I:
      rtype = R_IA64_PLTOFF64I;
      break;
    case BFD_RELOC_IA64_PLTOFF64MSB:
      rtype = R_IA64_PLTOFF64MSB;
      break;
    case BFD_RELOC_IA64_PLTOFF64LSB:
      rtype = R_IA64_PLTOFF64LSB;
      break;
    case BFD_RELOC_IA64_FPTR64I:
      rtype = R_IA64_FPTR64I;
      break;
    case BFD_RELOC_IA64_FPTR32MSB:
      rtype = R_IA64_FPTR32MSB;
      break;
    case BFD_RELOC_IA64_FPTR32LSB:
      rtype = R_IA64_FPTR32LSB;
      break;
    case BFD_RELOC_IA64_FPTR64MSB:
      rtype = R_IA64_FPTR64MSB;
      break;
    case BFD_RELOC_IA64_FPTR64LSB:
      rtype = R_IA64_FPTR64LSB;
      break;

    case BFD_RELOC_IA64_PCREL21B:
      rtype = R_IA64_PCREL21B;
      break;
    case BFD_RELOC_IA64_PCREL21BI:
      rtype = R_IA64_PCREL21BI;
      break;
    case BFD_RELOC_IA64_PCREL21M:
      rtype = R_IA64_PCREL21M;
      break;
    case BFD_RELOC_IA64_PCREL21F:
      rtype = R_IA64_PCREL21F;
      break;
    case BFD_RELOC_IA64_PCREL22:
      rtype = R_IA64_PCREL22;
      break;
    case BFD_RELOC_IA64_PCREL60B:
      rtype = R_IA64_PCREL60B;
      break;
    case BFD_RELOC_IA64_PCREL64I:
      rtype = R_IA64_PCREL64I;
      break;
    case BFD_RELOC_IA64_PCREL32MSB:
      rtype = R_IA64_PCREL32MSB;
      break;
    case BFD_RELOC_IA64_PCREL32LSB:
      rtype = R_IA64_PCREL32LSB;
      break;
    case BFD_RELOC_IA64_PCREL64MSB:
      rtype = R_IA64_PCREL64MSB;
      break;
    case BFD_RELOC_IA64_PCREL64LSB:
      rtype = R_IA64_PCREL64LSB;
      break;

    case BFD_RELOC_IA64_LTOFF_FPTR22:
      rtype = R_IA64_LTOFF_FPTR22;
      break;
    case BFD_RELOC_IA64_LTOFF_FPTR64I:
      rtype = R_IA64_LTOFF_FPTR64I;
      break;
    case BFD_RELOC_IA64_LTOFF_FPTR32MSB:
      rtype = R_IA64_LTOFF_FPTR32MSB;
      break;
    case BFD_RELOC_IA64_LTOFF_FPTR32LSB:
      rtype = R_IA64_LTOFF_FPTR32LSB;
      break;
    case BFD_RELOC_IA64_LTOFF_FPTR64MSB:
      rtype = R_IA64_LTOFF_FPTR64MSB;
      break;
    case BFD_RELOC_IA64_LTOFF_FPTR64LSB:
      rtype = R_IA64_LTOFF_FPTR64LSB;
      break;

    case BFD_RELOC_IA64_SEGREL32MSB:
      rtype = R_IA64_SEGREL32MSB;
      break;
    case BFD_RELOC_IA64_SEGREL32LSB:
      rtype = R_IA64_SEGREL32LSB;
      break;
    case BFD_RELOC_IA64_SEGREL64MSB:
      rtype = R_IA64_SEGREL64MSB;
      break;
    case BFD_RELOC_IA64_SEGREL64LSB:
      rtype = R_IA64_SEGREL64LSB;
      break;

    case BFD_RELOC_IA64_SECREL32MSB:
      rtype = R_IA64_SECREL32MSB;
      break;
    case BFD_RELOC_IA64_SECREL32LSB:
      rtype = R_IA64_SECREL32LSB;
      break;
    case BFD_RELOC_IA64_SECREL64MSB:
      rtype = R_IA64_SECREL64MSB;
      break;
    case BFD_RELOC_IA64_SECREL64LSB:
      rtype = R_IA64_SECREL64LSB;
      break;

    case BFD_RELOC_IA64_REL32MSB:
      rtype = R_IA64_REL32MSB;
      break;
    case BFD_RELOC_IA64_REL32LSB:
      rtype = R_IA64_REL32LSB;
      break;
    case BFD_RELOC_IA64_REL64MSB:
      rtype = R_IA64_REL64MSB;
      break;
    case BFD_RELOC_IA64_REL64LSB:
      rtype = R_IA64_REL64LSB;
      break;

    case BFD_RELOC_IA64_LTV32MSB:
      rtype = R_IA64_LTV32MSB;
      break;
    case BFD_RELOC_IA64_LTV32LSB:
      rtype = R_IA64_LTV32LSB;
      break;
    case BFD_RELOC_IA64_LTV64MSB:
      rtype = R_IA64_LTV64MSB;
      break;
    case BFD_RELOC_IA64_LTV64LSB:
      rtype = R_IA64_LTV64LSB;
      break;

    case BFD_RELOC_IA64_IPLTMSB:
      rtype = R_IA64_IPLTMSB;
      break;
    case BFD_RELOC_IA64_IPLTLSB:
      rtype = R_IA64_IPLTLSB;
      break;
    case BFD_RELOC_IA64_COPY:
      rtype = R_IA64_COPY;
      break;
    case BFD_RELOC_IA64_LTOFF22X:
      rtype = R_IA64_LTOFF22X;
      break;
    ...
    case BFD_RELOC_IA64_TPREL14:
      rtype = R_IA64_TPREL14;
      break;
    case BFD_RELOC_IA64_TPREL22:
      rtype = R_IA64_TPREL22;
      break;
    case BFD_RELOC_IA64_TPREL64I:
      rtype = R_IA64_TPREL64I;
      break;
    case BFD_RELOC_IA64_TPREL64MSB:
      rtype = R_IA64_TPREL64MSB;
      break;
    case BFD_RELOC_IA64_TPREL64LSB:
      rtype = R_IA64_TPREL64LSB;
      break;
    case BFD_RELOC_IA64_LTOFF_TPREL22:
      rtype = R_IA64_LTOFF_TPREL22;
      break;

    case BFD_RELOC_IA64_DTPMOD64MSB:
      rtype = R_IA64_DTPMOD64MSB;
      break;
    case BFD_RELOC_IA64_DTPMOD64LSB:
      rtype = R_IA64_DTPMOD64LSB;
      break;
    case BFD_RELOC_IA64_LTOFF_DTPMOD22:
      rtype = R_IA64_LTOFF_DTPMOD22;
      break;

    case BFD_RELOC_IA64_DTPREL14:
      rtype = R_IA64_DTPREL14;
      break;
    case BFD_RELOC_IA64_DTPREL22:
      rtype = R_IA64_DTPREL22;
      break;
    case BFD_RELOC_IA64_DTPREL64I:
      rtype = R_IA64_DTPREL64I;
      break;
    case BFD_RELOC_IA64_DTPREL32MSB:
      rtype = R_IA64_DTPREL32MSB;
      break;
    case BFD_RELOC_IA64_DTPREL32LSB:
      rtype = R_IA64_DTPREL32LSB;
      break;
    case BFD_RELOC_IA64_DTPREL64MSB:
      rtype = R_IA64_DTPREL64MSB;
      break;
    case BFD_RELOC_IA64_DTPREL64LSB:
      rtype = R_IA64_DTPREL64LSB;
      break;
    case BFD_RELOC_IA64_LTOFF_DTPREL22:
      rtype = R_IA64_LTOFF_DTPREL22;
      break;
     ...
     bfd_boolean *again;
{
  ...
  *again = FALSE;
  ...
  if ((sec->flags & SEC_RELOC) == 0
      || sec->reloc_count == 0
      || (!link_info->need_relax_finalize && sec->need_finalize_relax == 0))
    return TRUE;
  ...
  for (irel = internal_relocs; irel < irelend; irel++)
      ...
      if (is_branch)
	{
	  ...
	  reladdr = (sec->output_section->vma
		     + sec->output_offset + roff) & (bfd_vma) - 4;
  ...
  if (changed_got)
    {
      ...
      elfNN_ia64_dyn_sym_traverse (ia64_info, allocate_global_data_got,
				   &data);
      elfNN_ia64_dyn_sym_traverse (ia64_info, allocate_global_fptr_got,
				   &data);
     ...
     bfd_vma *valp;
{
  if (sym->st_shndx == SHN_COMMON
      && !info->relocatable && sym->st_size <= elf_gp_size (abfd))
    {
     ...
     struct bfd_link_info *info ATTRIBUTE_UNUSED;
{
  ...
  if (s && (s->flags & SEC_LOAD))
      ...
      if (m == NULL)
	{
	  ...
	  while (*pm != NULL
		 && ((*pm)->p_type == PT_PHDR || (*pm)->p_type == PT_INTERP))
	    pm = &(*pm)->next;
...
elfNN_ia64_dynamic_symbol_p (h, info, r_type)
     ...
     int r_type;
{
  bfd_boolean ignore_protected = ((r_type & 0xf8) == 0x40	/* FPTR relocs */
  ...
  for (rel = relocs; rel < relend; ++rel)
      ...
      if (r_symndx >= symtab_hdr->sh_info)
	{
      ...
      if (h && ((!info->executable
		...
		|| !h->def_regular || h->root.type == bfd_link_hash_defweak))
	maybe_dynamic = TRUE;
	...
	continue;
      ...
      if ((need_entry & NEED_FPTR) != 0 && rel->r_addend)
	{
	  (*info->callbacks->warning)
...
allocate_global_data_got (dyn_i, data)
     ...
     PTR data;
{
  struct elfNN_ia64_allocate_data *x =
    (struct elfNN_ia64_allocate_data *) data;
     ...
     struct bfd_link_info *info;
{
  ...
  if (ia64_info->root.dynamic_sections_created && info->executable)
    {
     ...
     unsigned int r_type;
{
  ...
  switch (r_type)
    ...
    case R_IA64_PCREL21F:
      opnd = IA64_OPND_TGT25;
      break;
    case R_IA64_PCREL21M:
      opnd = IA64_OPND_TGT25b;
      break;
    case R_IA64_PCREL60B:
      opnd = IA64_OPND_TGT64;
      break;
    case R_IA64_PCREL21B:
    case R_IA64_PCREL21BI:
  ...
  switch (opnd)
    ...
    case IA64_OPND_TGT64:
      ...
      /* First, clear the bits that form the 64 bit constant.  */
      t0 &= ~(0x3ffffLL << 46);
      t1 &= ~(0x7fffffLL | ((1LL << 36 | 0xfffffLL << 13) << 23));
	...
	case 2:
	  ...
	  break;
	case 3:
	  return bfd_reloc_notsupported;	/* shouldn't happen...  */
	}
     ...
     unsigned int dyn_r_type;
{
  ...
  if (!done)
    {
	  ...
	  && (!dyn_i->want_ltoff_fptr
	      || !info->pie
	      || !dyn_i->h || dyn_i->h->root.type != bfd_link_hash_undefweak))
	{
	  if (dynindx == -1
  ...
  value = (got_sec->output_section->vma
	   + got_sec->output_offset + got_offset);
  ...
  if (!dyn_i->fptr_done)
      ...
      if (ia64_info->rel_fptr_sec)
	{
	  ...
	  outrel.r_offset = (fptr_sec->output_section->vma
			     + fptr_sec->output_offset + dyn_i->fptr_offset);
     ...
     bfd_boolean is_plt;
{
  ...
  if ((!dyn_i->want_plt || is_plt) && !dyn_i->pltoff_done)
    {
  ...
  value = (pltoff_sec->output_section->vma
	   + pltoff_sec->output_offset + dyn_i->pltoff_offset);
  ...
  if (gp
	  ...
	  || gp->root.type == bfd_link_hash_defweak))
    {
      ...
      gp_val = (gp->root.u.def.value
		+ gp_sec->output_section->vma + gp_sec->output_offset);
    }
  else
    {
	...
	gp_val = min_vma;
	  ...
	  && max_vma - gp_val <= 0x200000 && gp_val - min_vma > 0x200000)
     ...
     struct bfd_link_info *info;
{
  ...
  if (!info->relocatable)
      ...
      if (s)
	{
	  ...
	  unwind_output_sec->contents = bfd_malloc (unwind_output_sec->size);
  ...
  for (; rel < relend; ++rel)
	...
	case R_IA64_DIR64LSB:
	  ...
	  if ((dynamic_symbol_p || info->shared)
	      && r_symndx != 0 && (input_section->flags & SEC_ALLOC) != 0)
	    {
	      unsigned int dyn_r_type;
	      long dynindx;
	      bfd_vma addend;
	...
	case R_IA64_LTOFF64I:
	  ...
	  value =
	    set_got_entry (input_bfd, info, dyn_i, (h ? h->dynindx : -1),
  ...
  if (dyn_i && dyn_i->want_plt)
    {
      ...
      plt_addr = (plt_sec->output_section->vma
		  + plt_sec->output_offset + dyn_i->plt_offset);
      pltoff_addr =
	set_pltoff_entry (output_bfd, info, dyn_i, plt_addr, TRUE);
     ...
     bfd *ibfd, *obfd;
{
  ...
  if ((in_flags & EF_IA_64_BE) != (out_flags & EF_IA_64_BE))
    {
      (*_bfd_error_handler)
	(_("%B: linking big-endian files with little-endian files"), ibfd);
  ...
  if ((in_flags & EF_IA_64_ABI64) != (out_flags & EF_IA_64_ABI64))
    {
      (*_bfd_error_handler)
	(_("%B: linking 64-bit files with 32-bit files"), ibfd);
  ...
  if ((in_flags & EF_IA_64_CONS_GP) != (out_flags & EF_IA_64_CONS_GP))
    {
      (*_bfd_error_handler)
	(_("%B: linking constant-gp files with non-constant-gp files"), ibfd);
  ...
  if ((in_flags & EF_IA_64_NOFUNCDESC_CONS_GP)
    ...
    {
      (*_bfd_error_handler)
	(_("%B: linking auto-pic files with non-auto-pic files"), ibfd);
