...
static void MY (swap_ext_reloc_out) (abfd, g, natptr)
     bfd *
       abfd;
     arelent *
       g;
...
static void MY (swap_ext_reloc_in) (abfd, bytes, cache_ptr, symbols, symcount)
     bfd *
       abfd;
     struct reloc_ext_external *
       bytes;
       ...
       symcount;
{
  ...
  r_index = (bytes->r_index[2] << 16)
    | (bytes->r_index[1] << 8) | bytes->r_index[0];
...
static bfd_boolean MY (set_sizes) (abfd)
     bfd *
       abfd;
{
