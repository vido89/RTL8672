...
PARAMS ((bfd *, arelent *, asymbol *, PTR, asection *, bfd *, char **));
static reloc_howto_type *dlx_rtype_to_howto PARAMS ((unsigned int));
...
static reloc_howto_type elf_dlx_gnu_rel16_s2 = HOWTO (R_DLX_RELOC_16_PCREL,	/* type */
						      0,	/* rightshift */
						      1,	/* size (0 = byte, 1 = short, 2 = long) */
						      16,	/* bitsize */
						      TRUE,	/* pc_relative */
...
static reloc_howto_type elf_dlx_gnu_rel26_s2 = HOWTO (R_DLX_RELOC_26_PCREL,	/* type */
						      0,	/* rightshift */
						      2,	/* size (0 = byte, 1 = short, 2 = long) */
						      26,	/* bitsize */
						      TRUE,	/* pc_relative */
...
static reloc_howto_type elf_dlx_reloc_16_hi = HOWTO (R_DLX_RELOC_16_HI,	/* type */
						     16,	/* rightshift */
						     2,	/* size (0 = byte, 1 = short, 2 = long) */
						     32,	/* bitsize */
						     FALSE,	/* pc_relative */
...
static reloc_howto_type elf_dlx_reloc_16_lo = HOWTO (R_DLX_RELOC_16_LO,	/* type */
						     0,	/* rightshift */
						     1,	/* size (0 = byte, 1 = short, 2 = long) */
						     16,	/* bitsize */
						     FALSE,	/* pc_relative */
     ...
     char **error_message ATTRIBUTE_UNUSED;
{
  ...
  if (strcmp (input_section->name, symbol->section->output_section->name) !=
      0)
    {
      fprintf (stderr,
  ...
  val = (symbol->section->output_offset +
	 symbol->section->output_section->vma + symbol->value) - vallo;
