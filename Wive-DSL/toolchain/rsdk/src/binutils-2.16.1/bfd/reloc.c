...
bfd_check_overflow (enum complain_overflow how,
		    unsigned int bitsize,
		    unsigned int rightshift,
		    unsigned int addrsize, bfd_vma relocation)
{
			...
			bfd * output_bfd, char **error_message)
{
  ...
  if (bfd_is_und_section (symbol->section)
      && (symbol->flags & BSF_WEAK) == 0 && output_bfd == NULL)
			...
			asection * input_section, char **error_message)
{
  ...
  switch (howto->type)
    ...
    case 6:
      break;			/* R_MIPS_LO16 */
    case 38:			/* R_RELOC_OFF6A: used in ltw instruction */
      if ((relocation % 8) != 0)
...
HOWTO (0, 00, 2, 32, FALSE, 0, complain_overflow_bitfield, 0, "VRT32", FALSE,
					    ...
					    asymbol ** symbols)
{
  ...
  if (reloc_count > 0)
      ...
      for (parent = reloc_vector; *parent != NULL; parent++)
	{
	  ...
	  bfd_reloc_status_type r = bfd_perform_relocation (input_bfd,
							    *parent,
							    data,
							    input_section,
							    relocatable ? abfd
