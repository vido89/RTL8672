...
PARAMS ((bfd *, arelent *, Elf_Internal_Rela *));
static bfd_reloc_status_type bfd_elf_d30v_reloc PARAMS ((bfd * abfd,
							 arelent *
							 reloc_entry,
							 asymbol * symbol,
							 PTR data,
							 ...
							 char
							 **error_message));
static bfd_reloc_status_type bfd_elf_d30v_reloc_21
...
bfd_elf_d30v_reloc (abfd, reloc_entry, symbol, data, input_section,
     ...
     char **error_message;
{
  ...
  /* extract the addend */
  num = ((in2 & 0x3FFFF) | ((in2 & 0xFF00000) >> 2) | ((in1 & 0x3F) << 26));
  in1 &= 0xFFFFFFC0;
  in2 = 0x80000000;
...
static bfd_reloc_status_type
bfd_elf_d30v_reloc_21 (abfd, reloc_entry, symbol, data, input_section,
		       output_bfd, error_message)
     bfd *abfd;
     arelent *reloc_entry;
     asymbol *symbol;
     ...
     bfd_reloc_code_real_type code;
{
  ...
  for (i = 0;
       i < sizeof (d30v_reloc_map) / sizeof (struct d30v_reloc_map); i++)
    {
