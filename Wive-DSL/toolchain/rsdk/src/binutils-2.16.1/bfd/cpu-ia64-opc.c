...
static const char *
ins_immus8 (const struct ia64_operand *self, ia64_insn value,
	    ia64_insn * code)
{
  if (value & 0x7)
...
static const char *
ext_immus8 (const struct ia64_operand *self, ia64_insn code,
	    ia64_insn * valuep)
{
  const char *result;
...
static const char *
ins_immsu4 (const struct ia64_operand *self, ia64_insn value,
	    ia64_insn * code)
{
...
static const char *
ins_immsm1 (const struct ia64_operand *self, ia64_insn value,
	    ia64_insn * code)
{
  --value;
  return ins_imms_scaled (self, value, code, 0);
...
static const char *
ext_immsm1 (const struct ia64_operand *self, ia64_insn code,
	    ia64_insn * valuep)
{
...
static const char *
ext_imms1 (const struct ia64_operand *self, ia64_insn code,
	   ia64_insn * valuep)
{
...
static const char *
ext_imms4 (const struct ia64_operand *self, ia64_insn code,
	   ia64_insn * valuep)
{
...
static const char *
ins_imms16 (const struct ia64_operand *self, ia64_insn value,
	    ia64_insn * code)
{
...
static const char *
ext_imms16 (const struct ia64_operand *self, ia64_insn code,
	    ia64_insn * valuep)
{
...
static const char *
ext_cnt2b (const struct ia64_operand *self, ia64_insn code,
	   ia64_insn * valuep)
{
...
ins_cnt2c (const struct ia64_operand *self, ia64_insn value, ia64_insn * code)
{
  switch (value)
    ...
    case 16:
      ...
      break;
    default:
      return "count must be 0, 7, 15, or 16";
    }
  *code |= value << self->field[0].shift;
  return 0;
}
...
ins_inc3 (const struct ia64_operand *self, ia64_insn value, ia64_insn * code)
{
  ...
  switch (value)
    ...
    case 16:
      ...
      break;
    default:
      return "count must be +/- 1, 4, 8, or 16";
    }
