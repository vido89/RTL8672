...
static bfd_reloc_status_type iq2000_elf_howto_hi16_reloc (bfd *, arelent *,
							  asymbol *, void *,
							  asection *, bfd *,
							  char **);

...
static reloc_howto_type iq2000_elf_vtinherit_howto = HOWTO (R_IQ2000_GNU_VTINHERIT,	/* type */
							    0,	/* rightshift */
							    2,	/* size (0 = byte, 1 = short, 2 = long) */
							    0,	/* bitsize */
							    FALSE,	/* pc_relative */
...
static reloc_howto_type iq2000_elf_vtentry_howto = HOWTO (R_IQ2000_GNU_VTENTRY,	/* type */
							  0,	/* rightshift */
							  2,	/* size (0 = byte, 1 = short, 2 = long) */
							  0,	/* bitsize */
							  FALSE,	/* pc_relative */
  ...
  for (rel = relocs; rel < relend; rel++)
    {
      ...
      if (r_type == R_IQ2000_GNU_VTINHERIT || r_type == R_IQ2000_GNU_VTENTRY)
	continue;
