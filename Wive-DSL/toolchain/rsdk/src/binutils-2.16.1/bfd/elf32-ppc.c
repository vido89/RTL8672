...
ppc_elf_howto_init (void)
{
  ...
  for (i = 0;
       i < sizeof (ppc_elf_howto_raw) / sizeof (ppc_elf_howto_raw[0]); i++)
    {
		       ...
		       struct bfd_link_info *link_info, bfd_boolean * again)
{
  ...
  *again = FALSE;
  ...
  if ((isec->flags & SEC_ALLOC) == 0
      || (isec->flags & SEC_RELOC) == 0 || isec->reloc_count == 0)
    return TRUE;
  ...
  for (irel = internal_relocs; irel < irelend; irel++)
      ...
      else
	{
	  ...
	  if (r_type == R_PPC_PLTREL24
	      && ppc_info->plt != NULL && h->plt.offset != (bfd_vma) - 1)
	    {
	      tsec = ppc_info->plt;
	      toff = h->plt.offset;
	    }
			   ...
			   bfd_reloc_code_real_type code)
{
  ...
  switch (code)
    ...
    case BFD_RELOC_PPC_BA16_BRTAKEN:
      r = R_PPC_ADDR14_BRTAKEN;
      break;
    case BFD_RELOC_PPC_BA16_BRNTAKEN:
      r = R_PPC_ADDR14_BRNTAKEN;
      break;
    ...
    case BFD_RELOC_PPC_B16_BRTAKEN:
      r = R_PPC_REL14_BRTAKEN;
      break;
    case BFD_RELOC_PPC_B16_BRNTAKEN:
      r = R_PPC_REL14_BRNTAKEN;
      break;
    ...
    case BFD_RELOC_PPC_GOT_TLSGD16_LO:
      r = R_PPC_GOT_TLSGD16_LO;
      break;
    case BFD_RELOC_PPC_GOT_TLSGD16_HI:
      r = R_PPC_GOT_TLSGD16_HI;
      break;
    case BFD_RELOC_PPC_GOT_TLSGD16_HA:
      r = R_PPC_GOT_TLSGD16_HA;
      break;
    ...
    case BFD_RELOC_PPC_GOT_TLSLD16_HI:
      r = R_PPC_GOT_TLSLD16_HI;
      break;
    case BFD_RELOC_PPC_GOT_TLSLD16_HA:
      r = R_PPC_GOT_TLSLD16_HA;
      break;
    case BFD_RELOC_PPC_GOT_TPREL16:
      r = R_PPC_GOT_TPREL16;
      break;
    case BFD_RELOC_PPC_GOT_TPREL16_LO:
      r = R_PPC_GOT_TPREL16_LO;
      break;
    case BFD_RELOC_PPC_GOT_TPREL16_HI:
      r = R_PPC_GOT_TPREL16_HI;
      break;
    case BFD_RELOC_PPC_GOT_TPREL16_HA:
      r = R_PPC_GOT_TPREL16_HA;
      break;
    case BFD_RELOC_PPC_GOT_DTPREL16:
      r = R_PPC_GOT_DTPREL16;
      break;
    case BFD_RELOC_PPC_GOT_DTPREL16_LO:
      r = R_PPC_GOT_DTPREL16_LO;
      break;
    case BFD_RELOC_PPC_GOT_DTPREL16_HI:
      r = R_PPC_GOT_DTPREL16_HI;
      break;
    case BFD_RELOC_PPC_GOT_DTPREL16_HA:
      r = R_PPC_GOT_DTPREL16_HA;
      break;
    ...
    case BFD_RELOC_PPC_EMB_NADDR16_LO:
      r = R_PPC_EMB_NADDR16_LO;
      break;
    case BFD_RELOC_PPC_EMB_NADDR16_HI:
      r = R_PPC_EMB_NADDR16_HI;
      break;
    case BFD_RELOC_PPC_EMB_NADDR16_HA:
      r = R_PPC_EMB_NADDR16_HA;
      break;
    ...
    case BFD_RELOC_PPC_EMB_RELSEC16:
      r = R_PPC_EMB_RELSEC16;
      break;
    case BFD_RELOC_PPC_EMB_RELST_LO:
      r = R_PPC_EMB_RELST_LO;
      break;
    case BFD_RELOC_PPC_EMB_RELST_HI:
      r = R_PPC_EMB_RELST_HI;
      break;
    case BFD_RELOC_PPC_EMB_RELST_HA:
      r = R_PPC_EMB_RELST_HA;
      break;
...
ppc_elf_merge_private_bfd_data (bfd * ibfd, bfd * obfd)
{
  ...
  if (!is_ppc_elf_target (ibfd->xvec) || !is_ppc_elf_target (obfd->xvec))
    return TRUE;
  ...
  /* Incompatible flags.  */
	  ...
	  && (old_flags & (EF_PPC_RELOCATABLE | EF_PPC_RELOCATABLE_LIB)) == 0)
	{
      ...
      else if ((new_flags & (EF_PPC_RELOCATABLE | EF_PPC_RELOCATABLE_LIB)) ==
	       0 && (old_flags & EF_PPC_RELOCATABLE) != 0)
	{
	  error = TRUE;
	  (*_bfd_error_handler)
	...
	elf_elfheader (obfd)->e_flags |= EF_PPC_RELOCATABLE;
      ...
      new_flags &=
	~(EF_PPC_RELOCATABLE | EF_PPC_RELOCATABLE_LIB | EF_PPC_EMB);
      old_flags &=
	~(EF_PPC_RELOCATABLE | EF_PPC_RELOCATABLE_LIB | EF_PPC_EMB);
...
static bfd_boolean
ppc_elf_section_from_shdr (bfd * abfd, Elf_Internal_Shdr * hdr,
			   const char *name)
{
  asection *newsect;
  flagword flags;
...
static elf_linker_section_pointers_t *elf_find_pointer_linker_section
  (elf_linker_section_pointers_t * linker_pointers,
   bfd_vma addend, elf_linker_section_t * lsect)
{
				   ...
				   int relative_reloc)
{
  ...
  relocation = (lsect->section->output_offset
		+ linker_section_ptr->offset - lsect->sym_offset);
  ...
  if (s == NULL || (s->flags & flags) != flags)
    {
      ...
      if (s == NULL || !bfd_set_section_flags (htab->elf.dynobj, s, flags))
	return NULL;
      if (sym_sec == NULL)
	sym_sec = s;
    }
...
#endif
      bh = bfd_link_hash_lookup (info->hash, sym_name, FALSE, FALSE, FALSE);
...
ppc_elf_create_dynamic_sections (bfd * abfd, struct bfd_link_info *info)
{
  ...
  if (htab->got == NULL && !ppc_elf_create_got (abfd, info))
    return FALSE;
...
allocate_dynrelocs (struct elf_link_hash_entry *h, void *inf)
{
  ...
  if (eh->elf.got.refcount > 0)
    {
      /* Make sure this symbol is output as a dynamic symbol.  */
      if (eh->elf.dynindx == -1 && !eh->elf.forced_local)
	{
	  if (!bfd_elf_link_record_dynamic_symbol (info, &eh->elf))
	    return FALSE;
	}

      if (eh->tls_mask == (TLS_TLS | TLS_LD) && !eh->elf.def_dynamic)
  ...
  if (info->shared)
	...
	eh->dyn_relocs = NULL;
	  ...
	  && eh->dyn_relocs != NULL
	  && h->dynindx == -1
	  && h->root.type == bfd_link_hash_undefweak && !h->forced_local)
	{
	  if (!bfd_elf_link_record_dynamic_symbol (info, h))
	    return FALSE;
	}
  ...
  if (h->plt.offset != (bfd_vma) - 1)
    {
      ...
      rela.r_offset = (htab->plt->output_section->vma
		       + htab->plt->output_offset + h->plt.offset);
...
static bfd_boolean
ppc_elf_finish_dynamic_sections (bfd * output_bfd, struct bfd_link_info *info)
{
  asection *sdyn;
  struct ppc_elf_link_hash_table *htab;
			  ...
			  asection ** local_sections)
{
  ...
  for (; rel < relend; rel++)
	...
	dogot:
	  {
		...
		do
		  {
			...
			outrel.r_offset = (htab->got->output_section->vma
					   + htab->got->output_offset + off);
			outrel.r_addend = 0;
			if (tls_ty & (TLS_LD | TLS_GD))
			  {
			    outrel.r_info =
			      ELF32_R_INFO (indx, R_PPC_DTPMOD32);
		...
		*offp = off | 1;
		...
		(_("%B(%A+0x%lx): non-zero addend on %s reloc against `%s'"),
		 input_bfd,
		 input_section, (long) rel->r_offset, howto->name, sym_name);
	  }
	  break;
	      ...
	      if (sreloc == NULL)
		{
		  ...
		  name = (bfd_elf_string_from_elf_section
			  (input_bfd,
			   ...
			   elf_section_data (input_section)->rel_hdr.
			   sh_name));
		  if (name == NULL)
		    return FALSE;
	...
	case R_PPC_RELAX32_PLT:
	  BFD_ASSERT (h != NULL
		      && h->plt.offset != (bfd_vma) - 1 && htab->plt != NULL);
	...
	case R_PPC_RELAX32PC:
	  relocation -= (input_section->output_section->vma
			 + input_section->output_offset + rel->r_offset - 4);
	  /* Fall thru */
	...
	case R_PPC_PLTREL24:
	  ...
	  if (h->plt.offset == (bfd_vma) - 1 || htab->plt == NULL)
	    {
	...
	case R_PPC_SDAREL16:
	  {
		...
		(*_bfd_error_handler)
		  (_("%B: the target (%s) of a %s relocation is "
		   ...
		   input_bfd, sym_name, howto->name, name);
	      }
	...
	case R_PPC_EMB_RELSDA:
	  {
		...
		insn = bfd_get_32 (output_bfd, contents + rel->r_offset);
		insn =
		  (insn & ~RA_REGISTER_MASK) | (reg << RA_REGISTER_SHIFT);
		bfd_put_32 (output_bfd, insn, contents + rel->r_offset);
	      }
	  }
	  break;
	...
	case R_PPC_EMB_RELST_HA:
      ...
      fprintf (stderr, "\ttype = %s (%d), name = %s, symbol index = %ld, "
	       ...
	       howto->name,
	       (int) r_type,
	       sym_name, r_symndx, (long) rel->r_offset, (long) addend);
#endif
...
apuinfo_list_length (void)
{
  ...
  for (entry = head, count = 0; entry; entry = entry->next)
    ++count;
...
apuinfo_list_element (unsigned long number)
{
  ...
  for (entry = head; entry && number--; entry = entry->next)
    ;
...
ppc_elf_write_section (bfd * abfd ATTRIBUTE_UNUSED,
		       asection * asec, bfd_byte * contents ATTRIBUTE_UNUSED)
{
