...
static void
MY (set_arch_mach)
PARAMS ((bfd * abfd, unsigned long machtype));
...
#include "aout-target.h"
  ...
  PARAMS ((bfd *, sec_ptr, arelent **, asymbol **));
     ...
     static void MY (set_arch_mach) (abfd, machtype)
     bfd *abfd;
...
static void MY (choose_reloc_size) (abfd)
     bfd *
       abfd;
{
...
static reloc_howto_type *MY (reloc_howto_type_lookup) (abfd, code)
     bfd *
       abfd;
...
static const struct aout_backend_data MY (backend_data) =
{
  0,				/* zmagic contiguous */
    ...
    MY_set_sizes, 0,		/* text size includes exec header */
