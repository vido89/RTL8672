...
/* The file @code{aoutf1.h} contains the code for BFD's
   ...
   @end table  */
     ...
     void NAME (lynx, set_arch_mach) (abfd, machtype)
     bfd *abfd;
...
static bfd_boolean NAME (aout, sparclynx_write_object_contents) (abfd)
     bfd *
       abfd;
{
