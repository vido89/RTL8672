...
static bfd_boolean
simple_dummy_undefined_symbol (struct bfd_link_info *link_info
			       ATTRIBUTE_UNUSED,
...
static bfd_boolean
simple_dummy_reloc_dangerous (struct bfd_link_info *link_info
			      ATTRIBUTE_UNUSED,
...
static bfd_boolean
simple_dummy_unattached_reloc (struct bfd_link_info *link_info
			       ATTRIBUTE_UNUSED,
			       const char *name ATTRIBUTE_UNUSED,
			       bfd * abfd ATTRIBUTE_UNUSED,
			       asection * section ATTRIBUTE_UNUSED,
...
static bfd_boolean
simple_dummy_multiple_definition (struct bfd_link_info *link_info
				  ATTRIBUTE_UNUSED,
				  const char *name ATTRIBUTE_UNUSED,
