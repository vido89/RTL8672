...
static bfd_boolean elf32_sparc_new_section_hook PARAMS ((bfd *, asection *));
...
PARAMS ((bfd *, struct bfd_link_info *));
static bfd_boolean elf32_sparc_merge_private_bfd_data PARAMS ((bfd *, bfd *));
...
static bfd_boolean elf32_sparc_mkobject PARAMS ((bfd *));
static bfd_boolean elf32_sparc_object_p PARAMS ((bfd *));
static void elf32_sparc_final_write_processing PARAMS ((bfd *, bfd_boolean));
...
reloc_howto_type _bfd_sparc_elf_howto_table[] = {
  ...
  HOWTO (R_SPARC_64, 0, 0, 00, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_64", FALSE, 0, 0x00000000,
	 TRUE),
  HOWTO (R_SPARC_OLO10, 0, 0, 00, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_OLO10", FALSE, 0, 0x00000000,
	 TRUE),
  HOWTO (R_SPARC_HH22, 0, 0, 00, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_HH22", FALSE, 0, 0x00000000,
	 TRUE),
  HOWTO (R_SPARC_HM10, 0, 0, 00, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_HM10", FALSE, 0, 0x00000000,
	 TRUE),
  HOWTO (R_SPARC_LM22, 0, 0, 00, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_LM22", FALSE, 0, 0x00000000,
	 TRUE),
  HOWTO (R_SPARC_PC_HH22, 0, 0, 00, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_PC_HH22", FALSE, 0,
	 0x00000000, TRUE),
  HOWTO (R_SPARC_PC_HM10, 0, 0, 00, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_PC_HM10", FALSE, 0,
	 0x00000000, TRUE),
  HOWTO (R_SPARC_PC_LM22, 0, 0, 00, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_PC_LM22", FALSE, 0,
	 0x00000000, TRUE),
  ...
  HOWTO (R_SPARC_NONE, 0, 0, 0, FALSE, 0, complain_overflow_dont,
	 bfd_elf_generic_reloc, "R_SPARC_NONE", FALSE, 0, 0x00000000, TRUE),
  HOWTO (R_SPARC_UA64, 0, 0, 0, FALSE, 0, complain_overflow_dont,
	 sparc_elf_notsupported_reloc, "R_SPARC_UA64", FALSE, 0, 0x00000000,
	 TRUE),
  ...
  HOWTO (R_SPARC_TLS_DTPOFF32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	 ...
	 TRUE),
  HOWTO (R_SPARC_TLS_DTPOFF64, 0, 0, 0, FALSE, 0, complain_overflow_dont,
	 bfd_elf_generic_reloc, "R_SPARC_TLS_DTPOFF64", FALSE, 0, 0x00000000,
	 TRUE),
...
HOWTO (R_SPARC_GNU_VTINHERIT, 0, 2, 0, FALSE, 0, complain_overflow_dont, NULL,
       "R_SPARC_GNU_VTINHERIT", FALSE, 0, 0, FALSE);
static reloc_howto_type elf32_sparc_vtentry_howto =
HOWTO (R_SPARC_GNU_VTENTRY, 0, 2, 0, FALSE, 0, complain_overflow_dont,
       _bfd_elf_rel_vtable_reloc_fn, "R_SPARC_GNU_VTENTRY", FALSE, 0, 0,
       FALSE);
static reloc_howto_type elf32_sparc_rev32_howto =
HOWTO (R_SPARC_REV32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
       bfd_elf_generic_reloc, "R_SPARC_REV32", FALSE, 0, 0xffffffff, TRUE);
     ...
     bfd_reloc_code_real_type code;
{
  ...
  switch (code)
    ...
    default:
      for (i = 0;
	   i < sizeof (sparc_reloc_map) / sizeof (struct elf_reloc_map); i++)
	{
     ...
     Elf_Internal_Rela *dst;
{
  switch (ELF32_R_TYPE (dst->r_info))
    ...
    default:
      BFD_ASSERT (ELF32_R_TYPE (dst->r_info) <
		  (unsigned int) R_SPARC_max_std);
      cache_ptr->howto =
	&_bfd_sparc_elf_howto_table[ELF32_R_TYPE (dst->r_info)];
    }
}

     ...
     char **error_message ATTRIBUTE_UNUSED;
{
  ...
  x |= ((((relocation >> 2) & 0xc000) << 6) | ((relocation >> 2) & 0x3fff));
...
elf32_sparc_tls_transition (info, abfd, r_type, is_local)
     ...
     int is_local;
{
  if (r_type == R_SPARC_TLS_GD_HI22 && !elf32_sparc_tdata (abfd)->has_tlsgd)
  ...
  for (rel = relocs; rel < rel_end; rel++)
	...
	case R_SPARC_TLS_GD_LO10:
	  /* This symbol requires a global offset table entry.  */
	  {
		...
		old_tls_type =
		  elf32_sparc_local_got_tls_type (abfd)[r_symndx];
	      }
	...
	r_sparc_plt32:
	  ...
	  if ((info->shared
	      ...
	      if (sreloc == NULL)
		{
	      ...
	      if (h != NULL)
		head =
		  &((struct elf32_sparc_link_hash_entry *) h)->dyn_relocs;
	      else
		{
  ...
  for (; rel < relend; rel++)
    {
      ...
      if (r_type == R_SPARC_GNU_VTINHERIT || r_type == R_SPARC_GNU_VTENTRY)
	continue;
  ...
  if (h->plt.offset != (bfd_vma) - 1)
    {
      ...
      loc = srela->contents;
      loc +=
	(h->plt.offset / PLT_ENTRY_SIZE - 4) * sizeof (Elf32_External_Rela);
