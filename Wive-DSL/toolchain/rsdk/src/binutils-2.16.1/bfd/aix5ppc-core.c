...
bfd_boolean xcoff64_core_file_matches_executable_p PARAMS ((bfd *, bfd *));
     ...
     bfd *abfd;
{
  ...
  if ((CORE_VERSION_1 != (core.c_flag & CORE_VERSION_1))
      ...
      || (!(core.c_flag & UBLOCK_VALID)) || (!(core.c_flag & LE_VALID)))
    goto xcoff64_core_p_error;

  /* Check for truncated stack or general truncating.  */
  if ((!(core.c_flag & USTACK_VALID)) || (core.c_flag & CORE_TRUNC))
    {
