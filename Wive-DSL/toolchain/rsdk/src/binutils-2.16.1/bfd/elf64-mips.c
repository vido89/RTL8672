...
/* 16 bit offset for pc-relative branches.  */
static reloc_howto_type elf_mips_gnu_rela16_s2 = HOWTO (R_MIPS_GNU_REL16_S2,	/* type */
							2,	/* rightshift */
							2,	/* size (0 = byte, 1 = short, 2 = long) */
							16,	/* bitsize */
							TRUE,	/* pc_relative */
			     ...
			     Elf_Internal_Rela * dst)
{
  ...
  mips_elf64_swap_reloc_in (abfd,
			    (const Elf64_Mips_External_Rel *) src, &mirel);
			      ...
			      Elf_Internal_Rela * dst)
{
  ...
  mips_elf64_swap_reloca_in (abfd,
			     (const Elf64_Mips_External_Rela *) src, &mirela);
			      ...
			      bfd_byte * dst)
{
  ...
  mips_elf64_swap_reloc_out (abfd, &mirel, (Elf64_Mips_External_Rel *) dst);
}
...
mips_elf64_final_gp (bfd * output_bfd, asymbol * symbol,
				  ...
				  bfd_boolean dynamic)
{
  ...
  for (i = 0, relent = relents;
       i < reloc_count; i++, native_relocs += entsize)
    {
...
mips_elf64_write_rel (bfd * abfd, asection * sec,
		      Elf_Internal_Shdr * rel_hdr, int *count, void *data)
{
  bfd_boolean *failedp = data;
