...
PARAMS ((bfd *));
     ...
     reloc_howto_type *riscix_reloc_type_lookup
       PARAMS ((bfd *, bfd_reloc_code_real_type));

     void
       riscix_swap_std_reloc_out
       PARAMS ((bfd *, arelent *, struct reloc_std_external *));

bfd_boolean riscix_squirt_out_relocs PARAMS ((bfd *, asection *));

     long
     MY (canonicalize_reloc)
PARAMS ((bfd *, sec_ptr, arelent **, asymbol **));
     ...
     static reloc_howto_type
       ...
       HOWTO (3, 2, 3, 26, TRUE, 0, complain_overflow_signed,
	      riscix_fix_pcrel_26, "ARM26", TRUE, 0x00ffffff, 0x00ffffff,
	      FALSE),
       ...
       HOWTO (7, 2, 3, 26, FALSE, 0, complain_overflow_signed,
	      riscix_fix_pcrel_26_done, "ARM26D", TRUE, 0x00ffffff,
	      0x00ffffff, FALSE),
       EMPTY_HOWTO (-1),
...
static const bfd_target *MY (object_p) (abfd)
     bfd *
       abfd;
{
