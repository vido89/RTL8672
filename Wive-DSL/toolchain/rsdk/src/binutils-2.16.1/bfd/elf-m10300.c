...
void _bfd_mn10300_elf_final_write_processing PARAMS ((bfd *, bfd_boolean));
bfd_boolean _bfd_mn10300_elf_object_p PARAMS ((bfd *));
bfd_boolean _bfd_mn10300_elf_merge_private_bfd_data PARAMS ((bfd *, bfd *));
  ...
  switch (r_type)
      ...
      if (info->shared && (input_section->flags & SEC_ALLOC) != 0)
	{
	  ...
	  bfd_elf32_swap_reloca_out (output_bfd, &outrel,
				     (bfd_byte
				      *) (((Elf32_External_Rela *) sreloc->
					   contents) + sreloc->reloc_count));
	  ++sreloc->reloc_count;
    ...
    case R_MN10300_GOTPC32:
      ...
      value = bfd_get_section_by_name (dynobj, ".got")->output_section->vma;
      value -= (input_section->output_section->vma
		+ input_section->output_offset);
      value -= offset;
      value += addend;
	  ...
	  && h->plt.offset != (bfd_vma) - 1)
	{
	  ...
	  value = (splt->output_section->vma
		   + splt->output_offset + h->plt.offset) - value;
	}
     ...
     PTR in_args;
{
  ...
  if (entry->root.root.type == bfd_link_hash_warning)
    entry =
      (struct elf32_mn10300_link_hash_entry *) entry->root.root.u.i.link;
	   ...
	   input_bfd != NULL; input_bfd = input_bfd->link_next)
	{
	  ...
	  for (section = input_bfd->sections;
		  ...
		  && section->reloc_count != 0)
		{
		  ...
		  for (; irel < irelend; irel++)
		      ...
		      if (r_index < symtab_hdr->sh_info)
			{
			  ...
			  sprintf (new_name, "%s_%08x", sym_name,
				   sym_sec->id);
			  sym_name = new_name;
		...
		free (internal_relocs);
	      ...
	      if (contents != NULL
		  && elf_section_data (section)->this_hdr.contents !=
		  contents)
		{
	  ...
	  || ELF32_R_TYPE (irel->r_info) == (int) R_MN10300_PLT32)
	{
	  ...
	  if (ELF32_R_TYPE (irel->r_info) == (int) R_MN10300_PLT32
	      ...
	      && h->root.plt.offset != (bfd_vma) - 1)
	    {
	      ...
	      splt =
		bfd_get_section_by_name (elf_hash_table (link_info)->dynobj,
					 ".plt");
	  ...
	  || ELF32_R_TYPE (irel->r_info) == (int) R_MN10300_GOTPC32)
	{
	  ...
	  if (ELF32_R_TYPE (irel->r_info) != (int) R_MN10300_32)
	      ...
	      if (ELF32_R_TYPE (irel->r_info) == (int) R_MN10300_GOT32)
		{
	      ...
	      else if (ELF32_R_TYPE (irel->r_info) ==
     ...
     struct bfd_link_hash_table *hash;
{
  ...
  _bfd_generic_link_hash_table_free ((struct bfd_link_hash_table *) ret);
}
     ...
     bfd *abfd;
{
  bfd_default_set_arch_mach (abfd, bfd_arch_mn10300,
			     elf_mn10300_mach (elf_elfheader (abfd)->
					       e_flags));
  return TRUE;
}
  ...
  if (h->plt.offset != (bfd_vma) - 1)
      ...
      else
	{
      ...
      bfd_elf32_swap_reloca_out (output_bfd, &rel,
				 (bfd_byte *) ((Elf32_External_Rela *) srel->
					       contents + plt_index));
  ...
  if (h->needs_copy)
    {
      ...
      rel.r_addend = 0;
      bfd_elf32_swap_reloca_out (output_bfd, &rel,
				 (bfd_byte *) ((Elf32_External_Rela *) s->
					       contents + s->reloc_count));
      ++s->reloc_count;
    }
  ...
  if (elf_hash_table (info)->dynamic_sections_created)
      ...
      if (splt && splt->size > 0)
	{
	  if (info->shared)
	    ...
	    {
	      memcpy (splt->contents, elf_mn10300_plt0_entry,
		      PLT0_ENTRY_SIZE);
	      bfd_put_32 (output_bfd,
