...
static reloc_howto_type x86_64_elf_howto_table[] = {
  HOWTO (R_X86_64_NONE, 0, 0, 0, FALSE, 0, complain_overflow_dont,
	 bfd_elf_generic_reloc, "R_X86_64_NONE", FALSE, 0x00000000,
	 0x00000000,
	 FALSE),
  ...
  HOWTO (R_X86_64_PC32, 0, 2, 32, TRUE, 0, complain_overflow_signed,
	 bfd_elf_generic_reloc, "R_X86_64_PC32", FALSE, 0xffffffff,
	 0xffffffff,
	 TRUE),
  HOWTO (R_X86_64_GOT32, 0, 2, 32, FALSE, 0, complain_overflow_signed,
	 bfd_elf_generic_reloc, "R_X86_64_GOT32", FALSE, 0xffffffff,
	 0xffffffff,
	 FALSE),
  HOWTO (R_X86_64_PLT32, 0, 2, 32, TRUE, 0, complain_overflow_signed,
	 bfd_elf_generic_reloc, "R_X86_64_PLT32", FALSE, 0xffffffff,
	 0xffffffff,
	 TRUE),
  HOWTO (R_X86_64_COPY, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	 bfd_elf_generic_reloc, "R_X86_64_COPY", FALSE, 0xffffffff,
	 0xffffffff,
	 FALSE),
			    ...
			    Elf_Internal_Rela * dst)
{
  ...
  if (r_type < (unsigned int) R_X86_64_GNU_VTINHERIT)
  ...
  else
    {
      ...
      i =
	r_type - ((unsigned int) R_X86_64_GNU_VTINHERIT - R_X86_64_TPOFF32 -
		  1);
    }
...
static bfd_boolean
elf64_x86_64_create_dynamic_sections (bfd * dynobj,
	...
	case R_X86_64_TPOFF32:
	  if (info->shared)
		...
		(_
		 ...
		 abfd, x86_64_elf_howto_table[r_type].name,
	  ...
	  if ((info->shared
	      ...
	      if (p == NULL || p->sec != sec)
		{
		  ...
		  *head = p;
		  ...
		  || r_type == R_X86_64_PC16 || r_type == R_X86_64_PC32)
		p->pc_count += 1;
	    }
	  break;
	...
	case R_X86_64_GOTTPOFF:
		  ...
		  if (indx == 0)
		  ...
		  else
		    {
		      bfd_put_64 (output_bfd, 0,
				  htab->sgot->contents + off +
				  GOT_ENTRY_SIZE);
		      outrel.r_info = ELF64_R_INFO (indx, R_X86_64_DTPOFF64);
	  ...
	  if (r_type == ELF64_R_TYPE (rel->r_info))
		...
		BFD_ASSERT (bfd_get_8 (input_bfd,
	      ...
	      BFD_ASSERT (ELF64_R_TYPE (rel[1].r_info) == R_X86_64_PLT32);
	      memcpy (contents + rel->r_offset - 4,
		      "\x64\x48\x8b\x04\x25\0\0\0\0\x48\x03\x05\0\0\0", 16);

	      relocation = (htab->sgot->output_section->vma
			    + htab->sgot->output_offset + off
			    - rel->r_offset
			    - input_section->output_section->vma
			    - input_section->output_offset - 12);
	...
	abort ();
      ...
      bfd_put_32 (output_bfd,
		  (htab->sgotplt->output_section->vma
		   ...
		   - h->plt.offset
		   - 6), htab->splt->contents + h->plt.offset + 2);
...
static bfd_boolean
elf64_x86_64_finish_dynamic_sections (bfd * output_bfd,
				      struct bfd_link_info *info)
{
  struct elf64_x86_64_link_hash_table *htab;
  bfd *dynobj;
  ...
  if (htab->sgotplt)
      ...
      if (htab->sgotplt->size > 0)
	{
	  ...
	  bfd_put_64 (output_bfd, (bfd_vma) 0,
		      htab->sgotplt->contents + GOT_ENTRY_SIZE * 2);
	}
...
static bfd_boolean
elf64_x86_64_section_from_shdr (bfd * abfd, Elf_Internal_Shdr * hdr,
				const char *name)
{
