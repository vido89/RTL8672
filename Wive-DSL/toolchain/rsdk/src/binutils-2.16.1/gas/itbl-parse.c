...
#line 309 "itbl-parse.y"
	...
	DBG (("line %d: entry pnum=%d type=%d name=%s value=x%x\n",
	      insntbl_line, yyvsp[-4].num, yyvsp[-3].num, yyvsp[-2].str,
	      yyvsp[-1].val));
	itbl_add_reg (yyvsp[-4].num, yyvsp[-3].num, yyvsp[-2].str,
		      yyvsp[-1].val);
      }
      break;
    case 5:
#line 315 "itbl-parse.y"
	...
	insn =
	  itbl_add_insn (yyvsp[-5].num, yyvsp[-3].str, yyvsp[-2].val, sbit,
			 ebit, yyvsp[0].val);
      }
      break;
    case 6:
