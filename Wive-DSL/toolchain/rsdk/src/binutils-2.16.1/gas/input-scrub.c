...
input_scrub_push (char *saved_position)
{
  ...
  buffer_start =
    xmalloc ((BEFORE_SIZE + buffer_length + buffer_length + AFTER_SIZE));
		  ...
		  int line_number)
{
  ...
  if (fname
      && (logical_input_file == NULL || strcmp (logical_input_file, fname)))
    {
