...
PARAMS ((char *, LITTLENUM_TYPE *, int));
static void (*ia64_float_to_chars) PARAMS ((char *, LITTLENUM_TYPE *, int));
...
static struct
{
  ...
  unsigned int manual_bundling:1, debug_dv:1, detect_dv:1, explicit_mode:1,	/* which mode we're in */
    default_explicit_mode:1,	/* which mode is the default */
    mode_explicitly_set:1,	/* was the current mode explicitly set? */
    auto_align:1, keep_pending_output:1;
  ...
  struct slot
  {
    unsigned int
      end_of_insn_group:1,
      manual_bundling_on:1, manual_bundling_off:1, loc_directive_seen:1;
...
pseudo_func[] =
{
  ...
  {
    "dtpmod", PSEUDO_FUNC_RELOC,
    {
  0}},
  {
    "dtprel", PSEUDO_FUNC_RELOC,
    {
  0}},
  {
  ...
  0}},				/* placeholder for FUNC_LT_FPTR_RELATIVE */
  {
    NULL, 0,
    {
  0}},				/* placeholder for FUNC_LT_DTP_MODULE */
  {
    NULL, 0,
    {
  0}},				/* placeholder for FUNC_LT_DTP_RELATIVE */
  {
    NULL, 0,
    {
  0}},				/* placeholder for FUNC_LT_TP_RELATIVE */
  {
    "iplt", PSEUDO_FUNC_RELOC,
    {
  0}},
    /* mbtype4 constants:  */
  {
  ...
  0xa}},
  {
    "brcst", PSEUDO_FUNC_CONST,
    {
  0x0}},
  {
    "mix", PSEUDO_FUNC_CONST,
    {
  0x8}},
  {
    "rev", PSEUDO_FUNC_CONST,
    {
  0xb}},
  {
    "shuf", PSEUDO_FUNC_CONST,
    {
  0x9}},
    /* fclass constants:  */
  {
    "nat", PSEUDO_FUNC_CONST,
    {
  0x100}},
  {
    "qnan", PSEUDO_FUNC_CONST,
    {
  0x080}},
  {
    "snan", PSEUDO_FUNC_CONST,
    {
  0x040}},
  {
    "pos", PSEUDO_FUNC_CONST,
    {
  0x001}},
  {
    "neg", PSEUDO_FUNC_CONST,
    {
  0x002}},
  {
    "zero", PSEUDO_FUNC_CONST,
    {
  0x004}},
  {
    "unorm", PSEUDO_FUNC_CONST,
    {
  0x008}},
  {
    "norm", PSEUDO_FUNC_CONST,
    {
  0x010}},
  {
  ...
  0x100}},			/* old usage */
    /* hint constants: */
  {
    "pause", PSEUDO_FUNC_CONST,
    {
  0x0}},
    /* unwind-related constants:  */
  {
    "svr4", PSEUDO_FUNC_CONST,
    {
  ELFOSABI_NONE}},
  {
    "hpux", PSEUDO_FUNC_CONST,
    {
  ELFOSABI_HPUX}},
  {
    "nt", PSEUDO_FUNC_CONST,
    {
  2}},				/* conflicts w/ELFOSABI_NETBSD */
  {
    "linux", PSEUDO_FUNC_CONST,
    {
  ELFOSABI_LINUX}},
  {
    "freebsd", PSEUDO_FUNC_CONST,
    {
  ELFOSABI_FREEBSD}},
  {
    "openvms", PSEUDO_FUNC_CONST,
    {
  ELFOSABI_OPENVMS}},
  {
    "nsk", PSEUDO_FUNC_CONST,
    {
  ELFOSABI_NSK}},
...
#define STATE_SRLZ 2
  ...
  enum
  { CMP_NONE, CMP_OR, CMP_AND } cmp_type;	/* OR or AND compare? */
...
PARAMS ((int ref, void (*cons) PARAMS ((int)), int ua));
...
static enum operand_match_result operand_match
PARAMS ((const struct ia64_opcode * idesc, int index, expressionS * e));
...
static bfd_reloc_code_real_type ia64_gen_real_reloc_type
PARAMS ((struct symbol * sym, bfd_reloc_code_real_type r_type));
static void insn_group_break PARAMS ((int, int, int));
static void mark_resource
PARAMS ((struct ia64_opcode *, const struct ia64_dependency *, struct rsrc *,
	 int depind, int path));
...
static int specify_resource PARAMS ((const struct ia64_dependency *,
				     struct ia64_opcode *, int, struct rsrc[],
				     int, int));
...
static int resources_match
PARAMS ((struct rsrc *, struct ia64_opcode *, int, int, int));
...
static void output_R3_format
PARAMS ((vbyte_func, unw_record_type, unsigned long));
...
static void output_P4_format
PARAMS ((vbyte_func, unsigned char *, unsigned long));
...
static void output_P7_format
PARAMS ((vbyte_func, unw_record_type, unsigned long, unsigned long));
static void output_P8_format
PARAMS ((vbyte_func, unw_record_type, unsigned long));
static void output_P9_format PARAMS ((vbyte_func, int, int));
static void output_P10_format PARAMS ((vbyte_func, int, int));
static void output_B1_format
PARAMS ((vbyte_func, unw_record_type, unsigned long));
static void output_B2_format
PARAMS ((vbyte_func, unsigned long, unsigned long));
static void output_B3_format
PARAMS ((vbyte_func, unsigned long, unsigned long));
static void output_B4_format
PARAMS ((vbyte_func, unw_record_type, unsigned long));
static char format_ab_reg PARAMS ((int, int));
static void output_X1_format
PARAMS ((vbyte_func, unw_record_type, int, int, unsigned long,
	 unsigned long));
static void output_X2_format
PARAMS ((vbyte_func, int, int, int, int, int, unsigned long));
static void output_X3_format
PARAMS ((vbyte_func, unw_record_type, int, int, int, unsigned long,
	 unsigned long));
static void output_X4_format
PARAMS ((vbyte_func, int, int, int, int, int, int, unsigned long));
...
static unw_rec_list *output_spill_psprel
PARAMS ((unsigned int, unsigned int, unsigned int));
static unw_rec_list *output_spill_sprel
PARAMS ((unsigned int, unsigned int, unsigned int));
static unw_rec_list *output_spill_psprel_p
PARAMS ((unsigned int, unsigned int, unsigned int, unsigned int));
static unw_rec_list *output_spill_sprel_p
PARAMS ((unsigned int, unsigned int, unsigned int, unsigned int));
static unw_rec_list *output_spill_reg
PARAMS ((unsigned int, unsigned int, unsigned int, unsigned int));
static unw_rec_list *output_spill_reg_p
PARAMS ((unsigned int, unsigned int, unsigned int, unsigned int,
	 unsigned int));
...
static void set_imask
PARAMS ((unw_rec_list *, unsigned long, unsigned long, unsigned int));
static unsigned long slot_index
PARAMS ((unsigned long, fragS *, unsigned long, fragS *, int));
static unw_rec_list *optimize_unw_records PARAMS ((unw_rec_list *));
static void fixup_unw_records PARAMS ((unw_rec_list *, int));
static int convert_expr_to_ab_reg
PARAMS ((expressionS *, unsigned int *, unsigned int *));
static int convert_expr_to_xy_reg
PARAMS ((expressionS *, unsigned int *, unsigned int *));
     ...
     unw_rec_list *list;
{
  ...
  if (list->r.type == prologue
	  ...
	  || (list->next->r.type == body
	      && list->next->next->r.type == endp)))
    return NULL;
...
ia64_convert_frag (fragS * frag)
{
  ...
  md_number_to_chars (frag->fr_literal, (((bfd_vma) 1 << 48)	/* Version.  */
  ...
  if (suffix == text_name && (text_seg->flags & SEC_LINK_ONCE) != 0)
    {
      ...
      if (group_name == NULL)
	{
	  as_bad ("Group section `%s' has no group signature", sec_text_name);
	  ignore_rest_of_line ();
	  return;
	}
      /* We have to construct a fake section directive. */
      group_name_len = strlen (group_name);
      len = (sec_name_len + 16	/* ,"aG",@progbits,  */
  ...
  if (size != 0)
    {
      ...
      frag_var (rs_machine_dependent, size, size, 0, 0,
		(offsetT) (long) unwind.personality_routine, (char *) list);
      ...
      if (e2.X_op == O_constant)
	{
	  switch (reg1)
	    ...
	    case REG_AR + AR_LC:
	      add_unwind_entry (output_lc_when ());
	      add_unwind_entry ((psprel
				 ? output_lc_psprel : output_lc_sprel) (val));
	      break;
	    case REG_BR:
	      add_unwind_entry (output_rp_when ());
	      add_unwind_entry ((psprel
				 ? output_rp_psprel : output_rp_sprel) (val));
	      break;
	    case REG_PR:
	      add_unwind_entry (output_preds_when ());
	      add_unwind_entry ((psprel
  ...
  if (unwind.info || unwind.force_unwind_entry)
    {
      ...
      e.X_add_number = 0;
      if (!S_IS_LOCAL (unwind.proc_start) && S_IS_DEFINED (unwind.proc_start))
  ...
  while (1)
      ...
      if (!*name)
	{
	  if (md.unwind_check == unwind_check_warning)
		...
		{
		  as_warn
		    ("Empty argument of .endp. Use the default name `%s'",
		     default_name);
		  name = default_name;
		}
	      else
      ...
      if (*name)
	{
	  ...
	  if (!sym
	      ...
	      && default_name && default_name != name)
	    {
	      ...
	      as_warn
		("`%s' was not defined within procedure. Use the default name `%s'",
		 name, default_name);
	      name = default_name;
	      sym = symbol_find (name);
	    }
     ...
     int ua;
{
  ...
  *end = '\0';
  ...
  if (section_count != bfd_count_sections (stdoutput))
    as_warn
      ("Creating sections with .xdataN/.xrealN/.xstringZ is deprecated.");
  ...
  while (1)
    {
	  ...
	  && pr.X_add_number >= REG_P && pr.X_add_number <= REG_P + 63)
	{
     ...
     int regnum;
{
  ...
  if (err)
    as_fatal ("Inserting \"%s\" into register table failed: %s", name, err);
  ...
  switch (opnd)
	  ...
	  || e->X_op == O_subtract)
	{
	  ...
	  if (e->X_op != O_subtract)
	    {
	      fix->code =
		ia64_gen_real_reloc_type (e->X_op_symbol, fix->code);
	  ...
	  if (e->X_op == O_big)
	    {
		  ...
		  && generic_bignum[1] == 0
		  && generic_bignum[2] == 0
		  && generic_bignum[3] == 0 && generic_bignum[4] == 1)
		return OPERAND_MATCH;
	      else
		return OPERAND_OUT_OF_RANGE;
	    }
     ...
     struct ia64_opcode *idesc;
{
  ...
  for (i = 0; i < num_operands; ++i)
	...
	default:
	  ...
	  break;
	case 'm':
	  as_warn ("Invalid use of `r%d' as base update address operand",
		   regno);
	  break;
	}
    }
  ...
  for (i = 0; i < 3 && md.num_slots_in_use > 0; ++i)
	  ...
	  if (required_template != template)
	    {
	      ...
	      for (j = i; j < 3; ++j)
		insn[j] =
		  nop[ia64_templ_desc[required_template].exec_unit[j]];
	    }
      ...
      else
	{
	  ...
	  switch (insn_type)
	    ...
	    case IA64_TYPE_A:
	      if (required_unit == IA64_UNIT_I
		  || required_unit == IA64_UNIT_M)
		insn_unit = required_unit;
	      break;
	    case IA64_TYPE_X:
	      insn_unit = IA64_UNIT_L;
	      break;
	    case IA64_TYPE_I:
	      insn_unit = IA64_UNIT_I;
	      break;
	    case IA64_TYPE_M:
	      ...
	      break;
	    case IA64_TYPE_B:
	      insn_unit = IA64_UNIT_B;
	      break;
	    case IA64_TYPE_F:
	      insn_unit = IA64_UNIT_F;
	      break;
	    default:
	      break;
	    }
     ...
     char *arg;
{
  ...
  switch (c)
    ...
    case 'm':
	  ...
	  || strcmp (arg, "lp64") == 0 || strcmp (arg, "p64") == 0)
	{
	  md.flags |= EF_IA_64_ABI64;
	}
...
match (int templ, int type, int slot)
{
  ...
  switch (type)
    ...
    case IA64_TYPE_DYN:
      result = 1;
      break;			/* for nop and break */
    case IA64_TYPE_A:
      result = (unit == IA64_UNIT_I || unit == IA64_UNIT_M);
      break;
    case IA64_TYPE_X:
      result = (unit == IA64_UNIT_L);
      break;
    case IA64_TYPE_I:
      result = (unit == IA64_UNIT_I);
      break;
    case IA64_TYPE_M:
      result = (unit == IA64_UNIT_M);
      break;
    case IA64_TYPE_B:
      result = (unit == IA64_UNIT_B);
      break;
    case IA64_TYPE_F:
      result = (unit == IA64_UNIT_F);
      break;
    default:
      result = 0;
      break;
     ...
     int ch;
{
  switch (ch)
	...
	CURR_SLOT.manual_bundling_on = 1;
      ...
      if (md.detect_dv && !md.explicit_mode)
	{
	  if (!md.mode_explicitly_set && !md.default_explicit_mode)
	    dot_dv_mode ('E');
	  else
	...
	PREV_SLOT.manual_bundling_off = 1;
      ...
      if (md.detect_dv
	  && md.explicit_mode
	  && !md.mode_explicitly_set && !md.default_explicit_mode)
	dot_dv_mode ('A');
	...
	else if (LOCAL_LABELS_FB && ISDIGIT (*input_line_pointer))
	  {
	    temp = 0;
     ...
     struct symbol *sym;
{
  if ((S_GET_SEGMENT (sym) == &bfd_und_section && !symbol_used_p (sym) &&
      ...
      || (S_GET_SEGMENT (sym) == &bfd_abs_section && !S_IS_EXTERNAL (sym)))
    return 1;
  return 0;
}
#endif
	...
	case PSEUDO_FUNC_RELOC:
	  ...
	  if (e->X_op != O_symbol)
		...
		case FUNC_FPTR_RELATIVE:
		  idx = FUNC_LT_FPTR_RELATIVE;
		  break;
		case FUNC_DTP_MODULE:
		  idx = FUNC_LT_DTP_MODULE;
		  break;
		case FUNC_DTP_RELATIVE:
		  idx = FUNC_LT_DTP_RELATIVE;
		  break;
		case FUNC_TP_RELATIVE:
		  idx = FUNC_LT_TP_RELATIVE;
		  break;
		default:
		  as_bad ("Illegal combination of relocation functions");
		  goto done;
...
#define KNOWN(REG) (gr_values[REG].known && gr_values[REG].path >= path)
  ...
  switch (dep->specifier)
	  ...
	  if (idesc->operands[!rsrc_write] == IA64_OPND_CPUID_R3)
	    {
	      ...
	      if (regno >= 0 && regno < NELEMS (gr_values) && KNOWN (regno))
		{
		  specs[count] = tmpl;
      ...
      if (note == 0)
	{
	  ...
	  if (rsrc_write
	      && idesc->operands[1] == IA64_OPND_CR3 && regno == CR_IVR)
	    {
	      for (i = 0; i < 4; i++)
		{
		  specs[count] = tmpl;
      ...
      else if (note == 7)
	{
	  valueT mask = 0;
	  /* Mark only those registers indicated by the mask.  */
	  if (rsrc_write && idesc->operands[0] == IA64_OPND_PR)
	    {
	      mask = CURR_SLOT.opnd[2].X_add_number;
	      if (mask & ((valueT) 1 << 16))
		for (i = 16; i < 63; i++)
	  ...
	  else if (rsrc_write && idesc->operands[0] == IA64_OPND_PR_ROT)
	    {
	      for (i = 16; i < 63; i++)
		{
		  specs[count] = tmpl;
	  ...
	  if (idesc->operands[!rsrc_write] == IA64_OPND_PSR_UM)
		...
		case PSR_IC:
		  if (rsrc_write)
			...
			{
			  int index =
			    ((idesc->operands[0] == IA64_OPND_CR3) ? 0 : 1);
			  int regno =
		...
		case PSR_CPL:
		  if (rsrc_write)
			...
			{
			  int index =
			    ((idesc->operands[0] == IA64_OPND_AR3) ? 0 : 1);
			  int regno =
      ...
      if (note == 0 || note == 1)
	{
	  ...
	  /* other AR[REG] resources may be affected by AR accesses */
		...
		case AR_RSC:
		  if (!rsrc_write &&
		      (regno == AR_BSPSTORE || regno == AR_RNAT))
		    {
		      specs[count++] = tmpl;
		    }
		  break;
...
update_qp_mutex (valueT mask)
{
  ...
  while (i < qp_mutexeslen)
      ...
      if ((qp_mutexes[i].prmask & mask) != 0)
	{
	  ...
	  if (qp_mutexes[i].prmask == mask && qp_mutexes[i].path == md.path)
	    {
	      i++;
	      add = -1;
	    }
	      ...
	      if (qp_mutexes[i].path == md.path)
		{
		  /* If it is a proper subset of the mutex, create a
		     new mutex.  */
		  if (add == 0 && (qp_mutexes[i].prmask & mask) == mask)
		    add = 1;
  ...
  for (i = 0; i < qp_implieslen; i++)
    {
	  ...
	  && qp_implies[i].p2 == p2
	  && qp_implies[i].path == md.path && !qp_implies[i].p2_branched)
	return;
    }
     ...
     struct ia64_opcode *idesc;
{
  ...
  else if (is_interruption_or_rfi (idesc) || is_taken_branch (idesc))
    {
      clear_register_values ();
  ...
  /* Look for mutex and implies relations.  */
      ...
      else
	{
	  ...
	  if (CURR_SLOT.qp_regno == 0 || has_suffix_p (idesc->name, ".unc"))
	    {
	      if (added == 0 && p1 && p2)
     ...
     int path;
{
  ...
  if (qp_mutex (rs->qp_regno, qp_regno, path) && note != 11)
    return 0;
  ...
  while (count-- > 0)
    {
	  ...
	  && specs[count].mem_offset.hint && rs->mem_offset.hint)
	{
  ...
  while (i < regdepslen)
    {
      ...
      if (qp_regno != 0 && regdeps[i].qp_regno != qp_regno)
	{
	  ++i;
	  continue;
	}
  ...
  if (regdepslen == regdepstotlen)
    {
      regdepstotlen += 20;
      regdeps = (struct rsrc *)
	xrealloc ((void *) regdeps, regdepstotlen * sizeof (struct rsrc));
    }
	  ...
	  if ((matchtype = resources_match (rs, idesc, note,
		...
		sprintf (indexmsg, ", specific resource number is %d",
	      ...
	      sprintf (msg, "Use of '%s' %s %s dependency '%s' (%s)%s%s",
		       ...
		       dv_sem[dep->semantics], pathmsg, indexmsg);
	      ...
	      if (md.explicit_mode)
		{
		  ...
		  if (path < md.path)
		    as_warn (_
			     ("Only the first path encountering the conflict "
			      "is reported"));
  ...
  for (i = 0; i < opdeps->nregs; i++)
	...
	case IA64_RS_RR:
	  for (path = 0; path < md.path; path++)
	    {
	      count =
		specify_resource (dep, idesc, DV_REG, specs, note, path);
	      while (count-- > 0)
		mark_resource (idesc, dep, &specs[count],
     ...
     struct ia64_opcode *idesc;
{
  ...
  else if (is_conditional_branch (idesc) && CURR_SLOT.qp_regno != 0)
    {
  ...
  if (md.debug_dv)
    {
      fprintf (stderr, "Checking %s for violations (line %d, %d/%d)\n",
	       ...
	       idesc->dependencies->nchks, idesc->dependencies->nregs);
    }
  ...
  if (idesc->type == IA64_TYPE_DYN)
      ...
      if (CURR_SLOT.opnd[rop].X_op == O_register)
	{
	  ...
	  if (ar_is_only_in_integer_unit (CURR_SLOT.opnd[rop].X_add_number))
	    ...
	    if (ar_is_only_in_memory_unit (CURR_SLOT.opnd[rop].X_add_number))
	    unit = 'm';
     ...
     bfd_reloc_code_real_type r_type;
{
  ...
  switch (S_GET_VALUE (sym))
	...
	case BFD_RELOC_IA64_IMM22:
	  ...
	  break;
	case BFD_RELOC_IA64_IMM64:
	  new = BFD_RELOC_IA64_LTOFF_FPTR64I;
	  break;
	case BFD_RELOC_IA64_DIR32MSB:
	  new = BFD_RELOC_IA64_LTOFF_FPTR32MSB;
	  break;
	case BFD_RELOC_IA64_DIR32LSB:
	  new = BFD_RELOC_IA64_LTOFF_FPTR32LSB;
	  break;
	case BFD_RELOC_IA64_DIR64MSB:
	  new = BFD_RELOC_IA64_LTOFF_FPTR64MSB;
	  break;
	case BFD_RELOC_IA64_DIR64LSB:
	  new = BFD_RELOC_IA64_LTOFF_FPTR64LSB;
	  break;
	default:
	  type = "LTOFF_FPTR";
	  break;
	...
	{
	case BFD_RELOC_IA64_IMM22:
	  new = BFD_RELOC_IA64_LTOFF_TPREL22;
	  break;
	default:
	  type = "LTOFF_TPREL";
	  break;
	...
	{
	case BFD_RELOC_IA64_DIR64MSB:
	  new = BFD_RELOC_IA64_DTPMOD64MSB;
	  break;
	case BFD_RELOC_IA64_DIR64LSB:
	  new = BFD_RELOC_IA64_DTPMOD64LSB;
	  break;
	default:
	  type = "DTPMOD";
	  break;
	...
	{
	case BFD_RELOC_IA64_DIR32MSB:
	  new = BFD_RELOC_IA64_DTPREL32MSB;
	  break;
	case BFD_RELOC_IA64_DIR32LSB:
	  new = BFD_RELOC_IA64_DTPREL32LSB;
	  break;
	case BFD_RELOC_IA64_DIR64MSB:
	  new = BFD_RELOC_IA64_DTPREL64MSB;
	  break;
	case BFD_RELOC_IA64_DIR64LSB:
	  new = BFD_RELOC_IA64_DTPREL64LSB;
	  break;
	case BFD_RELOC_IA64_IMM14:
	  new = BFD_RELOC_IA64_DTPREL14;
	  break;
	case BFD_RELOC_IA64_IMM22:
	  new = BFD_RELOC_IA64_DTPREL22;
	  break;
	case BFD_RELOC_IA64_IMM64:
	  new = BFD_RELOC_IA64_DTPREL64I;
	  break;
	default:
	  type = "DTPREL";
	  break;
	...
	{
	case BFD_RELOC_IA64_IMM22:
	  new = BFD_RELOC_IA64_LTOFF_DTPREL22;
	  break;
	default:
	  type = "LTOFF_DTPREL";
	  break;
  ...
  if (fix->fx_pcrel)
    {
      switch (fix->fx_r_type)
	{
	case BFD_RELOC_IA64_PCREL21B:
	  break;
	case BFD_RELOC_IA64_PCREL21BI:
	  break;
	case BFD_RELOC_IA64_PCREL21F:
	  break;
	case BFD_RELOC_IA64_PCREL21M:
	  break;
	case BFD_RELOC_IA64_PCREL60B:
	  break;
	case BFD_RELOC_IA64_PCREL22:
	  break;
	case BFD_RELOC_IA64_PCREL64I:
	  break;
	case BFD_RELOC_IA64_PCREL32MSB:
	  break;
	case BFD_RELOC_IA64_PCREL32LSB:
	  break;
	case BFD_RELOC_IA64_PCREL64MSB:
	  break;
	case BFD_RELOC_IA64_PCREL64LSB:
	  break;
	default:
	  fix->fx_r_type =
	    ia64_gen_real_reloc_type (pseudo_func[FUNC_PC_RELATIVE].u.sym,
				      fix->fx_r_type);
	  break;
	}
    }
...
static void
ia64_float_to_chars_bigendian (char *lit, LITTLENUM_TYPE * words, int prec)
{
  while (prec--)
    {
...
static void
ia64_float_to_chars_littleendian (char *lit, LITTLENUM_TYPE * words, int prec)
{
  while (prec--)
    {
