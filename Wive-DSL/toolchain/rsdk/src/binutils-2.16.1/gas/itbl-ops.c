...
struct itbl_entry *
itbl_add_reg (int yyprocessor, int yytype, char *regname, int regnum)
{
...
find_entry_byname (e_processor processor, e_type type, char *n)
{
  struct itbl_entry *e, **es;
...
alloc_field (e_type type, int sbit, int ebit, unsigned long flags)
{
  struct itbl_field *f;
