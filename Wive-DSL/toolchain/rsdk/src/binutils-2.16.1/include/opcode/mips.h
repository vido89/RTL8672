...
#define INSN_ISA4180              0x00001000   /* LX4180, RLX4181 */
#define INSN_ISA4181              0x00002000   /* LX4180, RLX4181 */
#define INSN_ISA5181              0x00004000   /* LX4180, RLX4181 */
#define INSN_ISA5280              0x00008000   /* LX4180, RLX4181 */

/* 2006-01-10 tonywu: shift left 1 bit to make room for RLX CPUs */
/* Masks used for MIPS-defined ASEs.  */
#define INSN_ASE_MASK             0x000f0000
                                                                                                    
/* MIPS 16 ASE */
#define INSN_MIPS16               0x00020000
/* MIPS-3D ASE */
#define INSN_MIPS3D               0x00040000
/* MDMX ASE */
#define INSN_MDMX                 0x00080000
                                                                                                    
/* Chip specific instructions.  These are bitmasks.  */
                                                                                                    
/* MIPS R4650 instruction.  */
#define INSN_4650                 0x00100000
/* LSI R4010 instruction.  */
#define INSN_4010                 0x00200000
/* NEC VR4100 instruction.  */
#define INSN_4100                 0x00400000
/* Toshiba R3900 instruction.  */
#define INSN_3900                 0x00800000
/* MIPS R10000 instruction.  */
#define INSN_10000                0x01000000
/* Broadcom SB-1 instruction.  */
#define INSN_SB1                  0x02000000
/* NEC VR4111/VR4181 instruction.  */
#define INSN_4111                 0x04000000
/* NEC VR4120 instruction.  */
#define INSN_4120                 0x08000000
/* NEC VR5400 instruction.  */
#define INSN_5400                 0x10000000
/* NEC VR5500 instruction.  */
#define INSN_5500				  0x20000000
...
#define       ISA_MIPS4180    (ISA_MIPS1 | INSN_ISA4180)
#define       ISA_MIPS4181    (ISA_MIPS1 | INSN_ISA4181)
#define       ISA_MIPS5181    (ISA_MIPS1 | INSN_ISA5181)
#define       ISA_MIPS5280    (ISA_MIPS1 | INSN_ISA5280)
...
#define OPCODE_IS_MEMBER(insn, isa, cpu)				\
    (((insn)->membership & isa) != 0					\
	 ...
	 || ((cpu == CPU_R10000 || cpu == CPU_R12000) && ((insn)->membership & INSN_10000) != 0) \
	 || (cpu == CPU_SB1 && ((insn)->membership & INSN_SB1) != 0)       \
	 || (cpu == CPU_R4111 && ((insn)->membership & INSN_4111) != 0)    \
	 || (cpu == CPU_VR4120 && ((insn)->membership & INSN_4120) != 0)   \
	 || (cpu == CPU_VR5400 && ((insn)->membership & INSN_5400) != 0)   \
	 || (cpu == CPU_VR5500 && ((insn)->membership & INSN_5500) != 0)   \
     || (cpu == CPU_LX4180  && ((insn)->membership & INSN_ISA4180) != 0)	\
     || (cpu == CPU_RLX4181 && ((insn)->membership & INSN_ISA4181) != 0)	\
     || (cpu == CPU_RLX5181 && ((insn)->membership & INSN_ISA5181) != 0)	\
     || (cpu == CPU_LX5280  && ((insn)->membership & INSN_ISA5280) != 0)	\
