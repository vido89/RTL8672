...
#define IMM16_PCREL    (IMM16+1)
  {16, 0,
   MN10200_OPERAND_PCREL | MN10200_OPERAND_RELAX | MN10200_OPERAND_SIGNED},
...
#define IMM24_PCREL    (IMM24+1)
  {24, 0,
   MN10200_OPERAND_EXTENDED | MN10200_OPERAND_PCREL | MN10200_OPERAND_SIGNED},
...
#define SD8N_PCREL    (SD16+1)
  {8, 0,
   MN10200_OPERAND_SIGNED | MN10200_OPERAND_PCREL | MN10200_OPERAND_RELAX},
