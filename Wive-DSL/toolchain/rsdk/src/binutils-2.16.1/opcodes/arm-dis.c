...
static const struct arm_opcode arm_opcodes[] = {
  ...
  {ARM_EXT_V6, 0xfc500000, 0xfff00000,
   "mrrc2\t%8-11d, %4-7d, %12-15r, %16-19r, cr%0-3d"},
  {ARM_EXT_V6, 0xfc400000, 0xfff00000,
   "mcrr2\t%8-11d, %4-7d, %12-15r, %16-19r, cr%0-3d"},
  ...
  {ARM_EXT_V6, 0x06300f30, 0x0ff00ff0,
   "shaddsubx%c\t%12-15r, %16-19r, %0-3r"},
  ...
  {ARM_EXT_V6, 0x06300f50, 0x0ff00ff0,
   "shsubaddx%c\t%12-15r, %16-19r, %0-3r"},
  ...
  {ARM_EXT_V6, 0x06700f30, 0x0ff00ff0,
   "uhaddsubx%c\t%12-15r, %16-19r, %0-3r"},
  ...
  {ARM_EXT_V6, 0x06700f50, 0x0ff00ff0,
   "uhsubaddx%c\t%12-15r, %16-19r, %0-3r"},
  ...
  {ARM_EXT_V6, 0x06600f30, 0x0ff00ff0,
   "uqaddsubx%c\t%12-15r, %16-19r, %0-3r"},
  ...
  {ARM_EXT_V6, 0x06600f50, 0x0ff00ff0,
   "uqsubaddx%c\t%12-15r, %16-19r, %0-3r"},
...
#define IWMMXT_INSN_COUNT 47
  ...
  {ARM_CEXT_XSCALE, 0x0e800100, 0x0fd00ff0,
   "wmadd%21?su%c\t%12-15g, %16-19g, %0-3g"},
  ...
  {ARM_CEXT_XSCALE, 0x0e000100, 0x0fc00ff0,
   "wmul%21?su%20?ml%c\t%12-15g, %16-19g, %0-3g"},
  ...
  {ARM_CEXT_XSCALE, 0x0e300040, 0x0f300ff0,
   "wror%22-23w%8'g%c\t%12-15g, %16-19g, %0-3g"},
  {ARM_CEXT_XSCALE, 0x0e300148, 0x0f300ffc,
   "wror%22-23w%8'g%c\t%12-15g, %16-19g, %0-3G"},
  ...
  {ARM_CEXT_XSCALE, 0x0e0000c0, 0x0f100fff,
   "wunpckeh%21?su%22-23w%c\t%12-15g, %16-19g"},
  ...
  {FPU_VFP_EXT_V1xD, 0x0c900b00, 0x0fd00f00,
   "fldmia%0?xd%c\t%16-19r%21'!, %3z"},
  ...
  {FPU_VFP_EXT_V1xD, 0x0ef90a10, 0x0fff0fff,
   "fmrx%c\t%12-15r, fpinst\t@ Impl def"},
  {FPU_VFP_EXT_V1xD, 0x0efa0a10, 0x0fff0fff,
   "fmrx%c\t%12-15r, fpinst2\t@ Impl def"},
  {FPU_VFP_EXT_V1xD, 0x0ef00a10, 0x0ff00fff,
   "fmrx%c\t%12-15r, <impl def 0x%16-19x>"},
  ...
  {FPU_VFP_EXT_V1xD, 0x0ee90a10, 0x0fff0fff,
   "fmxr%c\tfpinst, %12-15r\t@ Impl def"},
  {FPU_VFP_EXT_V1xD, 0x0eea0a10, 0x0fff0fff,
   "fmxr%c\tfpinst2, %12-15r\t@ Impl def"},
  {FPU_VFP_EXT_V1xD, 0x0ee00a10, 0x0ff00fff,
   "fmxr%c\t<impl def 0x%16-19x>, %12-15r"},
  ...
  {FPU_VFP_EXT_V1xD, 0x0c800b00, 0x0fd00f00,
   "fstmia%0?xd%c\t%16-19r%21'!, %3z"},
  ...
  {ARM_CEXT_MAVERICK, 0x0e000500, 0x0ff00f00,
   "cfsh32%c\tmvfx%12-15d, mvfx%16-19d, #%I"},
  {ARM_CEXT_MAVERICK, 0x0e200500, 0x0ff00f00,
...
static const struct thumb_opcode thumb_opcodes[] = {
  ...
  {ARM_EXT_V4T, 0xA000, 0xF800,
   "add\t%8-10r, pc, #%0-7W\t(adr %8-10r,%0-7a)"},
...
static arm_regname regnames[] = {
  ...
  {"apcs", "Select register names used in the APCS",
   {"a1", "a2", "a3", "a4", "v1", "v2", "v3", "v4", "v5", "v6", "sl", "fp",
    "ip", "sp", "lr", "pc"}},
  ...
  {"special-atpcs", "Select special register names used in the ATPCS",
   {"a1", "a2", "a3", "a4", "v1", "v2", "v3", "WR", "v5", "SB", "SL", "FP",
    "IP", "SP", "LR", "PC"}},
  {"iwmmxt_regnames",
   "Select register names used on the Intel Wireless MMX technology coprocessor",
   {"wr0", "wr1", "wr2", "wr3", "wr4", "wr5", "wr6", "wr7", "wr8", "wr9",
    "wr10", "wr11", "wr12", "wr13", "wr14", "wr15"}},
  {"iwmmxt_Cregnames",
   "Select control register names used on the Intel Wireless MMX technology coprocessor",
   {"wcid", "wcon", "wcssf", "wcasf", "reserved", "reserved", "reserved",
    "reserved", "wcgr0", "wcgr1", "wcgr2", "wcgr3", "reserved", "reserved",
    "reserved", "reserved"}}
};

static char *iwmmxt_wwnames[] = { "b", "h", "w", "d" };

static char *iwmmxt_wwssnames[] = { "b", "bus", "b", "bss",
  "h", "hus", "h", "hss",
  "w", "wus", "w", "wss",
  "d", "dus", "d", "dss"
};
...
static char *arm_shift[] = { "lsl", "lsr", "asr", "ror" };

...
static int set_iwmmxt_regnames PARAMS ((void));
