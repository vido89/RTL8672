     ...
     int length;
{
  ...
  switch (opindex)
    ...
    case IQ2000_OPERAND_JMPTARG:
      print_address (cd, info, fields->f_jtarg,
		     0 | (1 << CGEN_OPERAND_ABS_ADDR), pc, length);
      break;
    case IQ2000_OPERAND_JMPTARGQ10:
      print_address (cd, info, fields->f_jtargq10,
		     0 | (1 << CGEN_OPERAND_ABS_ADDR), pc, length);
      break;
    ...
    case IQ2000_OPERAND_OFFSET:
      print_address (cd, info, fields->f_offset,
    ...
    case IQ2000_OPERAND_RD_RS:
      print_keyword (cd, info, &iq2000_cgen_opval_gr_names, fields->f_rd_rs,
		     0 | (1 << CGEN_OPERAND_VIRTUAL));
      break;
    case IQ2000_OPERAND_RD_RT:
      print_keyword (cd, info, &iq2000_cgen_opval_gr_names, fields->f_rd_rt,
		     0 | (1 << CGEN_OPERAND_VIRTUAL));
      break;
    ...
    case IQ2000_OPERAND_RT_RS:
      print_keyword (cd, info, &iq2000_cgen_opval_gr_names, fields->f_rt_rs,
		     0 | (1 << CGEN_OPERAND_VIRTUAL));
      break;
