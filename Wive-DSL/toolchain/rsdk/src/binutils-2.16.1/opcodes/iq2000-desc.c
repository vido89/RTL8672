...
const CGEN_HW_ENTRY iq2000_cgen_hw_table[] = {
  ...
  {"h-gr", HW_H_GR, CGEN_ASM_KEYWORD, (PTR) & iq2000_cgen_opval_gr_names,
   {0, {(1 << MACH_BASE)}}},
...
const CGEN_IFLD iq2000_cgen_ifld_table[] = {
  ...
  {IQ2000_F_RD_RS, "f-rd-rs", 0, 0, 0, 0,
   {0 | A (VIRTUAL), {(1 << MACH_BASE)}}},
  {IQ2000_F_RD_RT, "f-rd-rt", 0, 0, 0, 0,
   {0 | A (VIRTUAL), {(1 << MACH_BASE)}}},
  {IQ2000_F_RT_RS, "f-rt-rs", 0, 0, 0, 0,
   {0 | A (VIRTUAL), {(1 << MACH_BASE)}}},
  {IQ2000_F_JTARG, "f-jtarg", 0, 32, 15, 16,
   {0 | A (ABS_ADDR), {(1 << MACH_BASE)}}},
  {IQ2000_F_JTARGQ10, "f-jtargq10", 0, 32, 20, 21,
   {0 | A (ABS_ADDR), {(1 << MACH_BASE)}}},
  {IQ2000_F_OFFSET, "f-offset", 0, 32, 15, 16,
...
/* add ${rd-rs},$rt */
  {
   -1, "add2", "add", 32,
   {0 | A (USES_RT) | A (USES_RS) | A (USES_RD) | A (NO_DIS) | A (ALIAS),
    {(1 << MACH_BASE)}}
   },
/* add $rd,$rs,$rt */
  {
...
/* bbv $rs,$rt,$offset */
  {
   ...
   {0 | A (USES_RT) | A (USES_RS) | A (COND_CTI) | A (DELAY_SLOT),
    {(1 << MACH_BASE)}}
   },
/* bbvn $rs,$rt,$offset */
  {
...
/* beql $rs,$rt,$offset */
  {
   ...
   {0 | A (USES_RT) | A (USES_RS) | A (SKIP_CTI) | A (COND_CTI) |
    A (DELAY_SLOT), {(1 << MACH_BASE)}}
   },
/* bgez $rs,$offset */
  {
...
/* bgezal $rs,$offset */
  {
   ...
   {0 | A (USES_R31) | A (USES_RS) | A (COND_CTI) | A (DELAY_SLOT),
    {(1 << MACH_BASE)}}
   },
/* bgezall $rs,$offset */
  {
   IQ2000_INSN_BGEZALL, "bgezall", "bgezall", 32,
   {0 | A (USES_R31) | A (USES_RS) | A (SKIP_CTI) | A (COND_CTI) |
    A (DELAY_SLOT), {(1 << MACH_BASE)}}
   },
/* bgezl $rs,$offset */
  {
   IQ2000_INSN_BGEZL, "bgezl", "bgezl", 32,
   {0 | A (USES_RS) | A (SKIP_CTI) | A (COND_CTI) | A (DELAY_SLOT),
    {(1 << MACH_BASE)}}
   },
/* bltz $rs,$offset */
  {
...
/* jalr $rd,$rs */
  {
   ...
   {0 | A (USES_RS) | A (USES_RD) | A (UNCOND_CTI) | A (DELAY_SLOT),
    {(1 << MACH_BASE)}}
   },
/* jr $rs */
  {
...
/* andoui ${rt-rs},$hi16 */
  {
   -1, "andoui2", "andoui", 32,
   {0 | A (USES_RT) | A (USES_RS) | A (NO_DIS) | A (ALIAS),
    {(1 << MACH_IQ2000)}}
   },
/* orui ${rt-rs},$hi16 */
  {
...
/* cm64ra $rd,$rs,$rt */
  {
   ...
   {0 | A (USES_RD) | A (USES_RT) | A (USES_RS) | A (EVEN_REG_NUM),
    {(1 << MACH_IQ10)}}
   },
/* cm64rd $rd,$rt */
  {
