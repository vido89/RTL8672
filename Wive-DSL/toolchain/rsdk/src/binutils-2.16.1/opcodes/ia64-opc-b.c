...
#undef BRT
  ...
  {"rfi", B0, OpX6 (0, 0x08), {0,}, NO_PRED | LAST | PRIV | MOD_RRBS, 0,
   NULL},
...
#undef BRT
  ...
  {"br.call.sptk.clr", B, OpPaWhaD (5, 0, 0, 1), {B1, TGT25c}, PSEUDO, 0,
   NULL},
  ...
  {"br.call.spnt.clr", B, OpPaWhaD (5, 0, 1, 1), {B1, TGT25c}, PSEUDO, 0,
   NULL},
  ...
  {"br.call.dptk.clr", B, OpPaWhaD (5, 0, 2, 1), {B1, TGT25c}, PSEUDO, 0,
   NULL},
  ...
  {"br.call.dpnt.clr", B, OpPaWhaD (5, 0, 3, 1), {B1, TGT25c}, PSEUDO, 0,
   NULL},
