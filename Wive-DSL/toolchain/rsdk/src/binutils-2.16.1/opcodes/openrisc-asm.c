     ...
     CGEN_FIELDS *fields;
{
  ...
  switch (opindex)
	...
	bfd_vma value;
	errmsg =
	  cgen_parse_address (cd, strp, OPENRISC_OPERAND_ABS_26, 0, NULL,
			      &value);
	...
	bfd_vma value;
	errmsg =
	  cgen_parse_address (cd, strp, OPENRISC_OPERAND_DISP_26, 0, NULL,
			      &value);
    ...
    case OPENRISC_OPERAND_HI16:
      errmsg =
	parse_hi16 (cd, strp, OPENRISC_OPERAND_HI16,
		    (long *) (&fields->f_simm16));
      break;
    case OPENRISC_OPERAND_LO16:
      errmsg =
	parse_lo16 (cd, strp, OPENRISC_OPERAND_LO16,
		    (long *) (&fields->f_lo16));
      break;
    case OPENRISC_OPERAND_OP_F_23:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, OPENRISC_OPERAND_OP_F_23,
				     (unsigned long *) (&fields->f_op4));
      break;
    case OPENRISC_OPERAND_OP_F_3:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, OPENRISC_OPERAND_OP_F_3,
				     (unsigned long *) (&fields->f_op5));
      break;
    case OPENRISC_OPERAND_RA:
      errmsg =
	cgen_parse_keyword (cd, strp, &openrisc_cgen_opval_h_gr,
			    &fields->f_r2);
      break;
    ...
    case OPENRISC_OPERAND_SIMM_16:
      errmsg =
	cgen_parse_signed_integer (cd, strp, OPENRISC_OPERAND_SIMM_16,
				   (long *) (&fields->f_simm16));
      break;
    case OPENRISC_OPERAND_UI16NC:
      errmsg =
	parse_lo16 (cd, strp, OPENRISC_OPERAND_UI16NC,
		    (long *) (&fields->f_i16nc));
      break;
    case OPENRISC_OPERAND_UIMM_16:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, OPENRISC_OPERAND_UIMM_16,
				     (unsigned long *) (&fields->f_uimm16));
      break;
    case OPENRISC_OPERAND_UIMM_5:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, OPENRISC_OPERAND_UIMM_5,
