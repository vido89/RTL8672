...
static long
extract_bba (unsigned long insn, int dialect ATTRIBUTE_UNUSED, int *invalid)
{
...
extract_bd (unsigned long insn,
	    int dialect ATTRIBUTE_UNUSED, int *invalid ATTRIBUTE_UNUSED)
{
...
insert_bdm (unsigned long insn,
	    long value, int dialect, const char **errmsg ATTRIBUTE_UNUSED)
{
...
static unsigned long
insert_boe (unsigned long insn, long value, int dialect, const char **errmsg)
{
  if (!valid_bo (value, dialect))
    *errmsg = _("invalid conditional option");
  else if ((value & 1) != 0)
...
insert_dq (unsigned long insn,
	   long value, int dialect ATTRIBUTE_UNUSED, const char **errmsg)
{
  if ((value & 0xf) != 0)
...
static unsigned long
insert_fxm (unsigned long insn, long value, int dialect, const char **errmsg)
{
...
static long
extract_fxm (unsigned long insn, int dialect ATTRIBUTE_UNUSED, int *invalid)
{
...
static long
extract_mbe (unsigned long insn, int dialect ATTRIBUTE_UNUSED, int *invalid)
{
  long ret;
  int mb, me;
  int i;
...
static long
extract_nsi (unsigned long insn, int dialect ATTRIBUTE_UNUSED, int *invalid)
{
  *invalid = 1;
...
static long
extract_rbs (unsigned long insn, int dialect ATTRIBUTE_UNUSED, int *invalid)
{
