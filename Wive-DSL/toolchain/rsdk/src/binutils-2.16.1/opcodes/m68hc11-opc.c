...
const struct m68hc11_opcode m68hc11_opcodes[] = {
  ...
  {"bclr", OP_BITMASK | OP_IY | OP_PAGE2, 4, 0x1d, 8, 8, CLR_V_CHG_NZ,
   cpu6811},
  ...
  {"brclr", OP_BITMASK
   | OP_JUMP_REL | OP_IDX_2, 6, 0x0f, 8, 8, CHG_NONE, cpu6812},
  ...
  {"brset", OP_BITMASK
   | OP_JUMP_REL | OP_IX, 4, 0x1e, 7, 7, CHG_NONE, cpu6811},
  {"brset", OP_BITMASK | OP_JUMP_REL
  ...
  {"bset", OP_BITMASK | OP_IY | OP_PAGE2, 4, 0x1c, 8, 8, CLR_V_CHG_NZ,
   cpu6811},
  ...
  {"call", OP_IND16 | OP_PAGE | OP_BRANCH, 4, 0x4a, 8, 8, CHG_NONE, cpu6812},
  {"call", OP_IDX | OP_PAGE | OP_BRANCH, 3, 0x4b, 8, 8, CHG_NONE, cpu6812},
  {"call", OP_IDX_1 | OP_PAGE | OP_BRANCH, 4, 0x4b, 8, 8, CHG_NONE, cpu6812},
  {"call", OP_IDX_2 | OP_PAGE | OP_BRANCH, 5, 0x4b, 9, 9, CHG_NONE, cpu6812},
  {"call", OP_D_IDX | OP_BRANCH, 2, 0x4b, 10, 10, CHG_NONE, cpu6812},
  {"call", OP_D_IDX_2 | OP_BRANCH, 4, 0x4b, 10, 10, CHG_NONE, cpu6812},
  ...
  {"movb", OP_IMM8 | OP_IND16_p2 | OP_PAGE2, 5, 0x0b, 4, 4, CHG_NONE,
   cpu6812},
  {"movb", OP_IMM8 | OP_IDX_p2 | OP_PAGE2, 4, 0x08, 4, 4, CHG_NONE, cpu6812},
  {"movb", OP_IND16 | OP_IND16_p2 | OP_PAGE2, 6, 0x0c, 6, 6, CHG_NONE,
   cpu6812},
  ...
  {"movw", OP_IMM16 | OP_IND16_p2 | OP_PAGE2, 6, 0x03, 5, 5, CHG_NONE,
   cpu6812},
  {"movw", OP_IMM16 | OP_IDX_p2 | OP_PAGE2, 5, 0x00, 4, 4, CHG_NONE, cpu6812},
  {"movw", OP_IND16 | OP_IND16_p2 | OP_PAGE2, 6, 0x04, 6, 6, CHG_NONE,
   cpu6812},
