     ...
     bfd_vma pc ATTRIBUTE_UNUSED;
{
  ...
  switch (opindex)
    ...
    case IQ2000_OPERAND__INDEX:
      errmsg =
	insert_normal (cd, fields->f_index, 0, 0, 8, 9, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_BASE:
      errmsg =
	insert_normal (cd, fields->f_rs, 0, 0, 25, 5, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_BASEOFF:
      errmsg =
	insert_normal (cd, fields->f_imm, 0, 0, 15, 16, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_BITNUM:
      errmsg =
	insert_normal (cd, fields->f_rt, 0, 0, 20, 5, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_BYTECOUNT:
      errmsg =
	insert_normal (cd, fields->f_bytecount, 0, 0, 7, 8, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_CAM_Y:
      errmsg =
	insert_normal (cd, fields->f_cam_y, 0, 0, 2, 3, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_CAM_Z:
      errmsg =
	insert_normal (cd, fields->f_cam_z, 0, 0, 5, 3, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_CM_3FUNC:
      errmsg =
	insert_normal (cd, fields->f_cm_3func, 0, 0, 5, 3, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_CM_3Z:
      errmsg =
	insert_normal (cd, fields->f_cm_3z, 0, 0, 1, 2, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_CM_4FUNC:
      errmsg =
	insert_normal (cd, fields->f_cm_4func, 0, 0, 5, 4, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_CM_4Z:
      errmsg =
	insert_normal (cd, fields->f_cm_4z, 0, 0, 2, 3, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_COUNT:
      errmsg =
	insert_normal (cd, fields->f_count, 0, 0, 15, 7, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_EXECODE:
      errmsg =
	insert_normal (cd, fields->f_excode, 0, 0, 25, 20, 32, total_length,
		       buffer);
      break;
	...
	errmsg =
	  insert_normal (cd, value, 0 | (1 << CGEN_IFLD_ABS_ADDR), 0, 15, 16,
	...
	errmsg =
	  insert_normal (cd, value, 0 | (1 << CGEN_IFLD_ABS_ADDR), 0, 20, 21,
			 32, total_length, buffer);
      }
      break;
    ...
    case IQ2000_OPERAND_MASK:
      errmsg =
	insert_normal (cd, fields->f_mask, 0, 0, 9, 4, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_MASKL:
      errmsg =
	insert_normal (cd, fields->f_maskl, 0, 0, 4, 5, 32, total_length,
		       buffer);
      break;
    case IQ2000_OPERAND_MASKQ10:
      errmsg =
	insert_normal (cd, fields->f_maskq10, 0, 0, 10, 5, 32, total_length,
		       buffer);
      break;
    ...
    case IQ2000_OPERAND_RD:
      errmsg =
	insert_normal (cd, fields->f_rd, 0, 0, 15, 5, 32, total_length,
		       buffer);
      break;
    ...
    case IQ2000_OPERAND_SHAMT:
      errmsg =
	insert_normal (cd, fields->f_shamt, 0, 0, 10, 5, 32, total_length,
		       buffer);
      break;
     ...
     bfd_vma pc;
{
  ...
  switch (opindex)
    ...
    case IQ2000_OPERAND__INDEX:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 8, 9, 32, total_length,
			pc, &fields->f_index);
      break;
    case IQ2000_OPERAND_BASE:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 25, 5, 32,
			total_length, pc, &fields->f_rs);
      break;
    case IQ2000_OPERAND_BASEOFF:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 15, 16, 32,
			total_length, pc, &fields->f_imm);
      break;
    case IQ2000_OPERAND_BITNUM:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 20, 5, 32,
			total_length, pc, &fields->f_rt);
      break;
    case IQ2000_OPERAND_BYTECOUNT:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 7, 8, 32, total_length,
			pc, &fields->f_bytecount);
      break;
    case IQ2000_OPERAND_CAM_Y:
      length =
    ...
    case IQ2000_OPERAND_CAM_Z:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 5, 3, 32, total_length,
			pc, &fields->f_cam_z);
      break;
    case IQ2000_OPERAND_CM_3FUNC:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 5, 3, 32, total_length,
			pc, &fields->f_cm_3func);
      break;
    case IQ2000_OPERAND_CM_3Z:
      length =
    ...
    case IQ2000_OPERAND_CM_4FUNC:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 5, 4, 32, total_length,
			pc, &fields->f_cm_4func);
      break;
    case IQ2000_OPERAND_CM_4Z:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 2, 3, 32, total_length,
    ...
    case IQ2000_OPERAND_COUNT:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 15, 7, 32,
			total_length, pc, &fields->f_count);
      break;
    case IQ2000_OPERAND_EXECODE:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 25, 20, 32,
			total_length, pc, &fields->f_excode);
      break;
    case IQ2000_OPERAND_HI16:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 15, 16, 32,
	...
	length =
	  extract_normal (cd, ex_info, insn_value,
			  0 | (1 << CGEN_IFLD_ABS_ADDR), 0, 15, 16, 32,
	...
	length =
	  extract_normal (cd, ex_info, insn_value,
			  0 | (1 << CGEN_IFLD_ABS_ADDR), 0, 20, 21, 32,
			  total_length, pc, &value);
	value = ((((pc) & (0xf0000000))) | (((value) << (2))));
    ...
    case IQ2000_OPERAND_MASK:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 9, 4, 32, total_length,
			pc, &fields->f_mask);
      break;
    case IQ2000_OPERAND_MASKL:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 4, 5, 32, total_length,
			pc, &fields->f_maskl);
      break;
    case IQ2000_OPERAND_MASKQ10:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 10, 5, 32,
			total_length, pc, &fields->f_maskq10);
      break;
    case IQ2000_OPERAND_MASKR:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 25, 5, 32,
    ...
    case IQ2000_OPERAND_RD:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 15, 5, 32,
    ...
    case IQ2000_OPERAND_SHAMT:
      length =
	extract_normal (cd, ex_info, insn_value, 0, 0, 10, 5, 32,
			total_length, pc, &fields->f_shamt);
      break;
