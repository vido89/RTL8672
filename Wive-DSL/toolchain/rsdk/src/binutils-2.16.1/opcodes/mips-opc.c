...
/* name,    args,	match,	    mask,	pinfo,          	pinfo2,		membership */
  ...
  {"add.s", "D,V,T", 0x46000000, 0xffe0003f, WR_D | RD_S | RD_T | FP_S, 0,
   I1},
  {"add.d", "D,V,T", 0x46200000, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I1},
  {"add.ob", "X,Y,Q", 0x7800000b, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"add.ps", "D,V,T", 0x46c00000, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  {"add.qh", "X,Y,Q", 0x7820000b, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  ...
  {"addr.ps", "D,S,T", 0x46c00018, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   M3D},
  {"addu", "d,v,t", 0x00000021, 0xfc0007ff, WR_d | RD_s | RD_t, 0, I1},
  {"addu", "t,r,I", 0, (int) M_ADDU_I, INSN_MACRO, 0, I1},
  {"alni.ob", "X,Y,Z,O", 0x78000018, 0xff00003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  {"alni.ob", "D,S,T,%", 0x48000018, 0xff00003f, WR_D | RD_S | RD_T, 0, N54},
  {"alni.qh", "X,Y,Z,O", 0x7800001a, 0xff00003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  {"alnv.ps", "D,V,T,s", 0x4c00001e, 0xfc00003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  {"alnv.ob", "X,Y,Z,s", 0x78000019, 0xfc00003f,
   WR_D | RD_S | RD_T | RD_s | FP_D, 0, MX | SB1},
  {"alnv.qh", "X,Y,Z,s", 0x7800001b, 0xfc00003f,
   WR_D | RD_S | RD_T | RD_s | FP_D, 0, MX},
  {"and", "d,v,t", 0x00000024, 0xfc0007ff, WR_d | RD_s | RD_t, 0, I1},
  {"and", "t,r,I", 0, (int) M_AND_I, INSN_MACRO, 0, I1},
  {"and.ob", "X,Y,Q", 0x7800000c, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"and.qh", "X,Y,Q", 0x7820000c, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
...
/* bc2* are at the bottom of the table.  */
  ...
  {"c.f.d", "M,S,T", 0x46200030, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.f.s", "S,T", 0x46000030, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0, I1},
  {"c.f.s", "M,S,T", 0x46000030, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.f.ps", "S,T", 0x46c00030, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.f.ps", "M,S,T", 0x46c00030, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.un.d", "S,T", 0x46200031, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  ...
  {"c.un.s", "M,S,T", 0x46000031, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.un.ps", "S,T", 0x46c00031, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.un.ps", "M,S,T", 0x46c00031, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.eq.d", "S,T", 0x46200032, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.eq.d", "M,S,T", 0x46200032, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.eq.s", "S,T", 0x46000032, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.eq.s", "M,S,T", 0x46000032, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.eq.ob", "Y,Q", 0x78000001, 0xfc2007ff, WR_CC | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"c.eq.ps", "S,T", 0x46c00032, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.eq.ps", "M,S,T", 0x46c00032, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.eq.qh", "Y,Q", 0x78200001, 0xfc2007ff, WR_CC | RD_S | RD_T | FP_D, 0,
   MX},
  {"c.ueq.d", "S,T", 0x46200033, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.ueq.d", "M,S,T", 0x46200033, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.ueq.s", "S,T", 0x46000033, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.ueq.s", "M,S,T", 0x46000033, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.ueq.ps", "S,T", 0x46c00033, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ueq.ps", "M,S,T", 0x46c00033, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.olt.d", "S,T", 0x46200034, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.olt.d", "M,S,T", 0x46200034, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.olt.s", "S,T", 0x46000034, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.olt.s", "M,S,T", 0x46000034, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.olt.ps", "S,T", 0x46c00034, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.olt.ps", "M,S,T", 0x46c00034, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ult.d", "S,T", 0x46200035, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.ult.d", "M,S,T", 0x46200035, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.ult.s", "S,T", 0x46000035, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.ult.s", "M,S,T", 0x46000035, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.ult.ps", "S,T", 0x46c00035, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ult.ps", "M,S,T", 0x46c00035, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ole.d", "S,T", 0x46200036, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.ole.d", "M,S,T", 0x46200036, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.ole.s", "S,T", 0x46000036, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.ole.s", "M,S,T", 0x46000036, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.ole.ps", "S,T", 0x46c00036, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ole.ps", "M,S,T", 0x46c00036, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ule.d", "S,T", 0x46200037, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.ule.d", "M,S,T", 0x46200037, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.ule.s", "S,T", 0x46000037, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.ule.s", "M,S,T", 0x46000037, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.ule.ps", "S,T", 0x46c00037, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ule.ps", "M,S,T", 0x46c00037, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.sf.d", "S,T", 0x46200038, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.sf.d", "M,S,T", 0x46200038, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.sf.s", "S,T", 0x46000038, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.sf.s", "M,S,T", 0x46000038, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.sf.ps", "S,T", 0x46c00038, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.sf.ps", "M,S,T", 0x46c00038, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ngle.d", "S,T", 0x46200039, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.ngle.d", "M,S,T", 0x46200039, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.ngle.s", "S,T", 0x46000039, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.ngle.s", "M,S,T", 0x46000039, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.ngle.ps", "S,T", 0x46c00039, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ngle.ps", "M,S,T", 0x46c00039, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D,
   0, I5},
  {"c.seq.d", "S,T", 0x4620003a, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.seq.d", "M,S,T", 0x4620003a, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.seq.s", "S,T", 0x4600003a, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.seq.s", "M,S,T", 0x4600003a, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.seq.ps", "S,T", 0x46c0003a, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.seq.ps", "M,S,T", 0x46c0003a, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ngl.d", "S,T", 0x4620003b, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.ngl.d", "M,S,T", 0x4620003b, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.ngl.s", "S,T", 0x4600003b, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.ngl.s", "M,S,T", 0x4600003b, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.ngl.ps", "S,T", 0x46c0003b, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ngl.ps", "M,S,T", 0x46c0003b, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.lt.d", "S,T", 0x4620003c, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.lt.d", "M,S,T", 0x4620003c, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.lt.s", "S,T", 0x4600003c, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.lt.s", "M,S,T", 0x4600003c, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.lt.ob", "Y,Q", 0x78000004, 0xfc2007ff, WR_CC | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"c.lt.ps", "S,T", 0x46c0003c, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.lt.ps", "M,S,T", 0x46c0003c, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.lt.qh", "Y,Q", 0x78200004, 0xfc2007ff, WR_CC | RD_S | RD_T | FP_D, 0,
   MX},
  {"c.nge.d", "S,T", 0x4620003d, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.nge.d", "M,S,T", 0x4620003d, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.nge.s", "S,T", 0x4600003d, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.nge.s", "M,S,T", 0x4600003d, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.nge.ps", "S,T", 0x46c0003d, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.nge.ps", "M,S,T", 0x46c0003d, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.le.d", "S,T", 0x4620003e, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.le.d", "M,S,T", 0x4620003e, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.le.s", "S,T", 0x4600003e, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.le.s", "M,S,T", 0x4600003e, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.le.ob", "Y,Q", 0x78000005, 0xfc2007ff, WR_CC | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"c.le.ps", "S,T", 0x46c0003e, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.le.ps", "M,S,T", 0x46c0003e, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.le.qh", "Y,Q", 0x78200005, 0xfc2007ff, WR_CC | RD_S | RD_T | FP_D, 0,
   MX},
  {"c.ngt.d", "S,T", 0x4620003f, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I1},
  {"c.ngt.d", "M,S,T", 0x4620003f, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I4 | I32},
  {"c.ngt.s", "S,T", 0x4600003f, 0xffe007ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I1},
  {"c.ngt.s", "M,S,T", 0x4600003f, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   I4 | I32},
  {"c.ngt.ps", "S,T", 0x46c0003f, 0xffe007ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  {"c.ngt.ps", "M,S,T", 0x46c0003f, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   I5},
  ...
  {"cabs.eq.s", "M,S,T", 0x46000072, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S,
   0, M3D},
  {"cabs.f.d", "M,S,T", 0x46200070, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D, 0,
   M3D},
  {"cabs.f.ps", "M,S,T", 0x46c00070, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D,
   0, M3D},
  {"cabs.f.s", "M,S,T", 0x46000070, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S, 0,
   M3D},
  ...
  {"cabs.ngle.d", "M,S,T", 0x46200079, 0xffe000ff, RD_S | RD_T | WR_CC | FP_D,
   0, M3D},
  {"cabs.ngle.ps", "M,S,T", 0x46c00079, 0xffe000ff,
   RD_S | RD_T | WR_CC | FP_D, 0, M3D},
  ...
  {"cabs.un.s", "M,S,T", 0x46000071, 0xffe000ff, RD_S | RD_T | WR_CC | FP_S,
   0, M3D},
  {"cache", "k,o(b)", 0xbc000000, 0xfc000000, RD_b, 0, I3 | I32 | T3 | RLX3},
...
/* ctc2 is at the bottom of the table.  */
  ...
  {"cvt.d.s", "D,S", 0x46000021, 0xffff003f, WR_D | RD_S | FP_D | FP_S, 0,
   I1},
  ...
  {"cvt.s.d", "D,S", 0x46200020, 0xffff003f, WR_D | RD_S | FP_S | FP_D, 0,
   I1},
  {"cvt.s.w", "D,S", 0x46800020, 0xffff003f, WR_D | RD_S | FP_S, 0, I1},
  {"cvt.s.pl", "D,S", 0x46c00028, 0xffff003f, WR_D | RD_S | FP_S | FP_D, 0,
   I5},
  {"cvt.s.pu", "D,S", 0x46c00020, 0xffff003f, WR_D | RD_S | FP_S | FP_D, 0,
   I5},
  {"cvt.w.d", "D,S", 0x46200024, 0xffff003f, WR_D | RD_S | FP_D, 0, I1},
  {"cvt.w.s", "D,S", 0x46000024, 0xffff003f, WR_D | RD_S | FP_S, 0, I1},
  {"cvt.ps.pw", "D,S", 0x46800026, 0xffff003f, WR_D | RD_S | FP_S | FP_D, 0,
   M3D},
  {"cvt.ps.s", "D,V,T", 0x46000026, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  {"cvt.pw.ps", "D,S", 0x46c00024, 0xffff003f, WR_D | RD_S | FP_S | FP_D, 0,
   M3D},
...
/* dctr and dctw are used on the r5000.  */
  ...
  {"deret", "", 0x4200001f, 0xffffffff, 0, 0, I32 | G2 | RLX1},
...
/* For divu, see the comments about div.  */
  ...
  {"dmacc", "d,s,t", 0x00000029, 0xfc0007ff, RD_s | RD_t | WR_LO | WR_d, 0,
   N412},
  {"dmacchi", "d,s,t", 0x00000229, 0xfc0007ff, RD_s | RD_t | WR_LO | WR_d, 0,
   N412},
  {"dmacchis", "d,s,t", 0x00000629, 0xfc0007ff, RD_s | RD_t | WR_LO | WR_d, 0,
   N412},
  {"dmacchiu", "d,s,t", 0x00000269, 0xfc0007ff, RD_s | RD_t | WR_LO | WR_d, 0,
   N412},
  {"dmacchius", "d,s,t", 0x00000669, 0xfc0007ff, RD_s | RD_t | WR_LO | WR_d,
   0, N412},
  {"dmaccs", "d,s,t", 0x00000429, 0xfc0007ff, RD_s | RD_t | WR_LO | WR_d, 0,
   N412},
  {"dmaccu", "d,s,t", 0x00000069, 0xfc0007ff, RD_s | RD_t | WR_LO | WR_d, 0,
   N412},
  {"dmaccus", "d,s,t", 0x00000469, 0xfc0007ff, RD_s | RD_t | WR_LO | WR_d, 0,
   N412},
  ...
  {"dmtc0", "t,+D", 0x40a00000, 0xffe007f8, COD | RD_t | WR_C0 | WR_CC, 0,
   I64},
  {"dmtc0", "t,G,H", 0x40a00000, 0xffe007f8, COD | RD_t | WR_C0 | WR_CC, 0,
   I64},
...
/* dmtc2 is at the bottom of the table.  */
  ...
  {"dmtc3", "t,G,H", 0x4ca00000, 0xffe007f8, COD | RD_t | WR_C3 | WR_CC, 0,
   I64},
...
/* This form of jal is used by the disassembler and internally by the
  ...
  {"ldxc1", "D,t(b)", 0x4c000001, 0xfc00f83f, LDD | WR_D | RD_t | RD_b, 0,
   I4},
...
/* li is at the start of the table.  */
  ...
  {"luxc1", "D,t(b)", 0x4c000005, 0xfc00f83f, LDD | WR_D | RD_t | RD_b, 0,
   I5 | N55},
  ...
  {"lwxc1", "D,t(b)", 0x4c000000, 0xfc00f83f, LDD | WR_D | RD_t | RD_b, 0,
   I4},
  {"macc", "d,s,t", 0x00000028, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N412},
  {"macc", "d,s,t", 0x00000158, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  {"maccs", "d,s,t", 0x00000428, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N412},
  {"macchi", "d,s,t", 0x00000228, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N412},
  {"macchi", "d,s,t", 0x00000358, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  ...
  {"macchius", "d,s,t", 0x00000668, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d,
   0, N412},
  {"maccu", "d,s,t", 0x00000068, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N412},
  {"maccu", "d,s,t", 0x00000159, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  {"maccus", "d,s,t", 0x00000468, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N412},

/* 2006-01-19 tonywu: */
  {"mad", "s,t", 0x70000000, 0xfc00ffff, RD_s | RD_t | MOD_HILO, 0,
   P3 | RLX1},
  {"madu", "s,t", 0x70000001, 0xfc00ffff, RD_s | RD_t | MOD_HILO, 0,
   P3 | RLX1},

  {"madd.d", "D,R,S,T", 0x4c000021, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_D, 0, I4},
  {"madd.s", "D,R,S,T", 0x4c000020, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_S, 0, I4},
  {"madd.ps", "D,R,S,T", 0x4c000026, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_D, 0, I5},
  {"madd", "s,t", 0x0000001c, 0xfc00ffff, RD_s | RD_t | WR_HILO, 0, L1},
  {"madd", "s,t", 0x70000000, 0xfc00ffff, RD_s | RD_t | MOD_HILO, 0,
   I32 | N55},
  {"madd", "s,t", 0x70000000, 0xfc00ffff, RD_s | RD_t | WR_HILO | IS_M, 0,
   G1},
  {"madd", "d,s,t", 0x70000000, 0xfc0007ff,
   RD_s | RD_t | WR_HILO | WR_d | IS_M, 0, G1},
  {"maddu", "s,t", 0x0000001d, 0xfc00ffff, RD_s | RD_t | WR_HILO, 0, L1},
  {"maddu", "s,t", 0x70000001, 0xfc00ffff, RD_s | RD_t | MOD_HILO, 0,
   I32 | N55},
  {"maddu", "s,t", 0x70000001, 0xfc00ffff, RD_s | RD_t | WR_HILO | IS_M, 0,
   G1},
  {"maddu", "d,s,t", 0x70000001, 0xfc0007ff,
   RD_s | RD_t | WR_HILO | WR_d | IS_M, 0, G1},
  ...
  {"max.qh", "X,Y,Q", 0x78200007, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
...
/* mfhc2 is at the bottom of the table.  */
  ...
  {"min.qh", "X,Y,Q", 0x78200006, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  ...
  {"movf", "d,s,N", 0x00000001, 0xfc0307ff, WR_d | RD_s | RD_CC | FP_D | FP_S,
   0, I4 | I32},
  {"movf.d", "D,S,N", 0x46200011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_D, 0,
   I4 | I32},
  {"movf.l", "D,S,N", 0x46a00011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_D, 0,
   MX | SB1},
  {"movf.l", "X,Y,N", 0x46a00011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_D, 0,
   MX | SB1},
  {"movf.s", "D,S,N", 0x46000011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_S, 0,
   I4 | I32},
  {"movf.ps", "D,S,N", 0x46c00011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_D, 0,
   I5},
  {"movn", "d,v,t", 0x0000000b, 0xfc0007ff, WR_d | RD_s | RD_t, 0,
   I4 | I32 | RLX2},
  {"ffc", "d,v", 0x0000000b, 0xfc1f07ff, WR_d | RD_s, 0, L1},
  {"movn.d", "D,S,t", 0x46200013, 0xffe0003f, WR_D | RD_S | RD_t | FP_D, 0,
   I4 | I32},
  {"movn.l", "D,S,t", 0x46a00013, 0xffe0003f, WR_D | RD_S | RD_t | FP_D, 0,
   MX | SB1},
  {"movn.l", "X,Y,t", 0x46a00013, 0xffe0003f, WR_D | RD_S | RD_t | FP_D, 0,
   MX | SB1},
  {"movn.s", "D,S,t", 0x46000013, 0xffe0003f, WR_D | RD_S | RD_t | FP_S, 0,
   I4 | I32},
  {"movn.ps", "D,S,t", 0x46c00013, 0xffe0003f, WR_D | RD_S | RD_t | FP_D, 0,
   I5},
  {"movt", "d,s,N", 0x00010001, 0xfc0307ff, WR_d | RD_s | RD_CC, 0, I4 | I32},
  {"movt.d", "D,S,N", 0x46210011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_D, 0,
   I4 | I32},
  {"movt.l", "D,S,N", 0x46a10011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_D, 0,
   MX | SB1},
  {"movt.l", "X,Y,N", 0x46a10011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_D, 0,
   MX | SB1},
  {"movt.s", "D,S,N", 0x46010011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_S, 0,
   I4 | I32},
  {"movt.ps", "D,S,N", 0x46c10011, 0xffe3003f, WR_D | RD_S | RD_CC | FP_D, 0,
   I5},

  {"movz", "d,v,t", 0x0000000a, 0xfc0007ff, WR_d | RD_s | RD_t, 0,
   I4 | I32 | RLX2},
  {"ffs", "d,v", 0x0000000a, 0xfc1f07ff, WR_d | RD_s, 0, L1},
  {"movz.d", "D,S,t", 0x46200012, 0xffe0003f, WR_D | RD_S | RD_t | FP_D, 0,
   I4 | I32},
  {"movz.l", "D,S,t", 0x46a00012, 0xffe0003f, WR_D | RD_S | RD_t | FP_D, 0,
   MX | SB1},
  {"movz.l", "X,Y,t", 0x46a00012, 0xffe0003f, WR_D | RD_S | RD_t | FP_D, 0,
   MX | SB1},
  {"movz.s", "D,S,t", 0x46000012, 0xffe0003f, WR_D | RD_S | RD_t | FP_S, 0,
   I4 | I32},
  {"movz.ps", "D,S,t", 0x46c00012, 0xffe0003f, WR_D | RD_S | RD_t | FP_D, 0,
   I5},
  {"msac", "d,s,t", 0x000001d8, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  {"msacu", "d,s,t", 0x000001d9, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  {"msachi", "d,s,t", 0x000003d8, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  {"msachiu", "d,s,t", 0x000003d9, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d,
   0, N5},
/* move is at the top of the table.  */
  {"msgn.qh", "X,Y,Q", 0x78200000, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  {"msub.d", "D,R,S,T", 0x4c000029, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_D, 0, I4},
  {"msub.s", "D,R,S,T", 0x4c000028, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_S, 0, I4},
  {"msub.ps", "D,R,S,T", 0x4c00002e, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_D, 0, I5},
/* 2006-01-19 tonywu: */
  {"msub", "s,t", 0x70000004, 0xfc00ffff, RD_s | RD_t | MOD_HILO, 0,
   I32 | N55 | RLX1},
  ...
  {"mtc0", "t,+D", 0x40800000, 0xffe007f8, COD | RD_t | WR_C0 | WR_CC, 0,
   I32},
  {"mtc0", "t,G,H", 0x40800000, 0xffe007f8, COD | RD_t | WR_C0 | WR_CC, 0,
   I32},
...
/* mthc2 is at the bottom of the table.  */
  ...
  {"mtc3", "t,G,H", 0x4c800000, 0xffe007f8, COD | RD_t | WR_C3 | WR_CC, 0,
   I32},
  {"mtdr", "t,G", 0x7080003d, 0xffe007ff, COD | RD_t | WR_C0, 0, N5},
  {"mthi", "s", 0x00000011, 0xfc1fffff, RD_s | WR_HI, 0, I1},
  {"mtlo", "s", 0x00000013, 0xfc1fffff, RD_s | WR_LO, 0, I1},
  {"mul.d", "D,V,T", 0x46200002, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I1},
  {"mul.s", "D,V,T", 0x46000002, 0xffe0003f, WR_D | RD_S | RD_T | FP_S, 0,
   I1},
  {"mul.ob", "X,Y,Q", 0x78000030, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"mul.ps", "D,V,T", 0x46c00002, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  {"mul.qh", "X,Y,Q", 0x78200030, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  {"mul", "d,v,t", 0x70000002, 0xfc0007ff, WR_d | RD_s | RD_t | WR_HILO, 0,
   I32 | P3 | N55},
  {"mul", "d,s,t", 0x00000058, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N54},
  ...
  {"mulhi", "d,s,t", 0x00000258, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  {"mulhiu", "d,s,t", 0x00000259, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  ...
  {"mulr.ps", "D,S,T", 0x46c0001a, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   M3D},
  {"muls", "d,s,t", 0x000000d8, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  {"mulsu", "d,s,t", 0x000000d9, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  {"mulshi", "d,s,t", 0x000002d8, 0xfc0007ff, RD_s | RD_t | WR_HILO | WR_d, 0,
   N5},
  ...
  {"mult", "s,t", 0x00000018, 0xfc00ffff, RD_s | RD_t | WR_HILO | IS_M, 0,
   I1},
  {"mult", "d,s,t", 0x00000018, 0xfc0007ff,
   RD_s | RD_t | WR_HILO | WR_d | IS_M, 0, G1},
  {"multu", "s,t", 0x00000019, 0xfc00ffff, RD_s | RD_t | WR_HILO | IS_M, 0,
   I1},
  {"multu", "d,s,t", 0x00000019, 0xfc0007ff,
   RD_s | RD_t | WR_HILO | WR_d | IS_M, 0, G1},
  ...
  {"nmadd.d", "D,R,S,T", 0x4c000031, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_D, 0, I4},
  {"nmadd.s", "D,R,S,T", 0x4c000030, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_S, 0, I4},
  {"nmadd.ps", "D,R,S,T", 0x4c000036, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_D, 0, I5},
  {"nmsub.d", "D,R,S,T", 0x4c000039, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_D, 0, I4},
  {"nmsub.s", "D,R,S,T", 0x4c000038, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_S, 0, I4},
  {"nmsub.ps", "D,R,S,T", 0x4c00003e, 0xfc00003f,
   RD_R | RD_S | RD_T | WR_D | FP_D, 0, I5},
/* nop is at the start of the table.  */
  {"nor", "d,v,t", 0x00000027, 0xfc0007ff, WR_d | RD_s | RD_t, 0, I1},
  {"nor", "t,r,I", 0, (int) M_NOR_I, INSN_MACRO, 0, I1},
  {"nor.ob", "X,Y,Q", 0x7800000f, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"nor.qh", "X,Y,Q", 0x7820000f, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  ...
  {"or.ob", "X,Y,Q", 0x7800000e, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"or.qh", "X,Y,Q", 0x7820000e, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  ...
  {"pabsdiffc.ob", "Y,Q", 0x78000035, 0xfc2007ff, RD_S | RD_T | FP_D, WR_MACC,
   SB1},
  {"pavg.ob", "X,Y,Q", 0x78000008, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   SB1},
  {"pickf.ob", "X,Y,Q", 0x78000002, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  {"pickf.ob", "D,S,T", 0x4ac00002, 0xffe0003f, WR_D | RD_S | RD_T, 0, N54},
  {"pickf.ob", "D,S,T[e]", 0x48000002, 0xfe20003f, WR_D | RD_S | RD_T, 0,
   N54},
  {"pickf.ob", "D,S,k", 0x4bc00002, 0xffe0003f, WR_D | RD_S | RD_T, 0, N54},
  {"pickf.qh", "X,Y,Q", 0x78200002, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  {"pickt.ob", "X,Y,Q", 0x78000003, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  {"pickt.ob", "D,S,T", 0x4ac00003, 0xffe0003f, WR_D | RD_S | RD_T, 0, N54},
  {"pickt.ob", "D,S,T[e]", 0x48000003, 0xfe20003f, WR_D | RD_S | RD_T, 0,
   N54},
  {"pickt.ob", "D,S,k", 0x4bc00003, 0xffe0003f, WR_D | RD_S | RD_T, 0, N54},
  {"pickt.qh", "X,Y,Q", 0x78200003, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  {"pll.ps", "D,V,T", 0x46c0002c, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  {"plu.ps", "D,V,T", 0x46c0002d, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  /* pref and prefx are at the start of the table.  */
  {"pul.ps", "D,V,T", 0x46c0002e, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  {"puu.ps", "D,V,T", 0x46c0002f, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  ...
  {"recip2.d", "D,S,T", 0x4620001c, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   M3D},
  {"recip2.ps", "D,S,T", 0x46c0001c, 0xffe0003f, WR_D | RD_S | RD_T | FP_S, 0,
   M3D},
  {"recip2.s", "D,S,T", 0x4600001c, 0xffe0003f, WR_D | RD_S | RD_T | FP_S, 0,
   M3D},
  ...
  {"rsqrt2.d", "D,S,T", 0x4620001f, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   M3D},
  {"rsqrt2.ps", "D,S,T", 0x46c0001f, 0xffe0003f, WR_D | RD_S | RD_T | FP_S, 0,
   M3D},
  {"rsqrt2.s", "D,S,T", 0x4600001f, 0xffe0003f, WR_D | RD_S | RD_T | FP_S, 0,
   M3D},
...
/* 2006-01-11 tonywu: commmented out old sdbbp */
#if 0
  {"sdbbp", "", 0x0000000e, 0xffffffff, TRAP, 0, G2 | I1},
  {"sdbbp", "c", 0x0000000e, 0xfc00ffff, TRAP, 0, G2 | I1},
  {"sdbbp", "c,q", 0x0000000e, 0xfc00003f, TRAP, 0, G2 | I1},
#endif
  {"sdbbp", "", 0x7000003f, 0xffffffff, TRAP, 0, I32 | I1},
  {"sdbbp", "B", 0x7000003f, 0xfc00003f, TRAP, 0, I32 | I1},
  ...
  {"sll.ob", "X,Y,Q", 0x78000010, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  {"sll.ob", "D,S,T[e]", 0x48000010, 0xfe20003f, WR_D | RD_S | RD_T, 0, N54},
  {"sll.ob", "D,S,k", 0x4bc00010, 0xffe0003f, WR_D | RD_S | RD_T, 0, N54},
  {"sll.qh", "X,Y,Q", 0x78200010, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  ...
  {"sra.qh", "X,Y,Q", 0x78200013, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  ...
  {"srl.ob", "X,Y,Q", 0x78000012, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  {"srl.ob", "D,S,T[e]", 0x48000012, 0xfe20003f, WR_D | RD_S | RD_T, 0, N54},
  {"srl.ob", "D,S,k", 0x4bc00012, 0xffe0003f, WR_D | RD_S | RD_T, 0, N54},
  {"srl.qh", "X,Y,Q", 0x78200012, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
/* ssnop is at the start of the table.  */
  ...
  {"sub.d", "D,V,T", 0x46200001, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I1},
  {"sub.s", "D,V,T", 0x46000001, 0xffe0003f, WR_D | RD_S | RD_T | FP_S, 0,
   I1},
  {"sub.ob", "X,Y,Q", 0x7800000a, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"sub.ps", "D,V,T", 0x46c00001, 0xffe0003f, WR_D | RD_S | RD_T | FP_D, 0,
   I5},
  {"sub.qh", "X,Y,Q", 0x7820000a, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
  ...
  {"suxc1", "S,t(b)", 0x4c00000d, 0xfc0007ff, SM | RD_S | RD_t | RD_b, 0,
   I5 | N55},
  ...
  {"xor.ob", "X,Y,Q", 0x7800000d, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX | SB1},
  ...
  {"xor.qh", "X,Y,Q", 0x7820000d, 0xfc20003f, WR_D | RD_S | RD_T | FP_D, 0,
   MX},
...
/* Coprocessor 2 move/branch operations overlap with VR5400 .ob format
  ...
  {"dmtc2", "t,G,H", 0x48a00000, 0xffe007f8, COD | RD_t | WR_C2 | WR_CC, 0,
   I64},
  ...
  {"mtc2", "t,G,H", 0x48800000, 0xffe007f8, COD | RD_t | WR_C2 | WR_CC, 0,
   I32},
  {"mthc2", "t,i", 0x48e00000, 0xffe00000, COD | RD_t | WR_C2 | WR_CC, 0,
   I33},

/* dbb: modified for supporting radiax instructions */
/* 2006-01-19 tonywu: cleanup radiax instructions definition */
  {"mta2", "s,d", 0x7c00005d, 0xfc1f07ff, RD_s, 0, RLX4},
  {"mta2.g", "s,d", 0x7c00015d, 0xfc1f07ff, RD_s, 0, RLX4},
  {"mfa", "d,t", 0x7C00001C, 0xFFE007FF, WR_d, 0, RLX4},
  {"mfa", "d,t,#", 0x7C00001C, 0xFFE0007F, WR_d, 0, RLX4},
  {"mfa2", "d,t", 0x7C00005C, 0xFFE007FF, WR_d, 0, RLX4},
  {"mfa2", "d,t,#", 0x7C00005C, 0xFFE0007F, WR_d, 0, RLX4},
  {"diva", "d,s,t", 0x7C00001A, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"divau", "d,s,t", 0x7C00021A, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"multa", "d,s,t", 0x7C000112, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"multau", "d,s,t", 0x7C000312, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"multa2", "d,s,t", 0x7C000152, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"mulna2", "d,s,t", 0x7C000153, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"cmulta", "d,s,t", 0x7C00001B, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"madda", "d,s,t", 0x7C000012, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"maddau", "d,s,t", 0x7C000212, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"madda2", "d,s,t", 0x7C000052, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"madda2.s", "d,s,t", 0x7C0000D2, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"msuba", "d,s,t", 0x7C000013, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"msubau", "d,s,t", 0x7C000213, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"msuba2", "d,s,t", 0x7C000053, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"msuba2.s", "d,s,t", 0x7C0000D3, 0xFC0007FF, RD_t | RD_s, 0, RLX4},
  {"addma", "d,s,t", 0x7C00001E, 0xFC0007FF, 0, 0, RLX4},
  {"addma.s", "d,s,t", 0x7C00009E, 0xFC0007FF, 0, 0, RLX4},
  {"subma", "d,s,t", 0x7C00001F, 0xFC0007FF, 0, 0, RLX4},
  {"subma.s", "d,s,t", 0x7C00009F, 0xFC0007FF, 0, 0, RLX4},
  {"rnda2", "t", 0x7C000056, 0xFFE0FFFF, 0, 0, RLX4},
  {"rnda2", "t,#", 0x7C000056, 0xFFE0F87F, 0, 0, RLX4},
  {"lt", "`,@(b)", 0x7C000036, 0xFC00003F, LDD | RD_b | WR_t, 0, RLX4},
  {"st", "`,@(b)", 0x7C00003E, 0xFC00003F, SM | RD_t | RD_b, 0, RLX4},
  {"ltp", "`,(b)~", 0x7C0000f2, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"ltp.c0", "`,(b)~", 0x7C000032, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"ltp.c1", "`,(b)~", 0x7C000072, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"ltp.c2", "`,(b)~", 0x7C0000b2, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lwp", "t,(b)~", 0x7C0000f3, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lwp.c0", "t,(b)~", 0x7C000033, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lwp.c1", "t,(b)~", 0x7C000073, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lwp.c2", "t,(b)~", 0x7C0000b3, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lhp", "t,(b)~", 0x7C0000f1, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lhp.c0", "t,(b)~", 0x7C000031, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lhp.c1", "t,(b)~", 0x7C000071, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lhp.c2", "t,(b)~", 0x7C0000b1, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lhpu", "t,(b)~", 0x7C0000f5, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lhpu.c0", "t,(b)~", 0x7C000035, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lhpu.c1", "t,(b)~", 0x7C000075, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lhpu.c2", "t,(b)~", 0x7C0000b5, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lbp", "t,(b)~", 0x7C0000f0, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lbp.c0", "t,(b)~", 0x7C000030, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lbp.c1", "t,(b)~", 0x7C000070, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lbp.c2", "t,(b)~", 0x7C0000b0, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lbpu", "t,(b)~", 0x7C0000f4, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lbpu.c0", "t,(b)~", 0x7C000034, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lbpu.c1", "t,(b)~", 0x7C000074, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"lbpu.c2", "t,(b)~", 0x7C0000b4, 0xFC0000FF, LDD | WR_t | RD_b, 0, RLX4},
  {"stp", "`,(b)~", 0x7C0000fa, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"stp.c0", "`,(b)~", 0x7C00003a, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"stp.c1", "`,(b)~", 0x7C00007a, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"stp.c2", "`,(b)~", 0x7C0000ba, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"swp", "t,(b)~", 0x7C0000fb, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"swp.c0", "t,(b)~", 0x7C00003b, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"swp.c1", "t,(b)~", 0x7C00007b, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"swp.c2", "t,(b)~", 0x7C0000bb, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"shp", "t,(b)~", 0x7C0000f9, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"shp.c0", "t,(b)~", 0x7C000039, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"shp.c1", "t,(b)~", 0x7C000079, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"shp.c2", "t,(b)~", 0x7C0000b9, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"sbp", "t,(b)~", 0x7C0000f8, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"sbp.c0", "t,(b)~", 0x7C000038, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"sbp.c1", "t,(b)~", 0x7C000078, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"sbp.c2", "t,(b)~", 0x7C0000b8, 0xFC0000FF, WR_t | RD_b, 0, RLX4},
  {"mtru", "t,d", 0x7C000025, 0xFFE007FF, RD_t, 0, RLX4},
  {"mfru", "t,d", 0x7C000024, 0xFFE007FF, RD_t, 0, RLX4},
  {"mtrk", "t,d", 0x7C0000A5, 0xFFE007FF, RD_t, 0, RLX4},
  {"mfrk", "t,d", 0x7C0000A4, 0xFFE007FF, RD_t, 0, RLX4},
  {"sllv2", "d,t,s", 0x7C000044, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"srlv2", "d,t,s", 0x7C000046, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"srav2", "d,t,s", 0x7C000047, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"addr", "d,s,t", 0x7C000021, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"addr.s", "d,s,t", 0x7C0000A1, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"addr2", "d,s,t", 0x7C000061, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"addr2.s", "d,s,t", 0x7C0000E1, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"subr", "d,s,t", 0x7C000023, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"subr.s", "d,s,t", 0x7C0000A3, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"subr2", "d,s,t", 0x7C000063, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"subr2.s", "d,s,t", 0x7C0000E3, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"sltr2", "d,s,t", 0x7C00006A, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"min", "d,s,t", 0x7C000028, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"min2", "d,s,t", 0x7C000068, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"max", "d,s,t", 0x7C000029, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"max2", "d,s,t", 0x7C000069, 0xFC0007FF, RD_t | RD_s | WR_d, 0, RLX4},
  {"absr", "d,t", 0x7C00000F, 0xFFE007FF, RD_t | WR_d, 0, RLX4},
  {"absr.s", "d,t", 0x7C00008F, 0xFFE007FF, RD_t | WR_d, 0, RLX4},
  {"absr2", "d,t", 0x7C00004F, 0xFFE007FF, RD_t | WR_d, 0, RLX4},
  {"absr2.s", "d,t", 0x7C0000CF, 0xFFE007FF, RD_t | WR_d, 0, RLX4},
  {"mux2.hh", "d,s,t", 0x7C00064D, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"mux2.hl", "d,s,t", 0x7C00044D, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"mux2.lh", "d,s,t", 0x7C00024D, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"mux2.ll", "d,s,t", 0x7C00004D, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"cls", "d,t", 0x7C00000E, 0xFFE007FF, RD_t | WR_d, 0, RLX4},
  {"bitrev", "d,t,s", 0x7c00000c, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"cmveqz", "d,s,t", 0x7C000001, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"cmveqz.h", "d,s,t", 0x7C000081, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"cmveqz.l", "d,s,t", 0x7C000101, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"cmvnez", "d,s,t", 0x7C000041, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"cmvnez.h", "d,s,t", 0x7C0000c1, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
  {"cmvnez.l", "d,s,t", 0x7C000141, 0xFC0007FF, RD_s | RD_t | WR_d, 0, RLX4},
/* dbb:  modified for supporting radiax instructions */

/* 2006-01-09 tonywu: COP0 registers */
  {"mflxc0", "t,d", 0x40600000, 0xFFE007FF, LCD | WR_t | RD_C0, 0, RLX2},
  {"mtlxc0", "t,d", 0x40E00000, 0xFFE007FF, COD | RD_t | WR_C0 | WR_CC, 0,
   RLX2},

/* 2006-01-19 tonywu: MAC-DIV instructions */
  {"sleep", "", 0x42000038, 0xffffffff, 0, 0, RLX1},
  {"madh", "s,t", 0xF0000000, 0xFC00FFFF, RD_s | RD_t, 0, RLX1},
  {"madl", "s,t", 0xF0000002, 0xFC00FFFF, RD_s | RD_t, 0, RLX1},
  {"mazh", "s,t", 0xF0000004, 0xFC00FFFF, RD_s | RD_t, 0, RLX1},
  {"mazl", "s,t", 0xF0000006, 0xFC00FFFF, RD_s | RD_t, 0, RLX1},
  {"msbh", "s,t", 0xF0000010, 0xFC00FFFF, RD_s | RD_t, 0, RLX1},
  {"msbl", "s,t", 0xF0000012, 0xFC00FFFF, RD_s | RD_t, 0, RLX1},
  {"mszh", "s,t", 0xF0000014, 0xFC00FFFF, RD_s | RD_t, 0, RLX1},
  {"mszl", "s,t", 0xF0000016, 0xFC00FFFF, RD_s | RD_t, 0, RLX1},
  {"ltw", "`,-(b)", 0x7800003C, 0xFC00003F, LDD | RD_b | WR_t, 0,
   INSN_ISA4181},
