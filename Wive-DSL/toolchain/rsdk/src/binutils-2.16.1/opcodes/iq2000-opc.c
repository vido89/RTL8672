...
static const CGEN_IFMT ifmt_add2 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc0007ff, {{F (F_OPCODE)}, {F (F_RT)}, {F (F_RD_RS)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_add ATTRIBUTE_UNUSED = {
  32, 32, 0xfc0007ff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};
...
static const CGEN_IFMT ifmt_ram ATTRIBUTE_UNUSED = {
  32, 32, 0xfc000020, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_5)}, {F (F_MASKL)}, {0}}
};

static const CGEN_IFMT ifmt_sll ATTRIBUTE_UNUSED = {
  32, 32, 0xffe0003f, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_sllv2 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc0007ff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RD_RT)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_slmv2 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00003f, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RD_RT)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_slmv ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00003f, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};
...
static const CGEN_IFMT ifmt_sra2 ATTRIBUTE_UNUSED = {
  32, 32, 0xffe0003f, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RD_RT)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_bbi ATTRIBUTE_UNUSED = {
  32, 32, 0xfc000000, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_OFFSET)},
		       {0}}
};
...
static const CGEN_IFMT ifmt_bgez ATTRIBUTE_UNUSED = {
  32, 32, 0xfc1f0000, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_OFFSET)},
		       {0}}
};

static const CGEN_IFMT ifmt_jalr ATTRIBUTE_UNUSED = {
  32, 32, 0xfc1f07ff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_jr ATTRIBUTE_UNUSED = {
  32, 32, 0xfc1fffff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};
...
static const CGEN_IFMT ifmt_break ATTRIBUTE_UNUSED = {
  32, 32, 0xffffffff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};
...
static const CGEN_IFMT ifmt_mrgb ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00043f, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_10)}, {F (F_MASK)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_mrgb2 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00043f, {{F (F_OPCODE)}, {F (F_RT)}, {F (F_RD_RS)}, {F (F_10)},
		       {F (F_MASK)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_bc0f ATTRIBUTE_UNUSED = {
  32, 32, 0xffff0000, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_OFFSET)},
		       {0}}
};

static const CGEN_IFMT ifmt_cfc0 ATTRIBUTE_UNUSED = {
  32, 32, 0xffe007ff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_10_11)}, {0}}
};
...
static const CGEN_IFMT ifmt_lulck ATTRIBUTE_UNUSED = {
  32, 32, 0xffe0ffff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_pkrlr1 ATTRIBUTE_UNUSED = {
  32, 32, 0xffe00000, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_COUNT)},
		       {F (F_INDEX)}, {0}}
};

static const CGEN_IFMT ifmt_rfe ATTRIBUTE_UNUSED = {
  32, 32, 0xffffffff, {{F (F_OPCODE)}, {F (F_25)}, {F (F_24_19)},
		       {F (F_FUNC)}, {0}}
};
...
static const CGEN_IFMT ifmt_mrgbq10 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00003f, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_MASKQ10)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_mrgbq102 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00003f, {{F (F_OPCODE)}, {F (F_RT)}, {F (F_RD_RS)},
		       {F (F_MASKQ10)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_jq10 ATTRIBUTE_UNUSED = {
  32, 32, 0xffff0000, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_JTARG)},
		       {0}}
};

static const CGEN_IFMT ifmt_jalq10 ATTRIBUTE_UNUSED = {
  32, 32, 0xffe00000, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_JTARG)},
		       {0}}
};

static const CGEN_IFMT ifmt_avail ATTRIBUTE_UNUSED = {
  32, 32, 0xffff07ff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};

static const CGEN_IFMT ifmt_rbi ATTRIBUTE_UNUSED = {
  32, 32, 0xfc000700, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP)}, {F (F_BYTECOUNT)}, {0}}
};

static const CGEN_IFMT ifmt_cam36 ATTRIBUTE_UNUSED = {
  32, 32, 0xffe007c0, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP_10)}, {F (F_CAM_Z)}, {F (F_CAM_Y)}, {0}}
};

static const CGEN_IFMT ifmt_cm32and ATTRIBUTE_UNUSED = {
  32, 32, 0xfc0007ff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP)}, {F (F_CP_GRP)}, {F (F_FUNC)}, {0}}
};
...
static const CGEN_IFMT ifmt_cm128ria3 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc0007fc, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP)}, {F (F_CP_GRP)}, {F (F_CM_4FUNC)},
		       {F (F_CM_3Z)}, {0}}
};

static const CGEN_IFMT ifmt_cm128ria4 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc0007f8, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP)}, {F (F_CP_GRP)}, {F (F_CM_3FUNC)},
		       {F (F_CM_4Z)}, {0}}
};

static const CGEN_IFMT ifmt_ctc ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00ffff, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_SHAMT)}, {F (F_FUNC)}, {0}}
};
...
/* ram $rd,$rt,$shamt,$maskl,$maskr */
  {
   {0, 0, 0, 0},
   {{MNEM, ' ', OP (RD), ',', OP (RT), ',', OP (SHAMT), ',', OP (MASKL), ',',
     OP (MASKR), 0}},
   &ifmt_ram, {0x9c000000}
   },
/* sll $rd,$rt,$shamt */
...
static const CGEN_IFMT ifmt_m_cam36 ATTRIBUTE_UNUSED = {
  32, 32, 0xffe007c7, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP_10)}, {F (F_CAM_Z)}, {F (F_CAM_Y)}, {0}}
};
...
static const CGEN_IFMT ifmt_m_cm128ria3 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00fffc, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP)}, {F (F_CP_GRP)}, {F (F_CM_4FUNC)},
		       {F (F_CM_3Z)}, {0}}
};

static const CGEN_IFMT ifmt_m_cm128ria4 ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00fff8, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP)}, {F (F_CP_GRP)}, {F (F_CM_3FUNC)},
		       {F (F_CM_4Z)}, {0}}
};
...
static const CGEN_IFMT ifmt_m_pkrli ATTRIBUTE_UNUSED = {
  32, 32, 0xfc00ff00, {{F (F_OPCODE)}, {F (F_RS)}, {F (F_RT)}, {F (F_RD)},
		       {F (F_CP_OP)}, {F (F_BYTECOUNT)}, {0}}
};
...
/* sll $rd,$rt,$rs */
  {
   -1, "m-sll", "sll", 32,
   {0 | A (NO_DIS) | A (USES_RS) | A (USES_RT) | A (USES_RD) | A (ALIAS),
    {(1 << MACH_BASE)}}
   },
/* slt $rt,$rs,$imm */
  {
...
/* ldw $rt,$lo16 */
  {
   -1, "ldw-base-0", "ldw", 32,
   {0 | A (NO_DIS) | A (USES_RS) | A (USES_RT) | A (LOAD_DELAY) |
    A (EVEN_REG_NUM) | A (ALIAS), {(1 << MACH_IQ2000)}}
   },
/* sdw $rt,$lo16 */
  {
   -1, "sdw-base-0", "sdw", 32,
   {0 | A (NO_DIS) | A (USES_RT) | A (EVEN_REG_NUM) | A (ALIAS),
    {(1 << MACH_IQ2000)}}
   },
/* avail */
  {
