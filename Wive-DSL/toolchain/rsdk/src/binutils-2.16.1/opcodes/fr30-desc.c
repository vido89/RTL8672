...
const CGEN_HW_ENTRY fr30_cgen_hw_table[] = {
  ...
  {"h-pc", HW_H_PC, CGEN_ASM_NONE, 0,
   {0 | A (PROFILE) | A (PC), {(1 << MACH_BASE)}}},
  {"h-gr", HW_H_GR, CGEN_ASM_KEYWORD, (PTR) & fr30_cgen_opval_gr_names,
   {0 | A (CACHE_ADDR) | A (PROFILE), {(1 << MACH_BASE)}}},
  {"h-cr", HW_H_CR, CGEN_ASM_KEYWORD, (PTR) & fr30_cgen_opval_cr_names,
   {0, {(1 << MACH_BASE)}}},
  {"h-dr", HW_H_DR, CGEN_ASM_KEYWORD, (PTR) & fr30_cgen_opval_dr_names,
   {0, {(1 << MACH_BASE)}}},
  {"h-ps", HW_H_PS, CGEN_ASM_KEYWORD, (PTR) & fr30_cgen_opval_h_ps,
   {0, {(1 << MACH_BASE)}}},
  {"h-r13", HW_H_R13, CGEN_ASM_KEYWORD, (PTR) & fr30_cgen_opval_h_r13,
   {0, {(1 << MACH_BASE)}}},
  {"h-r14", HW_H_R14, CGEN_ASM_KEYWORD, (PTR) & fr30_cgen_opval_h_r14,
   {0, {(1 << MACH_BASE)}}},
  {"h-r15", HW_H_R15, CGEN_ASM_KEYWORD, (PTR) & fr30_cgen_opval_h_r15,
   {0, {(1 << MACH_BASE)}}},
...
const CGEN_IFLD fr30_cgen_ifld_table[] = {
  ...
  {FR30_F_REL12, "f-rel12", 0, 16, 5, 11,
   {0 | A (PCREL_ADDR), {(1 << MACH_BASE)}}},
  {FR30_F_REGLIST_HI_ST, "f-reglist_hi_st", 0, 16, 8, 8,
   {0, {(1 << MACH_BASE)}}},
  {FR30_F_REGLIST_LOW_ST, "f-reglist_low_st", 0, 16, 8, 8,
   {0, {(1 << MACH_BASE)}}},
  {FR30_F_REGLIST_HI_LD, "f-reglist_hi_ld", 0, 16, 8, 8,
   {0, {(1 << MACH_BASE)}}},
  {FR30_F_REGLIST_LOW_LD, "f-reglist_low_ld", 0, 16, 8, 8,
   {0, {(1 << MACH_BASE)}}},
  {0, 0, 0, 0, 0, 0, {0, {0}}}
};
...
/* jmp:d @$Ri */
  {
   ...
   {0 | A (NOT_IN_DELAY_SLOT) | A (UNCOND_CTI) | A (DELAY_SLOT),
    {(1 << MACH_BASE)}}
   },
/* call @$Ri */
  {
...
/* beq:d $label9 */
  {
   ...
   {0 | A (NOT_IN_DELAY_SLOT) | A (COND_CTI) | A (DELAY_SLOT),
    {(1 << MACH_BASE)}}
   },
/* beq $label9 */
  {
     ...
     CGEN_CPU_TABLE *cd;
{
  ...
  for (i = 0; init[i].name != NULL; ++i)
    if (CGEN_HW_ATTR_VALUE (&init[i], CGEN_HW_MACH) & machs)
     ...
     CGEN_CPU_TABLE *cd;
{
  ...
  for (i = 0; init[i].name != NULL; ++i)
    if (CGEN_OPERAND_ATTR_VALUE (&init[i], CGEN_OPERAND_MACH) & machs)
      selected[init[i].type] = &init[i];
	...
	if (mach->insn_chunk_bitsize != 0)
	  {
		...
		&& cd->insn_chunk_bitsize != mach->insn_chunk_bitsize)
	      {
		fprintf (stderr,
			 "fr30_cgen_rebuild_tables: conflicting insn-chunk-bitsize values: `%d' vs. `%d'\n",
			 cd->insn_chunk_bitsize, mach->insn_chunk_bitsize);
		abort ();
	      }
