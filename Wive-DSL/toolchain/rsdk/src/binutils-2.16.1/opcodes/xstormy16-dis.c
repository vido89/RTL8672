     ...
     int length;
{
  ...
  switch (opindex)
    ...
    case XSTORMY16_OPERAND_RB:
      print_keyword (cd, info, &xstormy16_cgen_opval_gr_Rb_names,
		     fields->f_Rb, 0);
      break;
    ...
    case XSTORMY16_OPERAND_RD:
      print_keyword (cd, info, &xstormy16_cgen_opval_gr_names, fields->f_Rd,
		     0);
      break;
    case XSTORMY16_OPERAND_RDM:
      print_keyword (cd, info, &xstormy16_cgen_opval_gr_names, fields->f_Rdm,
		     0);
      break;
    case XSTORMY16_OPERAND_RM:
      print_keyword (cd, info, &xstormy16_cgen_opval_gr_names, fields->f_Rm,
		     0);
      break;
    case XSTORMY16_OPERAND_RS:
      print_keyword (cd, info, &xstormy16_cgen_opval_gr_names, fields->f_Rs,
		     0);
      break;
    case XSTORMY16_OPERAND_ABS24:
      print_normal (cd, info, fields->f_abs24,
		    0 | (1 << CGEN_OPERAND_ABS_ADDR) | (1 <<
							CGEN_OPERAND_VIRTUAL),
		    pc, length);
      break;
    case XSTORMY16_OPERAND_BCOND2:
      print_keyword (cd, info, &xstormy16_cgen_opval_h_branchcond,
		     fields->f_op2, 0);
      break;
    ...
    case XSTORMY16_OPERAND_HMEM8:
      print_normal (cd, info, fields->f_hmem8,
		    0 | (1 << CGEN_OPERAND_ABS_ADDR), pc, length);
      break;
    case XSTORMY16_OPERAND_IMM12:
      print_normal (cd, info, fields->f_imm12, 0 | (1 << CGEN_OPERAND_SIGNED),
		    pc, length);
      break;
    case XSTORMY16_OPERAND_IMM16:
      print_normal (cd, info, fields->f_imm16,
		    0 | (1 << CGEN_OPERAND_SIGN_OPT), pc, length);
      break;
    ...
    case XSTORMY16_OPERAND_LMEM8:
      print_normal (cd, info, fields->f_lmem8,
		    0 | (1 << CGEN_OPERAND_ABS_ADDR), pc, length);
      break;
    case XSTORMY16_OPERAND_REL12:
      print_normal (cd, info, fields->f_rel12,
		    0 | (1 << CGEN_OPERAND_PCREL_ADDR), pc, length);
      break;
    case XSTORMY16_OPERAND_REL12A:
      print_normal (cd, info, fields->f_rel12a,
		    0 | (1 << CGEN_OPERAND_PCREL_ADDR), pc, length);
      break;
    case XSTORMY16_OPERAND_REL8_2:
      print_normal (cd, info, fields->f_rel8_2,
		    0 | (1 << CGEN_OPERAND_PCREL_ADDR), pc, length);
      break;
    case XSTORMY16_OPERAND_REL8_4:
      print_normal (cd, info, fields->f_rel8_4,
		    0 | (1 << CGEN_OPERAND_PCREL_ADDR), pc, length);
      break;
    case XSTORMY16_OPERAND_WS2:
      print_keyword (cd, info, &xstormy16_cgen_opval_h_wordsize,
		     fields->f_op2m, 0);
      break;
