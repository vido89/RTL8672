...
static void
ctrl (bfd_vma memaddr, unsigned long word1,
...
static void
cobr (bfd_vma memaddr, unsigned long word1,
      unsigned long word2 ATTRIBUTE_UNUSED)
{
  int src1;
  int src2;
  ...
  if (fp)
      ...
      if (mode == 1)
	{
	  ...
	  switch (reg)
	    {
	    case 0:
	      (*info->fprintf_func) (stream, "fp0");
	      break;
	    case 1:
	      (*info->fprintf_func) (stream, "fp1");
	      break;
	    case 2:
	      (*info->fprintf_func) (stream, "fp2");
	      break;
	    case 3:
	      (*info->fprintf_func) (stream, "fp3");
	      break;
	    case 16:
	      (*info->fprintf_func) (stream, "0f0.0");
	      break;
	    case 22:
	      (*info->fprintf_func) (stream, "0f1.0");
	      break;
	    default:
	      (*info->fprintf_func) (stream, "?");
	      break;
