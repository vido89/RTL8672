...
PARAMS ((CGEN_CPU_DESC, const char **, int, unsigned long *));
static long parse_register_number PARAMS ((const char **));
			...
			bfd_vma * valuep)
{
  ...
  if (errmsg == NULL && result_type != CGEN_PARSE_OPERAND_RESULT_QUEUED)
     ...
     CGEN_FIELDS *fields;
{
  ...
  switch (opindex)
    ...
    case FRV_OPERAND_A0:
      errmsg =
	parse_A0 (cd, strp, FRV_OPERAND_A0, (unsigned long *) (&fields->f_A));
      break;
    case FRV_OPERAND_A1:
      errmsg =
	parse_A1 (cd, strp, FRV_OPERAND_A1, (unsigned long *) (&fields->f_A));
      break;
    case FRV_OPERAND_ACC40SI:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_acc_names,
			    &fields->f_ACC40Si);
      break;
    ...
    case FRV_OPERAND_ACCGI:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_accg_names,
			    &fields->f_ACCGi);
      break;
    ...
    case FRV_OPERAND_CCI:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_cccr_names,
			    &fields->f_CCi);
      break;
    case FRV_OPERAND_CPRDOUBLEK:
      errmsg =
	parse_even_register (cd, strp, &frv_cgen_opval_cpr_names,
			     &fields->f_CPRk);
      break;
    case FRV_OPERAND_CPRI:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_cpr_names,
			    &fields->f_CPRi);
      break;
    ...
    case FRV_OPERAND_FCCI_1:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_fccr_names,
			    &fields->f_FCCi_1);
      break;
    ...
    case FRV_OPERAND_FRDOUBLEI:
      errmsg =
	parse_even_register (cd, strp, &frv_cgen_opval_fr_names,
			     &fields->f_FRi);
      break;
    ...
    case FRV_OPERAND_FRI:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_fr_names,
			    &fields->f_FRi);
      break;
    ...
    case FRV_OPERAND_GRDOUBLEK:
      errmsg =
	parse_even_register (cd, strp, &frv_cgen_opval_gr_names,
			     &fields->f_GRk);
      break;
    case FRV_OPERAND_GRI:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_gr_names,
			    &fields->f_GRi);
      break;
    ...
    case FRV_OPERAND_ICCI_1:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_iccr_names,
			    &fields->f_ICCi_1);
      break;
    ...
    case FRV_OPERAND_LI:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_LI,
				     (unsigned long *) (&fields->f_LI));
      break;
    case FRV_OPERAND_LRAD:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_LRAD,
				     (unsigned long *) (&fields->f_LRAD));
      break;
    case FRV_OPERAND_LRAE:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_LRAE,
				     (unsigned long *) (&fields->f_LRAE));
      break;
    case FRV_OPERAND_LRAS:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_LRAS,
				     (unsigned long *) (&fields->f_LRAS));
      break;
    case FRV_OPERAND_TLBPRL:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_TLBPRL,
				     (unsigned long *) (&fields->f_TLBPRL));
      break;
    case FRV_OPERAND_TLBPROPX:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_TLBPROPX,
				     (unsigned long *) (&fields->f_TLBPRopx));
      break;
    case FRV_OPERAND_AE:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_AE,
				     (unsigned long *) (&fields->f_ae));
      break;
    case FRV_OPERAND_CALLANN:
      errmsg =
	parse_call_annotation (cd, strp, FRV_OPERAND_CALLANN,
			       (unsigned long *) (&fields->f_reloc_ann));
      break;
    case FRV_OPERAND_CCOND:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_CCOND,
				     (unsigned long *) (&fields->f_ccond));
      break;
    case FRV_OPERAND_COND:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_COND,
				     (unsigned long *) (&fields->f_cond));
      break;
    case FRV_OPERAND_D12:
      errmsg =
	parse_d12 (cd, strp, FRV_OPERAND_D12, (long *) (&fields->f_d12));
      break;
    case FRV_OPERAND_DEBUG:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_DEBUG,
				     (unsigned long *) (&fields->f_debug));
      break;
    case FRV_OPERAND_EIR:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_EIR,
				     (unsigned long *) (&fields->f_eir));
      break;
    case FRV_OPERAND_HINT:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_HINT,
				     (unsigned long *) (&fields->f_hint));
      break;
    case FRV_OPERAND_HINT_NOT_TAKEN:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_h_hint_not_taken,
			    &fields->f_hint);
      break;
    case FRV_OPERAND_HINT_TAKEN:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_h_hint_taken,
			    &fields->f_hint);
      break;
	...
	bfd_vma value;
	errmsg =
	  cgen_parse_address (cd, strp, FRV_OPERAND_LABEL16, 0, NULL, &value);
	...
	bfd_vma value;
	errmsg =
	  parse_call_label (cd, strp, FRV_OPERAND_LABEL24, 0, NULL, &value);
	fields->f_label24 = value;
      }
      break;
    case FRV_OPERAND_LDANN:
      errmsg =
	parse_ld_annotation (cd, strp, FRV_OPERAND_LDANN,
			     (unsigned long *) (&fields->f_reloc_ann));
      break;
    case FRV_OPERAND_LDDANN:
      errmsg =
	parse_ldd_annotation (cd, strp, FRV_OPERAND_LDDANN,
			      (unsigned long *) (&fields->f_reloc_ann));
      break;
    case FRV_OPERAND_LOCK:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_LOCK,
				     (unsigned long *) (&fields->f_lock));
      break;
    case FRV_OPERAND_PACK:
      errmsg =
	cgen_parse_keyword (cd, strp, &frv_cgen_opval_h_pack,
			    &fields->f_pack);
      break;
    case FRV_OPERAND_S10:
      errmsg =
	cgen_parse_signed_integer (cd, strp, FRV_OPERAND_S10,
				   (long *) (&fields->f_s10));
      break;
    case FRV_OPERAND_S12:
      errmsg =
	parse_s12 (cd, strp, FRV_OPERAND_S12, (long *) (&fields->f_d12));
      break;
    case FRV_OPERAND_S16:
      errmsg =
	cgen_parse_signed_integer (cd, strp, FRV_OPERAND_S16,
				   (long *) (&fields->f_s16));
      break;
    case FRV_OPERAND_S5:
      errmsg =
	cgen_parse_signed_integer (cd, strp, FRV_OPERAND_S5,
				   (long *) (&fields->f_s5));
      break;
    case FRV_OPERAND_S6:
      errmsg =
	cgen_parse_signed_integer (cd, strp, FRV_OPERAND_S6,
				   (long *) (&fields->f_s6));
      break;
    case FRV_OPERAND_S6_1:
      errmsg =
	cgen_parse_signed_integer (cd, strp, FRV_OPERAND_S6_1,
				   (long *) (&fields->f_s6_1));
      break;
    case FRV_OPERAND_SLO16:
      errmsg =
	parse_uslo16 (cd, strp, FRV_OPERAND_SLO16, (long *) (&fields->f_s16));
      break;
    case FRV_OPERAND_SPR:
      errmsg =
	parse_spr (cd, strp, &frv_cgen_opval_spr_names, &fields->f_spr);
      break;
    case FRV_OPERAND_U12:
      errmsg =
	parse_u12 (cd, strp, FRV_OPERAND_U12, (long *) (&fields->f_u12));
      break;
    case FRV_OPERAND_U16:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_U16,
				     (unsigned long *) (&fields->f_u16));
      break;
    case FRV_OPERAND_U6:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, FRV_OPERAND_U6,
				     (unsigned long *) (&fields->f_u6));
      break;
    case FRV_OPERAND_UHI16:
      errmsg =
	parse_uhi16 (cd, strp, FRV_OPERAND_UHI16,
		     (unsigned long *) (&fields->f_u16));
      break;
    case FRV_OPERAND_ULO16:
      errmsg =
	parse_ulo16 (cd, strp, FRV_OPERAND_ULO16,
		     (unsigned long *) (&fields->f_u16));
      break;
			...
			CGEN_INSN_BYTES_PTR buf, char **errmsg)
{
  ...
  for (; ilist != NULL; ilist = CGEN_ASM_NEXT_INSN (ilist))
	...
	continue;
	  ...
	  regexec ((regex_t *) CGEN_INSN_RX (insn), str, 0, NULL,
		   0) == REG_NOMATCH)
	continue;
