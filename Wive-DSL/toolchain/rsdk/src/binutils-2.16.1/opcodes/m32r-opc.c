...
static const CGEN_IFMT ifmt_add3 ATTRIBUTE_UNUSED = {
  32, 32, 0xf0f00000, {{F (F_OP1)}, {F (F_R1)}, {F (F_OP2)}, {F (F_R2)},
		       {F (F_SIMM16)}, {0}}
};
...
static const CGEN_IFMT ifmt_beqz ATTRIBUTE_UNUSED = {
  32, 32, 0xfff00000, {{F (F_OP1)}, {F (F_R1)}, {F (F_OP2)}, {F (F_R2)},
		       {F (F_DISP16)}, {0}}
};
...
static const CGEN_IFMT ifmt_div ATTRIBUTE_UNUSED = {
  32, 32, 0xf0f0ffff, {{F (F_OP1)}, {F (F_R1)}, {F (F_OP2)}, {F (F_R2)},
		       {F (F_SIMM16)}, {0}}
};
...
static const CGEN_IFMT ifmt_ldi16 ATTRIBUTE_UNUSED = {
  32, 32, 0xf0ff0000, {{F (F_OP1)}, {F (F_R1)}, {F (F_OP2)}, {F (F_R2)},
		       {F (F_SIMM16)}, {0}}
};

static const CGEN_IFMT ifmt_machi_a ATTRIBUTE_UNUSED = {
  16, 16, 0xf070, {{F (F_OP1)}, {F (F_R1)}, {F (F_ACC)}, {F (F_OP23)},
		   {F (F_R2)}, {0}}
};
...
static const CGEN_IFMT ifmt_mvfachi_a ATTRIBUTE_UNUSED = {
  16, 16, 0xf0f3, {{F (F_OP1)}, {F (F_R1)}, {F (F_OP2)}, {F (F_ACCS)},
		   {F (F_OP3)}, {0}}
};
...
static const CGEN_IFMT ifmt_rac_dsi ATTRIBUTE_UNUSED = {
  16, 16, 0xf3f2, {{F (F_OP1)}, {F (F_ACCD)}, {F (F_BITS67)}, {F (F_OP2)},
		   {F (F_ACCS)}, {F (F_BIT14)}, {F (F_IMM1)}, {0}}
};
...
static const CGEN_IFMT ifmt_slli ATTRIBUTE_UNUSED = {
  16, 16, 0xf0e0, {{F (F_OP1)}, {F (F_R1)}, {F (F_SHIFT_OP2)}, {F (F_UIMM5)},
		   {0}}
};
...
static const CGEN_IFMT ifmt_bset ATTRIBUTE_UNUSED = {
  32, 32, 0xf8f00000, {{F (F_OP1)}, {F (F_BIT4)}, {F (F_UIMM3)}, {F (F_OP2)},
		       {F (F_R2)}, {F (F_SIMM16)}, {0}}
};

static const CGEN_IFMT ifmt_btst ATTRIBUTE_UNUSED = {
  16, 16, 0xf8f0, {{F (F_OP1)}, {F (F_BIT4)}, {F (F_UIMM3)}, {F (F_OP2)},
		   {F (F_R2)}, {0}}
};
...
static const CGEN_IFMT ifmt_ld_d2 ATTRIBUTE_UNUSED = {
  32, 32, 0xf0f00000, {{F (F_OP1)}, {F (F_OP2)}, {F (F_R1)}, {F (F_R2)},
		       {F (F_SIMM16)}, {0}}
};
...
static const CGEN_IFMT ifmt_ldi16a ATTRIBUTE_UNUSED = {
  32, 32, 0xf0ff0000, {{F (F_OP1)}, {F (F_OP2)}, {F (F_R2)}, {F (F_R1)},
		       {F (F_SIMM16)}, {0}}
};

static const CGEN_IFMT ifmt_rac_d ATTRIBUTE_UNUSED = {
  16, 16, 0xf3ff, {{F (F_OP1)}, {F (F_ACCD)}, {F (F_BITS67)}, {F (F_OP2)},
		   {F (F_ACCS)}, {F (F_BIT14)}, {F (F_IMM1)}, {0}}
};

static const CGEN_IFMT ifmt_rac_ds ATTRIBUTE_UNUSED = {
  16, 16, 0xf3f3, {{F (F_OP1)}, {F (F_ACCD)}, {F (F_BITS67)}, {F (F_OP2)},
		   {F (F_ACCS)}, {F (F_BIT14)}, {F (F_IMM1)}, {0}}
};
...
/* bl $disp8 */
  {
   -1, "bl8r", "bl", 16,
   {0 | A (RELAXABLE) | A (FILL_SLOT) | A (UNCOND_CTI) | A (ALIAS),
    {(1 << MACH_BASE), PIPE_O}}
   },
/* bl $disp24 */
  {
...
/* bcl $disp8 */
  {
   -1, "bcl8r", "bcl", 16,
   {0 | A (RELAXABLE) | A (FILL_SLOT) | A (COND_CTI) | A (ALIAS),
    {(1 << MACH_M32RX) | (1 << MACH_M32R2), PIPE_O}}
   },
/* bcl $disp24 */
  {
   -1, "bcl24r", "bcl", 32,
   {0 | A (RELAXED) | A (COND_CTI) | A (ALIAS),
    {(1 << MACH_M32RX) | (1 << MACH_M32R2), PIPE_NONE}}
   },
/* bnc $disp8 */
  {
   -1, "bnc8r", "bnc", 16,
