...
static int match_vliw PARAMS ((VLIW_COMBO *, VLIW_COMBO *, int));
static VLIW_COMBO *add_next_to_vliw
PARAMS ((FRV_VLIW *, CGEN_ATTR_VALUE_TYPE));
static int find_major_in_vliw PARAMS ((FRV_VLIW *, CGEN_ATTR_VALUE_TYPE));
...
static VLIW_COMBO fr550_allowed_vliw[] = {
  ...
  {UNIT_I0, UNIT_I1, UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_I0, UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_I0, UNIT_FM0, UNIT_I1, UNIT_FM1, UNIT_I2, UNIT_FM2, UNIT_I3,
   UNIT_FM3},
  {UNIT_I0, UNIT_FM0, UNIT_I1, UNIT_FM1, UNIT_I2, UNIT_FM2, UNIT_I3, UNIT_B0},
  {UNIT_I0, UNIT_FM0, UNIT_I1, UNIT_FM1, UNIT_I2, UNIT_FM2, UNIT_FM3,
   UNIT_B0},
  ...
  {UNIT_I0, UNIT_FM0, UNIT_I1, UNIT_FM1, UNIT_FM2, UNIT_FM3, UNIT_B0,
   UNIT_B1},
  {UNIT_I0, UNIT_FM0, UNIT_I1, UNIT_FM1, UNIT_FM2, UNIT_FM3, UNIT_B0,
   UNIT_B1},
  {UNIT_I0, UNIT_FM0, UNIT_I1, UNIT_FM1, UNIT_FM2, UNIT_B0, UNIT_B1,
   UNIT_NIL},
  {UNIT_I0, UNIT_FM0, UNIT_I1, UNIT_FM1, UNIT_B0, UNIT_B1, UNIT_NIL,
   UNIT_NIL},
  ...
  {UNIT_I0, UNIT_FM0, UNIT_I1, UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_I0, UNIT_FM0, UNIT_FM1, UNIT_FM2, UNIT_FM3, UNIT_B0, UNIT_B1,
   UNIT_NIL},
  {UNIT_I0, UNIT_FM0, UNIT_FM1, UNIT_FM2, UNIT_B0, UNIT_B1, UNIT_NIL,
   UNIT_NIL},
  {UNIT_I0, UNIT_FM0, UNIT_FM1, UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_I0, UNIT_FM0, UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_C, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_FM0, UNIT_FM1, UNIT_FM2, UNIT_FM3, UNIT_B0, UNIT_B1, UNIT_NIL,
   UNIT_NIL},
  {UNIT_FM0, UNIT_FM1, UNIT_FM2, UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_FM0, UNIT_FM1, UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_FM0, UNIT_B0, UNIT_B1, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL,
   UNIT_NIL},
  {UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL, UNIT_NIL,
   UNIT_NIL}
};
...
static int
fr400_check_insn_major_constraints (FRV_VLIW * vliw,
...
static int
fr450_check_insn_major_constraints (FRV_VLIW * vliw,
				    CGEN_ATTR_VALUE_TYPE major)
{
...
static int
find_major_in_slot (FRV_VLIW * vliw, CGEN_ATTR_VALUE_TYPE major,
...
fr550_find_media_in_vliw (FRV_VLIW * vliw)
{
  ...
  for (i = 0; i < vliw->next_slot; ++i)
    {
      if (vliw->major[i] < FR550_MAJOR_M_1
	  || vliw->major[i] > FR550_MAJOR_M_5)
	continue;
...
fr550_find_float_in_vliw (FRV_VLIW * vliw)
{
  ...
  for (i = 0; i < vliw->next_slot; ++i)
    {
      if (vliw->major[i] < FR550_MAJOR_F_1
	  || vliw->major[i] > FR550_MAJOR_F_4)
	continue;
...
static int
fr500_check_insn_major_constraints (FRV_VLIW * vliw,
				    CGEN_ATTR_VALUE_TYPE major)
{
...
static int
check_insn_major_constraints (FRV_VLIW * vliw, CGEN_ATTR_VALUE_TYPE major,
			      const CGEN_INSN * insn)
{
  int rc;
  switch (vliw->mach)
...
static const CGEN_IFMT ifmt_add ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fc0, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_ICCI_1_NULL)}, {F (F_OPE2)}, {F (F_GRJ)}, {0}}
};

static const CGEN_IFMT ifmt_not ATTRIBUTE_UNUSED = {
  32, 32, 0x1ffffc0, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_RS_NULL)},
		      {F (F_ICCI_1_NULL)}, {F (F_OPE2)}, {F (F_GRJ)}, {0}}
};
...
static const CGEN_IFMT ifmt_smu ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0fc0, {{F (F_PACK)}, {F (F_RD_NULL)}, {F (F_OP)}, {F (F_GRI)},
		       {F (F_OPE1)}, {F (F_GRJ)}, {0}}
};
...
static const CGEN_IFMT ifmt_cadd ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc00c0, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_GRJ)},
		      {0}}
};

static const CGEN_IFMT ifmt_cnot ATTRIBUTE_UNUSED = {
  32, 32, 0x1fff0c0, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_RS_NULL)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_GRJ)},
		      {0}}
};
...
static const CGEN_IFMT ifmt_addcc ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc03c0, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_ICCI_1)}, {F (F_OPE2)}, {F (F_GRJ)}, {0}}
};
...
static const CGEN_IFMT ifmt_addi ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0000, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_D12)}, {0}}
};
...
static const CGEN_IFMT ifmt_cmpb ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc03c0, {{F (F_PACK)}, {F (F_GRK_NULL)}, {F (F_OP)},
		       {F (F_GRI)}, {F (F_ICCI_1)}, {F (F_OPE2)}, {F (F_GRJ)},
		       {0}}
};

static const CGEN_IFMT ifmt_setlo ATTRIBUTE_UNUSED = {
  32, 32, 0x1ff0000, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)},
		      {F (F_MISC_NULL_4)}, {F (F_U16)}, {0}}
};
...
static const CGEN_IFMT ifmt_setlos ATTRIBUTE_UNUSED = {
  32, 32, 0x1ff0000, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)},
		      {F (F_MISC_NULL_4)}, {F (F_S16)}, {0}}
};

static const CGEN_IFMT ifmt_ldbf ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fc0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_OPE1)}, {F (F_GRJ)}, {0}}
};

static const CGEN_IFMT ifmt_ldc ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fc0, {{F (F_PACK)}, {F (F_CPRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_OPE1)}, {F (F_GRJ)}, {0}}
};
...
static const CGEN_IFMT ifmt_ldbfi ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0000, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_D12)}, {0}}
};
...
static const CGEN_IFMT ifmt_cldbf ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc00c0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_GRJ)},
		      {0}}
};
...
static const CGEN_IFMT ifmt_movgf ATTRIBUTE_UNUSED = {
  32, 32, 0x1ffffc0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_RS_NULL)},
		      {F (F_OPE1)}, {F (F_GRJ)}, {0}}
};

static const CGEN_IFMT ifmt_cmovgf ATTRIBUTE_UNUSED = {
  32, 32, 0x1fff0c0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_RS_NULL)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_GRJ)},
		      {0}}
};
...
static const CGEN_IFMT ifmt_bra ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0000, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_ICCI_2_NULL)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_LABEL16)}, {0}}
};

static const CGEN_IFMT ifmt_bno ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffcffff, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_ICCI_2_NULL)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_LABEL16_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_beq ATTRIBUTE_UNUSED = {
  32, 32, 0x79fc0000, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_ICCI_2)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_LABEL16)}, {0}}
};

static const CGEN_IFMT ifmt_fbra ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0000, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_FCCI_2_NULL)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_LABEL16)}, {0}}
};

static const CGEN_IFMT ifmt_fbno ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffcffff, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_FCCI_2_NULL)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_LABEL16_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_fbne ATTRIBUTE_UNUSED = {
  32, 32, 0x79fc0000, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_FCCI_2)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_LABEL16)}, {0}}
};
...
static const CGEN_IFMT ifmt_bralr ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffcffff, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_ICCI_2_NULL)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_OPE3)},
		       {F (F_CCOND_NULL)}, {F (F_S12_NULL)}, {0}}
};
...
static const CGEN_IFMT ifmt_beqlr ATTRIBUTE_UNUSED = {
  32, 32, 0x79fcffff, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_ICCI_2)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_OPE3)},
		       {F (F_CCOND_NULL)}, {F (F_S12_NULL)}, {0}}
};
...
static const CGEN_IFMT ifmt_fbeqlr ATTRIBUTE_UNUSED = {
  32, 32, 0x79fcffff, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_FCCI_2)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_OPE3)},
		       {F (F_CCOND_NULL)}, {F (F_S12_NULL)}, {0}}
};
...
static const CGEN_IFMT ifmt_bceqlr ATTRIBUTE_UNUSED = {
  32, 32, 0x79fcefff, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_ICCI_2)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_OPE3)}, {F (F_CCOND)},
		       {F (F_S12_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_fcbralr ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffcefff, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_FCCI_2_NULL)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_OPE3)}, {F (F_CCOND)},
		       {F (F_S12_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_fcbeqlr ATTRIBUTE_UNUSED = {
  32, 32, 0x79fcefff, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_FCCI_2)},
		       {F (F_OP)}, {F (F_HINT)}, {F (F_OPE3)}, {F (F_CCOND)},
		       {F (F_S12_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_jmpl ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0fc0, {{F (F_PACK)}, {F (F_MISC_NULL_1)}, {F (F_LI_OFF)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_MISC_NULL_2)},
		       {F (F_GRJ)}, {0}}
};

static const CGEN_IFMT ifmt_calll ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0fc0, {{F (F_PACK)}, {F (F_MISC_NULL_1)}, {F (F_LI_ON)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_MISC_NULL_2)},
		       {F (F_GRJ)}, {0}}
};

static const CGEN_IFMT ifmt_jmpil ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0000, {{F (F_PACK)}, {F (F_MISC_NULL_1)}, {F (F_LI_OFF)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_D12)}, {0}}
};

static const CGEN_IFMT ifmt_callil ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0000, {{F (F_PACK)}, {F (F_MISC_NULL_1)}, {F (F_LI_ON)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_D12)}, {0}}
};
...
static const CGEN_IFMT ifmt_tino ATTRIBUTE_UNUSED = {
  32, 32, 0x7fffffff, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_ICCI_2_NULL)},
		       {F (F_OP)}, {F (F_GRI_NULL)}, {F (F_S12_NULL)}, {0}}
};
...
static const CGEN_IFMT ifmt_ftira ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0000, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_ICCI_2_NULL)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_D12)}, {0}}
};
...
static const CGEN_IFMT ifmt_break ATTRIBUTE_UNUSED = {
  32, 32, 0x7fffffff, {{F (F_PACK)}, {F (F_RD_NULL)}, {F (F_OP)},
		       {F (F_RS_NULL)}, {F (F_MISC_NULL_3)}, {F (F_OPE4)},
		       {F (F_GRJ_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_andcr ATTRIBUTE_UNUSED = {
  32, 32, 0x71ff8ff8, {{F (F_PACK)}, {F (F_MISC_NULL_6)}, {F (F_CRK)},
		       {F (F_OP)}, {F (F_MISC_NULL_7)}, {F (F_CRI)},
		       {F (F_OPE1)}, {F (F_MISC_NULL_8)}, {F (F_CRJ)}, {0}}
};

static const CGEN_IFMT ifmt_notcr ATTRIBUTE_UNUSED = {
  32, 32, 0x71fffff8, {{F (F_PACK)}, {F (F_MISC_NULL_6)}, {F (F_CRK)},
		       {F (F_OP)}, {F (F_RS_NULL)}, {F (F_OPE1)},
		       {F (F_MISC_NULL_8)}, {F (F_CRJ)}, {0}}
};

static const CGEN_IFMT ifmt_ckra ATTRIBUTE_UNUSED = {
  32, 32, 0x79ffffff, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_CRJ_INT)},
		       {F (F_OP)}, {F (F_MISC_NULL_5)}, {F (F_ICCI_3_NULL)},
		       {0}}
};

static const CGEN_IFMT ifmt_ckeq ATTRIBUTE_UNUSED = {
  32, 32, 0x79fffffc, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_CRJ_INT)},
		       {F (F_OP)}, {F (F_MISC_NULL_5)}, {F (F_ICCI_3)}, {0}}
};

static const CGEN_IFMT ifmt_fckra ATTRIBUTE_UNUSED = {
  32, 32, 0x79fffffc, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_CRJ_FLOAT)},
		       {F (F_OP)}, {F (F_MISC_NULL_5)}, {F (F_FCCI_3)}, {0}}
};

static const CGEN_IFMT ifmt_cckra ATTRIBUTE_UNUSED = {
  32, 32, 0x79fff0ff, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_CRJ_INT)},
		       {F (F_OP)}, {F (F_RS_NULL)}, {F (F_CCI)}, {F (F_COND)},
		       {F (F_OPE4)}, {F (F_MISC_NULL_9)}, {F (F_ICCI_3_NULL)},
		       {0}}
};

static const CGEN_IFMT ifmt_cckeq ATTRIBUTE_UNUSED = {
  32, 32, 0x79fff0fc, {{F (F_PACK)}, {F (F_INT_CC)}, {F (F_CRJ_INT)},
		       {F (F_OP)}, {F (F_RS_NULL)}, {F (F_CCI)}, {F (F_COND)},
		       {F (F_OPE4)}, {F (F_MISC_NULL_9)}, {F (F_ICCI_3)}, {0}}
};

static const CGEN_IFMT ifmt_cfckra ATTRIBUTE_UNUSED = {
  32, 32, 0x79fff0ff, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_CRJ_FLOAT)},
		       {F (F_OP)}, {F (F_RS_NULL)}, {F (F_CCI)}, {F (F_COND)},
		       {F (F_OPE4)}, {F (F_MISC_NULL_9)}, {F (F_FCCI_3_NULL)},
		       {0}}
};

static const CGEN_IFMT ifmt_cfckne ATTRIBUTE_UNUSED = {
  32, 32, 0x79fff0fc, {{F (F_PACK)}, {F (F_FLT_CC)}, {F (F_CRJ_FLOAT)},
		       {F (F_OP)}, {F (F_RS_NULL)}, {F (F_CCI)}, {F (F_COND)},
		       {F (F_OPE4)}, {F (F_MISC_NULL_9)}, {F (F_FCCI_3)}, {0}}
};

static const CGEN_IFMT ifmt_cjmpl ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc00c0, {{F (F_PACK)}, {F (F_MISC_NULL_1)}, {F (F_LI_OFF)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_CCI)}, {F (F_COND)},
		       {F (F_OPE4)}, {F (F_GRJ)}, {0}}
};

static const CGEN_IFMT ifmt_ccalll ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc00c0, {{F (F_PACK)}, {F (F_MISC_NULL_1)}, {F (F_LI_ON)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_CCI)}, {F (F_COND)},
		       {F (F_OPE4)}, {F (F_GRJ)}, {0}}
};

static const CGEN_IFMT ifmt_icei ATTRIBUTE_UNUSED = {
  32, 32, 0x7dfc0fc0, {{F (F_PACK)}, {F (F_MISC_NULL_1)}, {F (F_AE)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_OPE1)}, {F (F_GRJ)},
		       {0}}
};

static const CGEN_IFMT ifmt_icpl ATTRIBUTE_UNUSED = {
  32, 32, 0x7dfc0fc0, {{F (F_PACK)}, {F (F_MISC_NULL_1)}, {F (F_LOCK)},
		       {F (F_OP)}, {F (F_GRI)}, {F (F_OPE1)}, {F (F_GRJ)},
		       {0}}
};

static const CGEN_IFMT ifmt_icul ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0fff, {{F (F_PACK)}, {F (F_RD_NULL)}, {F (F_OP)}, {F (F_GRI)},
		       {F (F_OPE1)}, {F (F_GRJ_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_bar ATTRIBUTE_UNUSED = {
  32, 32, 0x7fffffff, {{F (F_PACK)}, {F (F_RD_NULL)}, {F (F_OP)},
		       {F (F_RS_NULL)}, {F (F_OPE1)}, {F (F_GRJ_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_lrai ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fc7, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_OPE1)}, {F (F_LRAE)}, {F (F_LRAD)}, {F (F_LRAS)},
		      {F (F_LRA_NULL)}, {0}}
};
...
static const CGEN_IFMT ifmt_cop1 ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0000, {{F (F_PACK)}, {F (F_CPRK)}, {F (F_OP)}, {F (F_CPRI)},
		      {F (F_S6_1)}, {F (F_CPRJ)}, {0}}
};

static const CGEN_IFMT ifmt_clrgr ATTRIBUTE_UNUSED = {
  32, 32, 0x1ffffff, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_RS_NULL)},
		      {F (F_OPE1)}, {F (F_GRJ_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_clrfr ATTRIBUTE_UNUSED = {
  32, 32, 0x1ffffff, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_RS_NULL)},
		      {F (F_OPE1)}, {F (F_GRJ_NULL)}, {0}}
};
...
static const CGEN_IFMT ifmt_cfitos ATTRIBUTE_UNUSED = {
  32, 32, 0x1fff0c0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_RS_NULL)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_FRJ)},
		      {0}}
};
...
static const CGEN_IFMT ifmt_fadds ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fc0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_OPE1)}, {F (F_FRJ)}, {0}}
};
...
static const CGEN_IFMT ifmt_cfadds ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc00c0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_FRJ)},
		      {0}}
};

static const CGEN_IFMT ifmt_fcmps ATTRIBUTE_UNUSED = {
  32, 32, 0x79fc0fc0, {{F (F_PACK)}, {F (F_COND_NULL)}, {F (F_FCCI_2)},
		       {F (F_OP)}, {F (F_FRI)}, {F (F_OPE1)}, {F (F_FRJ)},
		       {0}}
};
...
static const CGEN_IFMT ifmt_cfcmps ATTRIBUTE_UNUSED = {
  32, 32, 0x79fc00c0, {{F (F_PACK)}, {F (F_COND_NULL)}, {F (F_FCCI_2)},
		       {F (F_OP)}, {F (F_FRI)}, {F (F_CCI)}, {F (F_COND)},
		       {F (F_OPE4)}, {F (F_FRJ)}, {0}}
};
...
static const CGEN_IFMT ifmt_mhsetloh ATTRIBUTE_UNUSED = {
  32, 32, 0x1ffffe0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_FRI_NULL)},
		      {F (F_OPE1)}, {F (F_MISC_NULL_11)}, {F (F_S5)}, {0}}
};
...
static const CGEN_IFMT ifmt_mcut ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fc0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_ACC40SI)},
		      {F (F_OPE1)}, {F (F_FRJ)}, {0}}
};
...
static const CGEN_IFMT ifmt_mcmpsh ATTRIBUTE_UNUSED = {
  32, 32, 0x79fc0fc0, {{F (F_PACK)}, {F (F_COND_NULL)}, {F (F_FCCK)},
		       {F (F_OP)}, {F (F_FRI)}, {F (F_OPE1)}, {F (F_FRJ)},
		       {0}}
};

static const CGEN_IFMT ifmt_mabshs ATTRIBUTE_UNUSED = {
  32, 32, 0x1ffffc0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_FRI_NULL)},
		      {F (F_OPE1)}, {F (F_FRJ)}, {0}}
};
...
static const CGEN_IFMT ifmt_maddaccs ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fff, {{F (F_PACK)}, {F (F_ACC40SK)}, {F (F_OP)},
		      {F (F_ACC40SI)}, {F (F_OPE1)}, {F (F_ACCJ_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_mmulhs ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fc0, {{F (F_PACK)}, {F (F_ACC40SK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_OPE1)}, {F (F_FRJ)}, {0}}
};

static const CGEN_IFMT ifmt_cmmulhs ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc00c0, {{F (F_PACK)}, {F (F_ACC40SK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_FRJ)},
		      {0}}
};
...
static const CGEN_IFMT ifmt_mmachu ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fc0, {{F (F_PACK)}, {F (F_ACC40UK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_OPE1)}, {F (F_FRJ)}, {0}}
};

static const CGEN_IFMT ifmt_cmmachu ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc00c0, {{F (F_PACK)}, {F (F_ACC40UK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_FRJ)},
		      {0}}
};
...
static const CGEN_IFMT ifmt_cmexpdhw ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc00c0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_U6)},
		      {0}}
};
...
static const CGEN_IFMT ifmt_munpackh ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fff, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_OPE1)}, {F (F_FRJ_NULL)}, {0}}
};
...
static const CGEN_IFMT ifmt_cmbtoh ATTRIBUTE_UNUSED = {
  32, 32, 0x1fff0c0, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_FRI_NULL)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_FRJ)},
		      {0}}
};
...
static const CGEN_IFMT ifmt_mnop ATTRIBUTE_UNUSED = {
  32, 32, 0x7fffffff, {{F (F_PACK)}, {F (F_ACC40SK)}, {F (F_OP)}, {F (F_A)},
		       {F (F_MISC_NULL_10)}, {F (F_OPE1)}, {F (F_FRJ_NULL)},
		       {0}}
};

static const CGEN_IFMT ifmt_mclracc_0 ATTRIBUTE_UNUSED = {
  32, 32, 0x1ffffff, {{F (F_PACK)}, {F (F_ACC40SK)}, {F (F_OP)}, {F (F_A)},
		      {F (F_MISC_NULL_10)}, {F (F_OPE1)}, {F (F_FRJ_NULL)},
		      {0}}
};

static const CGEN_IFMT ifmt_mrdacc ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fff, {{F (F_PACK)}, {F (F_FRK)}, {F (F_OP)}, {F (F_ACC40SI)},
		      {F (F_OPE1)}, {F (F_FRJ_NULL)}, {0}}
};
...
static const CGEN_IFMT ifmt_mwtacc ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fff, {{F (F_PACK)}, {F (F_ACC40SK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_OPE1)}, {F (F_FRJ_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_mwtaccg ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fff, {{F (F_PACK)}, {F (F_ACCGK)}, {F (F_OP)}, {F (F_FRI)},
		      {F (F_OPE1)}, {F (F_FRJ_NULL)}, {0}}
};

static const CGEN_IFMT ifmt_fnop ATTRIBUTE_UNUSED = {
  32, 32, 0x7fffffff, {{F (F_PACK)}, {F (F_RD_NULL)}, {F (F_OP)},
		       {F (F_FRI_NULL)}, {F (F_OPE1)}, {F (F_FRJ_NULL)}, {0}}
};
...
/* cadd$pack $GRi,$GRj,$GRk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRI), ',', OP (GRJ), ',', OP (GRK), ',',
     OP (CCI), ',', OP (COND), 0}},
   &ifmt_cadd, {0x1600000}
   },
...
/* cnot$pack $GRj,$GRk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRJ), ',', OP (GRK), ',', OP (CCI), ',',
     OP (COND), 0}},
   &ifmt_cnot, {0x16800c0}
   },
/* csmul$pack $GRi,$GRj,$GRdoublek,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRI), ',', OP (GRJ), ',', OP (GRDOUBLEK), ',',
     OP (CCI), ',', OP (COND), 0}},
...
/* addicc$pack $GRi,$s10,$GRk,$ICCi_1 */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRI), ',', OP (S10), ',', OP (GRK), ',',
     OP (ICCI_1), 0}},
...
/* smulicc$pack $GRi,$s10,$GRdoublek,$ICCi_1 */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRI), ',', OP (S10), ',', OP (GRDOUBLEK), ',',
     OP (ICCI_1), 0}},
...
/* ld$pack $ldann($GRi,$GRj),$GRk */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (LDANN), '(', OP (GRI), ',', OP (GRJ), ')', ',',
     OP (GRK), 0}},
   &ifmt_slass, {0x80100}
   },
...
/* ldd$pack $lddann($GRi,$GRj),$GRdoublek */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (LDDANN), '(', OP (GRI), ',', OP (GRJ), ')',
     ',', OP (GRDOUBLEK), 0}},
   &ifmt_ldd, {0x80140}
   },
...
/* stb$pack $GRk,@($GRi,$GRj) */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRK), ',', '@', '(', OP (GRI), ',', OP (GRJ),
     ')', 0}},
   &ifmt_slass, {0xc0000}
   },
...
/* stc$pack $CPRk,@($GRi,$GRj) */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (CPRK), ',', '@', '(', OP (GRI), ',', OP (GRJ),
     ')', 0}},
   &ifmt_ldc, {0xc0940}
   },
/* std$pack $GRdoublek,@($GRi,$GRj) */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRDOUBLEK), ',', '@', '(', OP (GRI), ',',
     OP (GRJ), ')', 0}},
   &ifmt_ldd, {0xc00c0}
   },
/* stdf$pack $FRdoublek,@($GRi,$GRj) */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRDOUBLEK), ',', '@', '(', OP (GRI), ',',
     OP (GRJ), ')', 0}},
   &ifmt_lddf, {0xc02c0}
   },
/* stdc$pack $CPRdoublek,@($GRi,$GRj) */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (CPRDOUBLEK), ',', '@', '(', OP (GRI), ',',
     OP (GRJ), ')', 0}},
   &ifmt_lddc, {0xc0980}
   },
...
/* stbi$pack $GRk,@($GRi,$d12) */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRK), ',', '@', '(', OP (GRI), ',', OP (D12),
     ')', 0}},
...
/* cmovgf$pack $GRj,$FRintk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRJ), ',', OP (FRINTK), ',', OP (CCI), ',',
     OP (COND), 0}},
...
/* cmovfg$pack $FRintk,$GRj,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTK), ',', OP (GRJ), ',', OP (CCI), ',',
     OP (COND), 0}},
...
/* beq$pack $ICCi_2,$hint,$label16 */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (ICCI_2), ',', OP (HINT), ',', OP (LABEL16),
     0}},
   &ifmt_beq, {0x20180000}
   },
...
/* fbne$pack $FCCi_2,$hint,$label16 */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FCCI_2), ',', OP (HINT), ',', OP (LABEL16),
     0}},
...
/* calll$pack $callann($GRi,$GRj) */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (CALLANN), '(', OP (GRI), ',', OP (GRJ), ')',
     0}},
...
/* cckeq$pack $ICCi_3,$CRj_int,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (ICCI_3), ',', OP (CRJ_INT), ',', OP (CCI), ',',
     OP (COND), 0}},
...
/* cfckne$pack $FCCi_3,$CRj_float,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FCCI_3), ',', OP (CRJ_FLOAT), ',', OP (CCI),
     ',', OP (COND), 0}},
...
/* lrai$pack $GRi,$GRk,$LRAE,$LRAD,$LRAS */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRI), ',', OP (GRK), ',', OP (LRAE), ',',
     OP (LRAD), ',', OP (LRAS), 0}},
   &ifmt_lrai, {0xc0800}
   },
...
/* tlbpr$pack $GRi,$GRj,$TLBPRopx,$TLBPRL */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRI), ',', OP (GRJ), ',', OP (TLBPROPX), ',',
     OP (TLBPRL), 0}},
   &ifmt_tlbpr, {0xc0900}
   },
/* cop1$pack $s6_1,$CPRi,$CPRj,$CPRk */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (S6_1), ',', OP (CPRI), ',', OP (CPRJ), ',',
     OP (CPRK), 0}},
   &ifmt_cop1, {0x1f80000}
   },
...
/* cfitos$pack $FRintj,$FRk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTJ), ',', OP (FRK), ',', OP (CCI), ',',
     OP (COND), 0}},
...
/* cfstoi$pack $FRj,$FRintk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRJ), ',', OP (FRINTK), ',', OP (CCI), ',',
     OP (COND), 0}},
...
/* cfmovs$pack $FRj,$FRk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRJ), ',', OP (FRK), ',', OP (CCI), ',',
     OP (COND), 0}},
...
/* cfadds$pack $FRi,$FRj,$FRk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRI), ',', OP (FRJ), ',', OP (FRK), ',',
     OP (CCI), ',', OP (COND), 0}},
...
/* mand$pack $FRinti,$FRintj,$FRintk */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTI), ',', OP (FRINTJ), ',', OP (FRINTK),
     0}},
   &ifmt_mand, {0x1ec0000}
   },
...
/* cmnot$pack $FRintj,$FRintk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTJ), ',', OP (FRINTK), ',', OP (CCI), ',',
     OP (COND), 0}},
...
/* mcut$pack $ACC40Si,$FRintj,$FRintk */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (ACC40SI), ',', OP (FRINTJ), ',', OP (FRINTK),
     0}},
   &ifmt_mcut, {0x1ec0b00}
   },
...
/* mdcutssi$pack $ACC40Si,$s6,$FRintkeven */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (ACC40SI), ',', OP (S6), ',', OP (FRINTKEVEN),
     0}},
...
/* mdrotli$pack $FRintieven,$s6,$FRintkeven */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTIEVEN), ',', OP (S6), ',',
     OP (FRINTKEVEN), 0}},
...
/* mqsaths$pack $FRintieven,$FRintjeven,$FRintkeven */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTIEVEN), ',', OP (FRINTJEVEN), ',',
     OP (FRINTKEVEN), 0}},
...
/* cmqaddhss$pack $FRintieven,$FRintjeven,$FRintkeven,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTIEVEN), ',', OP (FRINTJEVEN), ',',
     OP (FRINTKEVEN), ',', OP (CCI), ',', OP (COND), 0}},
...
/* mqsllhi$pack $FRintieven,$u6,$FRintkeven */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTIEVEN), ',', OP (U6), ',',
     OP (FRINTKEVEN), 0}},
...
/* mmulhs$pack $FRinti,$FRintj,$ACC40Sk */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTI), ',', OP (FRINTJ), ',', OP (ACC40SK),
     0}},
...
/* mmachu$pack $FRinti,$FRintj,$ACC40Uk */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTI), ',', OP (FRINTJ), ',', OP (ACC40UK),
     0}},
...
/* cmexpdhw$pack $FRinti,$u6,$FRintk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTI), ',', OP (U6), ',', OP (FRINTK), ',',
     OP (CCI), ',', OP (COND), 0}},
...
/* mexpdhd$pack $FRinti,$u6,$FRintkeven */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTI), ',', OP (U6), ',', OP (FRINTKEVEN),
     0}},
...
/* cmbtoh$pack $FRintj,$FRintkeven,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTJ), ',', OP (FRINTKEVEN), ',', OP (CCI),
     ',', OP (COND), 0}},
...
/* cmhtob$pack $FRintjeven,$FRintk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (FRINTJEVEN), ',', OP (FRINTK), ',', OP (CCI),
     ',', OP (COND), 0}},
...
static const CGEN_IFMT ifmt_nop ATTRIBUTE_UNUSED = {
  32, 32, 0x7fffffff, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		       {F (F_D12)}, {0}}
};
...
static const CGEN_IFMT ifmt_cmp ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc03c0, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		       {F (F_ICCI_1)}, {F (F_OPE2)}, {F (F_GRJ)}, {0}}
};

static const CGEN_IFMT ifmt_cmpi ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc0000, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		       {F (F_ICCI_1)}, {F (F_S10)}, {0}}
};

static const CGEN_IFMT ifmt_ccmp ATTRIBUTE_UNUSED = {
  32, 32, 0x7ffc00c0, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		       {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_GRJ)},
		       {0}}
};

static const CGEN_IFMT ifmt_mov ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc0fff, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_D12)}, {0}}
};

static const CGEN_IFMT ifmt_cmov ATTRIBUTE_UNUSED = {
  32, 32, 0x1fc00ff, {{F (F_PACK)}, {F (F_GRK)}, {F (F_OP)}, {F (F_GRI)},
		      {F (F_CCI)}, {F (F_COND)}, {F (F_OPE4)}, {F (F_GRJ)},
		      {0}}
};
...
/* nop$pack */
  {
   -1, "nop", "nop", 32,
   {0 | A (ALIAS),
    {(1 << MACH_BASE), UNIT_IALL, FR400_MAJOR_I_1, FR450_MAJOR_I_1,
     FR500_MAJOR_I_1, FR550_MAJOR_NONE}}
   },
/* ret$pack */
  {
   -1, "ret", "ret", 32,
   {0 | A (NO_DIS) | A (ALIAS),
    {(1 << MACH_BASE), UNIT_B01, FR400_MAJOR_B_3, FR450_MAJOR_B_3,
     FR500_MAJOR_B_3, FR550_MAJOR_NONE}}
   },
...
/* ccmp$pack $GRi,$GRj,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRI), ',', OP (GRJ), ',', OP (CCI), ',',
     OP (COND), 0}},
   &ifmt_ccmp, {0x1640040}
   },
/* mov$pack $GRi,$GRk */
...
/* cmov$pack $GRi,$GRk,$CCi,$cond */
  {
   {0, 0, 0, 0},
   {{MNEM, OP (PACK), ' ', OP (GRI), ',', OP (GRK), ',', OP (CCI), ',',
     OP (COND), 0}},
   &ifmt_cmov, {0x1680040}
   },
};
