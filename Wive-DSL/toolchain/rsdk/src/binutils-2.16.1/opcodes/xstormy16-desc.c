...
const CGEN_HW_ENTRY xstormy16_cgen_hw_table[] = {
  ...
  {"h-gr", HW_H_GR, CGEN_ASM_KEYWORD, (PTR) & xstormy16_cgen_opval_gr_names,
   {0, {(1 << MACH_BASE)}}},
  {"h-Rb", HW_H_RB, CGEN_ASM_KEYWORD,
   (PTR) & xstormy16_cgen_opval_gr_Rb_names, {0 | A (VIRTUAL),
					      {(1 << MACH_BASE)}}},
  {"h-Rbj", HW_H_RBJ, CGEN_ASM_KEYWORD,
   (PTR) & xstormy16_cgen_opval_gr_Rb_names, {0 | A (VIRTUAL),
					      {(1 << MACH_BASE)}}},
  {"h-Rpsw", HW_H_RPSW, CGEN_ASM_NONE, 0,
   {0 | A (VIRTUAL), {(1 << MACH_BASE)}}},
  {"h-z8", HW_H_Z8, CGEN_ASM_NONE, 0, {0 | A (VIRTUAL), {(1 << MACH_BASE)}}},
  {"h-z16", HW_H_Z16, CGEN_ASM_NONE, 0,
   {0 | A (VIRTUAL), {(1 << MACH_BASE)}}},
  ...
  {"h-branchcond", HW_H_BRANCHCOND, CGEN_ASM_KEYWORD,
   (PTR) & xstormy16_cgen_opval_h_branchcond, {0, {(1 << MACH_BASE)}}},
  {"h-wordsize", HW_H_WORDSIZE, CGEN_ASM_KEYWORD,
   (PTR) & xstormy16_cgen_opval_h_wordsize, {0, {(1 << MACH_BASE)}}},
...
const CGEN_IFLD xstormy16_cgen_ifld_table[] = {
  ...
  {XSTORMY16_F_IMM16, "f-imm16", 0, 32, 16, 16,
   {0 | A (SIGN_OPT), {(1 << MACH_BASE)}}},
  {XSTORMY16_F_LMEM8, "f-lmem8", 0, 32, 8, 8,
   {0 | A (ABS_ADDR), {(1 << MACH_BASE)}}},
  {XSTORMY16_F_HMEM8, "f-hmem8", 0, 32, 8, 8,
   {0 | A (ABS_ADDR), {(1 << MACH_BASE)}}},
  {XSTORMY16_F_REL8_2, "f-rel8-2", 0, 32, 8, 8,
   {0 | A (PCREL_ADDR), {(1 << MACH_BASE)}}},
  {XSTORMY16_F_REL8_4, "f-rel8-4", 0, 32, 8, 8,
   {0 | A (PCREL_ADDR), {(1 << MACH_BASE)}}},
  {XSTORMY16_F_REL12, "f-rel12", 0, 32, 20, 12,
   {0 | A (PCREL_ADDR), {(1 << MACH_BASE)}}},
  {XSTORMY16_F_REL12A, "f-rel12a", 0, 32, 4, 11,
   {0 | A (PCREL_ADDR), {(1 << MACH_BASE)}}},
  {XSTORMY16_F_ABS24_1, "f-abs24-1", 0, 32, 8, 8, {0, {(1 << MACH_BASE)}}},
  {XSTORMY16_F_ABS24_2, "f-abs24-2", 0, 32, 16, 16, {0, {(1 << MACH_BASE)}}},
  {XSTORMY16_F_ABS24, "f-abs24", 0, 0, 0, 0,
