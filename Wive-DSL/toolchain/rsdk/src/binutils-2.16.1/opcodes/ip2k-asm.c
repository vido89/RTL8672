     ...
     unsigned long *valuep;
{
  ...
  errmsg = cgen_parse_address (cd, strp, opindex, code, &result_type, &value);
  if (errmsg == NULL)
    {
     ...
     CGEN_FIELDS *fields;
{
  ...
  switch (opindex)
    ...
    case IP2K_OPERAND_ADDR16CJP:
      errmsg =
	parse_addr16_cjp (cd, strp, IP2K_OPERAND_ADDR16CJP,
			  (unsigned long *) (&fields->f_addr16cjp));
      break;
    case IP2K_OPERAND_ADDR16H:
      errmsg =
	parse_addr16 (cd, strp, IP2K_OPERAND_ADDR16H,
		      (unsigned long *) (&fields->f_imm8));
      break;
    case IP2K_OPERAND_ADDR16L:
      errmsg =
	parse_addr16 (cd, strp, IP2K_OPERAND_ADDR16L,
		      (unsigned long *) (&fields->f_imm8));
      break;
    case IP2K_OPERAND_ADDR16P:
      errmsg =
	parse_addr16_cjp (cd, strp, IP2K_OPERAND_ADDR16P,
			  (unsigned long *) (&fields->f_page3));
      break;
    case IP2K_OPERAND_BITNO:
      errmsg =
	parse_bit3 (cd, strp, IP2K_OPERAND_BITNO,
		    (unsigned long *) (&fields->f_bitno));
      break;
    case IP2K_OPERAND_CBIT:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, IP2K_OPERAND_CBIT,
				     (unsigned long *) (&junk));
      break;
    case IP2K_OPERAND_DCBIT:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, IP2K_OPERAND_DCBIT,
				     (unsigned long *) (&junk));
      break;
    case IP2K_OPERAND_FR:
      errmsg =
	parse_fr (cd, strp, IP2K_OPERAND_FR,
		  (unsigned long *) (&fields->f_reg));
      break;
    case IP2K_OPERAND_LIT8:
      errmsg =
	parse_lit8 (cd, strp, IP2K_OPERAND_LIT8, (long *) (&fields->f_imm8));
      break;
    case IP2K_OPERAND_PABITS:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, IP2K_OPERAND_PABITS,
				     (unsigned long *) (&junk));
      break;
    case IP2K_OPERAND_RETI3:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, IP2K_OPERAND_RETI3,
				     (unsigned long *) (&fields->f_reti3));
      break;
    case IP2K_OPERAND_ZBIT:
      errmsg =
	cgen_parse_unsigned_integer (cd, strp, IP2K_OPERAND_ZBIT,
				     (unsigned long *) (&junk));
      break;
