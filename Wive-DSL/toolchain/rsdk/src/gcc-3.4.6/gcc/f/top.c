...
bool ffe_is_second_underscore_ =
  FFETARGET_defaultUNDERSCORED_EXTERNAL_UNDERSCORED;
...
ffe_init_2 (void)
{
  ...
  ffe_program_unit_pool_ =
    malloc_pool_new ("Program unit", ffe_file_pool_, 1024);
...
ffe_init_3 (void)
{
  ...
  ffe_any_unit_pool_ =
    malloc_pool_new ("Any unit", ffe_program_unit_pool_, 1024);
