...
ffebld_constant_is_magical (ffebldConstant c)
{
  switch (ffebld_constant_type (c))
    ...
    case FFEBLD_constINTEGERDEFAULT:
      return
	ffetarget_integerdefault_is_magical (ffebld_constant_integer1 (c));
  ...
  if (!P)
    {
      ...
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constCHARACTER1", sizeof (*nc));
...
#if FFETARGET_okCOMPLEX1
ffebldConstant
ffebld_constant_new_complex1 (ffebldConstant real, ffebldConstant imaginary)
{
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constCOMPLEX1", sizeof (*nc));
...
#if FFETARGET_okCOMPLEX2
ffebldConstant
ffebld_constant_new_complex2 (ffebldConstant real, ffebldConstant imaginary)
{
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constCOMPLEX2", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constHOLLERITH", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constINTEGER1", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constINTEGER2", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constINTEGER3", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constINTEGER4", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constLOGICAL1", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constLOGICAL2", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constLOGICAL3", sizeof (*nc));
  ...
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constLOGICAL4", sizeof (*nc));
...
ffebld_constant_new_real1 (ffelexToken integer, ffelexToken decimal,
			   ffelexToken fraction, ffelexToken exponent,
			   ...
			   ffelexToken exponent_digits)
{
  ...
  ffetarget_real1 (&val,
		   integer, decimal, fraction, exponent, exponent_sign,
		   exponent_digits);
...
ffebld_constant_new_typeless_val (ffebldConst type, ffetargetTypeless val)
{
  ...
  ffebldConstant Q;
  int cmp = 0;
  P = ffebld_constant_typeless_[type - FFEBLD_constTYPELESS_FIRST];
  Q = P;
  if (!P)
    {
      /* make this node the root */
      nc = malloc_new_kp (ffebld_constant_pool (),
			  "FFEBLD_constTYPELESS", sizeof (*nc));
      nc->consttype = type;
      nc->u.typeless = val;
      nc->hook = FFECOM_constantNULL;
      nc->llink = NULL;
...
ffebld_constantarray_preparray (void **aptr, void **cptr, size_t * size,
				...
				ffeinfoBasictype abt, ffeinfoKindtype akt,
...
ffebld_constantarray_prepare (void **aptr, void **cptr, size_t * size,
			      ffebldConstantArray array, ffeinfoBasictype abt,
			      ffeinfoKindtype akt, ffetargetOffset offset,
