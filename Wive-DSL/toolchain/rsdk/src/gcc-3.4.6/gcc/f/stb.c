...
static ffelexHandler ffestb_do4_ (ffelexToken ft, ffebld expr, ffelexToken t);
static ffelexHandler ffestb_do5_ (ffelexToken t);
static ffelexHandler ffestb_do6_ (ffelexToken ft, ffebld expr, ffelexToken t);
static ffelexHandler ffestb_do7_ (ffelexToken ft, ffebld expr, ffelexToken t);
static ffelexHandler ffestb_do8_ (ffelexToken ft, ffebld expr, ffelexToken t);
static ffelexHandler ffestb_do9_ (ffelexToken ft, ffebld expr, ffelexToken t);
...
static ffelexHandler ffestb_halt1_ (ffelexToken ft, ffebld expr,
				    ffelexToken t);
static ffelexHandler ffestb_if1_ (ffelexToken ft, ffebld expr, ffelexToken t);
  ...
  if (!ffestb_local_.decl.aster_after)
      ...
      if (ffestb_local_.decl.type == FFESTP_typeCHARACTER)
	{
	  if (!ffesta_is_inhibited ())
	    ffestc_decl_start (ffestb_local_.decl.type, ffesta_tokens[0],
			       ffestb_local_.decl.kind,
			       ffestb_local_.decl.kindt,
			       ffestb_local_.decl.len,
			       ffestb_local_.decl.lent);
	  if (ffestb_local_.decl.kindt != NULL)
	    {
	      ffelex_token_kill (ffestb_local_.decl.kindt);
      ...
      else
	{
	  if (!ffesta_is_inhibited ())
	    ffestc_decl_start (ffestb_local_.decl.type, ffesta_tokens[0],
			       ffestb_local_.decl.kind,
			       ffestb_local_.decl.kindt, NULL, NULL);
	  if (ffestb_local_.decl.kindt != NULL)
	    {
	      ffelex_token_kill (ffestb_local_.decl.kindt);
	      ffestb_local_.decl.kind = NULL;
...
#endif
      ffestt_dimlist_append (ffestb_subrargs_.dim_list.dims, expr, NULL, ffelex_token_use (t));	/* NULL second expr for
												   now, just plug in. */
      return (ffelexHandler) ffeexpr_rhs (ffestb_subrargs_.dim_list.pool,
					  ffestb_subrargs_.dim_list.ctx,
					  (ffeexprCallback)
...
ffestb_decl_kindparam_1_ (ffelexToken t)
{
  ...
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM,
		     ffestb_local_.decl.badname, ffesta_tokens[1]);
  ffelex_token_kill (ffesta_tokens[1]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_decl_kindparam_2_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  ...
  if (ffestb_local_.decl.recursive != NULL)
    ffelex_token_kill (ffestb_local_.decl.recursive);
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, ffestb_local_.decl.badname, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
	...
	case FFELEX_typeEQUALS:
	  ...
	  next = (ffelexHandler) (*((ffelexHandler) ffeexpr_lhs
				    (ffesta_output_pool, FFEEXPR_contextDO,
				     (ffeexprCallback) ffestb_do6_))) (nt);
...
bad_1:				/* :::::::::::::::::::: */
  ...
  return (ffelexHandler) ffelex_swallow_tokens (t, (ffelexHandler) ffesta_zero);	/* Invalid second token. */
...
ffestb_dowhile (ffelexToken t)
{
  ...
  switch (ffelex_token_type (ffesta_tokens[0]))
	...
	case FFELEX_typeOPEN_PAREN:
	  p = ffelex_token_text (ffesta_tokens[0]) + (i =
	...
	case FFELEX_typeEQUALS:	/* Not really DOWHILE, but DOWHILExyz=.... */
	  ffesta_tokens[1] = NULL;
	  nt =
	    ffelex_token_name_from_names (ffesta_tokens[0], FFESTR_firstlDO,
					  0);
	  next =
	    (ffelexHandler) (*
			     ((ffelexHandler)
...
ffestb_do3_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	(ffelexHandler) (*
			 ((ffelexHandler)
			  ffeexpr_lhs (ffesta_output_pool, FFEEXPR_contextDO,
				       (ffeexprCallback)
				       ffestb_do6_))) (ffesta_tokens[2]);
      ...
      if (ffestr_second (ffesta_tokens[2]) != FFESTR_secondWHILE)
	{
	  ...
	  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, "DO",
			     ffesta_tokens[2]);
	  ffelex_token_kill (ffesta_tokens[2]);
	  return (ffelexHandler) ffelex_swallow_tokens (t, (ffelexHandler) ffesta_zero);	/* Invalid token. */
	}
      ffelex_token_kill (ffesta_tokens[2]);
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  FFEEXPR_contextDOWHILE,
      ...
      if (!ffesta_is_inhibited ())
	{
	  if (ffesta_tokens[1] != NULL)
	    ffestc_R819A (ffesta_construct_name, ffesta_tokens[1],
			  ...
			  ffestb_local_.do_stmt.end, ffesta_tokens[4], expr,
			  ft);
	  else
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "ELSE", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "ELSE IF", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "GO TO", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_0:				/* :::::::::::::::::::: */
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, "assignment",
		     ffesta_tokens[0]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
...
ffestb_let2_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  ...
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM,
		     (ffelex_token_type (ffesta_tokens[1]) ==
		      FFELEX_typeEQUALS) ? "assignment" :
		     "pointer-assignment", t);
  ffelex_token_kill (ffesta_tokens[1]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_0:				/* :::::::::::::::::::: */
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, ffestb_args.varlist.badname,
		     ffesta_tokens[0]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, ffestb_args.varlist.badname,
		     ffesta_tokens[0], i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "SAVE", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "DATA", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "NAMELIST", ffesta_tokens[0],
		     i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_0:				/* :::::::::::::::::::: */
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, "EQUIVALENCE",
		     ffesta_tokens[0]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "CYCLE", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "EXIT", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
	  ...
	  next = (ffelexHandler)
	    (*((ffelexHandler)
	       ffeexpr_lhs (ffesta_output_pool,
			    ...
			    (ffeexprCallback) ffestb_R8383_))) (et);
...
bad_0:				/* :::::::::::::::::::: */
  ...
  return (ffelexHandler) ffelex_swallow_tokens (t, (ffelexHandler) ffesta_zero);	/* Invalid first token. */
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "ASSIGN", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_R8381_ (ffelexToken t)
{
  if ((ffelex_token_type (t) == FFELEX_typeNAME)
      &&
      (ffesrc_strcmp_2c
       (ffe_case_match (), ffelex_token_text (t), "TO", "to", "To") == 0))
    {
  ...
  if (ffelex_token_type (t) == FFELEX_typeNAME)
	...
	(*((ffelexHandler)
	   ffeexpr_lhs (ffesta_output_pool, FFEEXPR_contextASSIGN,
			(ffeexprCallback) ffestb_R8383_))) (t);
    }
...
bad_0:				/* :::::::::::::::::::: */
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, "arithmetic-IF",
		     ffesta_tokens[0]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "CONTINUE", ffesta_tokens[0],
		     i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "PROGRAM", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_0:				/* :::::::::::::::::::: */
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, "BLOCK DATA",
		     ffesta_tokens[0]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "BLOCK DATA", ffesta_tokens[0],
		     i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
  ...
  switch (ffelex_token_type (ffesta_tokens[0]))
	...
	(*((ffelexHandler)
	   ffeexpr_lhs (ffesta_output_pool, FFEEXPR_contextSUBROUTINEREF,
			(ffeexprCallback) ffestb_R12121_))) (t);
	...
	(*((ffelexHandler)
	   ffeexpr_lhs (ffesta_output_pool, FFEEXPR_contextSUBROUTINEREF,
			(ffeexprCallback) ffestb_R12121_))) (nt);
      ffelex_token_kill (nt);
      return (ffelexHandler) (*next) (t);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "CALL", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_R1227 (ffelexToken t)
{
  ...
  switch (ffelex_token_type (ffesta_tokens[0]))
	...
	default:
      ...
      next =
	(ffelexHandler) ffelex_splice_tokens (next, ffesta_tokens[0],
					      FFESTR_firstlRETURN);
      if (next == NULL)
	return (ffelexHandler) ffelex_swallow_tokens (t,
						      (ffelexHandler)
...
bad_0:				/* :::::::::::::::::::: */
  ...
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, "SELECT CASE",
		     ffesta_tokens[0]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
...
bad_i:				/* :::::::::::::::::::: */
  ...
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "SELECT CASE",
		     ffesta_tokens[0], i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "CASE", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_R8103_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
    {
    case FFELEX_typeCLOSE_PAREN:
      ffestt_caselist_append (ffestb_local_.case_stmt.cases, FALSE, expr,
			      NULL, ffelex_token_use (ft));
      return (ffelexHandler) ffestb_R8101_;
    ...
    case FFELEX_typeCOLON:
      ffestt_caselist_append (ffestb_local_.case_stmt.cases, TRUE, expr, NULL, ffelex_token_use (ft));	/* NULL second expr for
													   now, just plug in. */
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  FFEEXPR_contextCASE,
					  (ffeexprCallback) ffestb_R8104_);
  ...
  switch (ffelex_token_type (t))
      ...
      if (!ffesta_seen_first_exec && !ffestb_local_.format.complained)
	{
      ...
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  ...
					  (ffeexprCallback) ffestb_R100115_);
    ...
    case FFELEX_typeSEMICOLON:
      ...
      for (f = ffestb_local_.format.f;
	   f->u.root.parent != NULL; f = f->u.root.parent->next)
	;
	...
	break;			/* Error, probably something like FORMAT("17)
				   = X. */
      ffelex_set_expecting_hollerith (-1, '\"', ffelex_token_where_line (t), ffelex_token_where_column (t));	/* Don't have to unset
														   this one. */
  ...
  switch (ffelex_token_type (t))
      ...
      else
	{
	  ...
	  ffestb_local_.format.pre.u.unsigned_val +=
	    strtoul (ffelex_token_text (t), NULL, 10);
	  ffelex_set_expecting_hollerith (ffestb_local_.format.pre.u.
					  unsigned_val, '\0',
					  ffelex_token_where_line (t),
					  ffelex_token_where_column (t));
	}
      ...
      if (ffestb_local_.format.sign)
	{
	  ffebad_start (FFEBAD_FORMAT_SPURIOUS_SIGN);
	  ffebad_here (0,
		       ffelex_token_where_line (ffestb_local_.format.pre.t),
		       ffelex_token_where_column (ffestb_local_.format.pre.
						  t));
	  ffebad_finish ();
	  ffestb_local_.format.pre.u.unsigned_val
...
ffestb_R10015_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
      ...
      if (!ffesta_seen_first_exec && !ffestb_local_.format.complained)
	{
      ...
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  FFEEXPR_contextFORMAT,
					  (ffeexprCallback) ffestb_R100116_);
...
ffestb_R10017_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
      ...
      if (!ffesta_seen_first_exec && !ffestb_local_.format.complained)
	{
      ...
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  FFEEXPR_contextFORMAT,
					  (ffeexprCallback) ffestb_R100117_);
...
ffestb_R10019_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
      ...
      if (!ffesta_seen_first_exec && !ffestb_local_.format.complained)
	{
      ...
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  FFEEXPR_contextFORMAT,
					  (ffeexprCallback) ffestb_R100118_);
...
ffestb_R100110_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	case FFESTP_formattypeNone:
	  ffesta_ffebad_1t (FFEBAD_FORMAT_BAD_SPEC, ffestb_local_.format.t);
	  ...
	  || ((pre == required) && !ffestb_local_.format.pre.present))
	{
	  ffesta_ffebad_1t (err, (pre == required)
			    ? ffestb_local_.format.t : ffestb_local_.format.
			    pre.t);
      ...
      if ((*p != '_') || (++i, *++p != '\0'))
	{
      ...
      next = (ffelexHandler) (*((ffelexHandler) ffeexpr_rhs
				(ffesta_output_pool, FFEEXPR_contextINCLUDE,
				 (ffeexprCallback) ffestb_S3P41_))) (nt);
      ffelex_token_kill (nt);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "INCLUDE", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
      ...
      if (!ffesta_is_inhibited ())
	{
	  if (ffe_is_pedantic ()
		  ...
		  || ffesta_line_has_semicolons))
	    {
	      ...
	      ffebad_start_msg
		("INCLUDE at %0 not the only statement on the source line",
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "VOLATILE", ffesta_tokens[0],
		     i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_beru (ffelexToken t)
{
  ...
  switch (ffelex_token_type (ffesta_tokens[0]))
	...
	case FFELEX_typeOPEN_PAREN:
	  if (ffelex_token_length (ffesta_tokens[0]) != ffestb_args.beru.len)
	    break;
...
ffestb_beru1_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	break;
      ffesta_confirmed ();
      ffestp_file.beru.beru_spec[FFESTP_beruixUNIT].kw_or_val_present = TRUE;
      ...
      ffestp_file.beru.beru_spec[FFESTP_beruixUNIT].value_is_label = FALSE;
...
ffestb_beru5_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	default:
      ...
      if (ffestp_file.beru.beru_spec[ffestb_local_.beru.ix].kw_or_val_present)
	break;			/* Can't specify a keyword twice! */
      ffestp_file.beru.beru_spec[ffestb_local_.beru.ix].kw_or_val_present =
	TRUE;
      ffestp_file.beru.beru_spec[ffestb_local_.beru.ix].kw_present = TRUE;
      ffestp_file.beru.beru_spec[ffestb_local_.beru.ix].value_present = FALSE;
...
ffestb_beru7_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
    ...
    case FFELEX_typeCLOSE_PAREN:
      if (expr == NULL)
	break;
      ffestp_file.beru.beru_spec[ffestb_local_.beru.ix].value_present = TRUE;
...
ffestb_R9043_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
    ...
    case FFELEX_typeCLOSE_PAREN:
      if (expr == NULL)
	break;
      ffestp_file.open.open_spec[FFESTP_openixUNIT].kw_or_val_present = TRUE;
      ...
      ffestp_file.open.open_spec[FFESTP_openixUNIT].value_is_label = FALSE;
...
ffestb_R9044_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	case FFESTR_openNOSPANBLOCKS:
	  ...
	  ffestp_file.open.open_spec[FFESTP_openixNOSPANBLOCKS].kw_present =
	    TRUE;
	  ffestp_file.open.open_spec[FFESTP_openixNOSPANBLOCKS].
	    value_present = FALSE;
	...
	case FFESTR_openREADONLY:
	  ...
	  ffestp_file.open.open_spec[FFESTP_openixREADONLY].
	    kw_or_val_present = TRUE;
	  ffestp_file.open.open_spec[FFESTP_openixREADONLY].kw_present = TRUE;
	  ffestp_file.open.open_spec[FFESTP_openixREADONLY].value_present =
	    FALSE;
	...
	case FFESTR_openSHARED:
	  if (ffestp_file.open.open_spec[FFESTP_openixSHARED].
	      kw_or_val_present)
	    goto bad;		/* :::::::::::::::::::: */
	  ffestp_file.open.open_spec[FFESTP_openixSHARED].kw_or_val_present =
	    TRUE;
	  ffestp_file.open.open_spec[FFESTP_openixSHARED].kw_present = TRUE;
	  ffestp_file.open.open_spec[FFESTP_openixSHARED].value_present =
	    FALSE;
	...
	default:
      ...
      if (ffestp_file.open.open_spec[ffestb_local_.open.ix].kw_or_val_present)
	break;			/* Can't specify a keyword twice! */
      ffestp_file.open.open_spec[ffestb_local_.open.ix].kw_or_val_present =
	TRUE;
      ffestp_file.open.open_spec[ffestb_local_.open.ix].kw_present = TRUE;
      ffestp_file.open.open_spec[ffestb_local_.open.ix].value_present = FALSE;
...
ffestb_R9046_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
    ...
    case FFELEX_typeCLOSE_PAREN:
      if (expr == NULL)
	break;
      ffestp_file.open.open_spec[ffestb_local_.open.ix].value_present = TRUE;
...
ffestb_R9073_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	= TRUE;
      ...
      ffestp_file.close.close_spec[FFESTP_closeixUNIT].value_is_label = FALSE;
...
ffestb_R9074_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	default:
	  ...
	  kw_or_val_present)
	break;			/* Can't specify a keyword twice! */
      ffestp_file.close.close_spec[ffestb_local_.close.ix].kw_or_val_present =
	TRUE;
      ffestp_file.close.close_spec[ffestb_local_.close.ix].kw_present = TRUE;
...
ffestb_R9094_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  ...
  if (ffebld_op (expr) != FFEBLD_opITEM)
	...
	case FFELEX_typeSEMICOLON:
	  ...
	  ffestp_file.read.read_spec[FFESTP_readixFORMAT].kw_or_val_present
	    = TRUE;
	  ffestp_file.read.read_spec[FFESTP_readixFORMAT].kw_present = FALSE;
	  ffestp_file.read.read_spec[FFESTP_readixFORMAT].value_present =
	    TRUE;
	  ffestp_file.read.read_spec[FFESTP_readixFORMAT].value_is_label =
	    FALSE;
	  ffestp_file.read.read_spec[FFESTP_readixFORMAT].value =
  ...
  switch (ffelex_token_type (t))
    ...
    case FFELEX_typeCOMMA:
    case FFELEX_typeCLOSE_PAREN:
      ffestp_file.read.read_spec[FFESTP_readixUNIT].kw_or_val_present = TRUE;
      ...
      ffestp_file.read.read_spec[FFESTP_readixUNIT].value_is_label = FALSE;
...
ffestb_R9098_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	default:
      ...
      if (ffestp_file.read.read_spec[ffestb_local_.read.ix].kw_or_val_present)
	break;			/* Can't specify a keyword twice! */
      ffestp_file.read.read_spec[ffestb_local_.read.ix].kw_or_val_present =
	TRUE;
      ffestp_file.read.read_spec[ffestb_local_.read.ix].kw_present = TRUE;
      ffestp_file.read.read_spec[ffestb_local_.read.ix].value_present = FALSE;
...
ffestb_R90910_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
      ...
      if (expr == NULL)
	{
      ...
      ffestp_file.read.read_spec[ffestb_local_.read.ix].value_present = TRUE;
...
ffestb_R9103_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	= TRUE;
      ...
      ffestp_file.write.write_spec[FFESTP_writeixUNIT].value_is_label = FALSE;
...
ffestb_R9107_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	default:
	  ...
	  kw_or_val_present)
	break;			/* Can't specify a keyword twice! */
      ffestp_file.write.write_spec[ffestb_local_.write.ix].kw_or_val_present =
	TRUE;
      ffestp_file.write.write_spec[ffestb_local_.write.ix].kw_present = TRUE;
...
ffestb_R91012_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					    ffestc_context_iolist (),
					    (ffeexprCallback) ffestb_R91013_);
...
ffestb_R91013_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	ffestc_R910_item (expr, ft);
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  ffestc_context_iolist (),
					  (ffeexprCallback) ffestb_R91014_);
...
ffestb_R9233_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	= TRUE;
      ffestp_file.inquire.inquire_spec[FFESTP_inquireixUNIT].kw_present =
	FALSE;
      ffestp_file.inquire.inquire_spec[FFESTP_inquireixUNIT].value_present =
	TRUE;
...
ffestb_R9234_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	kw_or_val_present = TRUE;
      ffestp_file.inquire.inquire_spec[ffestb_local_.inquire.ix].kw_present =
	TRUE;
      ffestp_file.inquire.inquire_spec[ffestb_local_.inquire.ix].
	value_present = FALSE;
      ffestp_file.inquire.inquire_spec[ffestb_local_.inquire.ix].
	value_is_label = ffestb_local_.inquire.label;
...
ffestb_R9236_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	= ffelex_token_use (ft);
      ffestp_file.inquire.inquire_spec[ffestb_local_.inquire.ix].u.expr =
	expr;
      if (ffelex_token_type (t) == FFELEX_typeCOMMA)
	return (ffelexHandler) ffestb_R9234_;
      if (ffestb_local_.inquire.ix == FFESTP_inquireixIOLENGTH)
...
ffestb_R92311_ (ffelexToken ft, ffebld expr, ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	ffestc_R923B_item (expr, ft);
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  FFEEXPR_contextIOLIST,
					  (ffeexprCallback) ffestb_R92311_);
...
bad_0:				/* :::::::::::::::::::: */
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, ffestb_args.dummy.badname,
		     ffesta_tokens[0]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, ffestb_args.dummy.badname,
		     ffesta_tokens[0], i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_dummy1_ (ffelexToken t)
{
  ...
  if (ffestb_local_.decl.recursive != NULL)
    ffelex_token_kill (ffestb_local_.decl.recursive);
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, ffestb_local_.dummy.badname,
		     t);
  ffelex_token_kill (ffesta_tokens[1]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
	  ...
	  switch (ffestb_local_.dummy.first_kw)
	    ...
	    case FFESTR_firstFUNCTION:
	      ffestc_R1219 (ffesta_tokens[1], ffestb_subrargs_.name_list.args,
			    ...
			    FFESTP_typeNone, NULL, NULL, NULL, NULL,
			    ffestb_local_.decl.recursive, NULL);
	      break;
...
bad_0:				/* :::::::::::::::::::: */
  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, ffestb_args.R524.badname,
		     ffesta_tokens[0]);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, ffestb_args.R524.badname,
		     ffesta_tokens[0], i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_R5243_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
      ...
      if (!ffesta_is_inhibited ())
	{
	  ...
	  ffestc_R524_item (ffesta_tokens[1], ffestb_subrargs_.dim_list.dims);
	}
      ffelex_token_kill (ffesta_tokens[1]);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "COMMON", ffesta_tokens[0], i,
		     t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
  ...
  switch (ffelex_token_type (t))
	...
	ffestc_R1229_start (ffesta_tokens[0],
      ...
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  ...
					  (ffeexprCallback) ffestb_R12292_);
...
ffestb_decl_chartype (ffelexToken t)
{
  ...
  switch (ffelex_token_type (ffesta_tokens[0]))
	...
	goto bad_i;		/* :::::::::::::::::::: */
      ...
      ffestb_local_.decl.lent = NULL;
      ffesta_tokens[1] =
	ffelex_token_names_from_names (ffesta_tokens[0], i, 0);
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "type-declaration",
		     ffesta_tokens[0], i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_decl_chartype1_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
    ...
    case FFELEX_typeCOMMA:
      ...
      if (!ffesta_is_inhibited ())
	ffestc_decl_start (ffestb_local_.decl.type, ffesta_tokens[0],
			   NULL, NULL, ffestb_local_.decl.len,
			   ffestb_local_.decl.lent);
      if (ffestb_local_.decl.lent != NULL)
	ffelex_token_kill (ffestb_local_.decl.lent);
      return (ffelexHandler) ffestb_decl_ents_;
...
ffestb_decl_attrs_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	case FFESTR_firstSAVE:
	  if (!ffesta_is_inhibited ())
	    ffestc_decl_attrib (FFESTP_attribSAVE, t, FFESTR_otherNone, NULL);
	  return (ffelexHandler) ffestb_decl_attrs_7_;
...
ffestb_decl_attrs_1_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
    ...
    case FFELEX_typeOPEN_PAREN:
      ffestb_subrargs_.dim_list.dims = ffestt_dimlist_create ();
      ffestb_subrargs_.dim_list.handler =
	(ffelexHandler) ffestb_decl_attrs_2_;
...
ffestb_decl_ents_1_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
    ...
    case FFELEX_typeCOMMA:
      if (!ffesta_is_inhibited ())
	ffestc_decl_item (ffesta_tokens[1], NULL, NULL, NULL, NULL, NULL,
			  NULL, NULL, FALSE);
      ffelex_token_kill (ffesta_tokens[1]);
      return (ffelexHandler) ffestb_decl_ents_;
...
ffestb_decl_ents_3_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	ffestc_decl_item (ffesta_tokens[1], ffestb_local_.decl.kind,
			  ffestb_local_.decl.kindt, NULL, NULL, NULL, NULL,
			  NULL, FALSE);
      ffelex_token_kill (ffesta_tokens[1]);
      if (ffestb_local_.decl.kindt != NULL)
	ffelex_token_kill (ffestb_local_.decl.kindt);
...
ffestb_decl_ents_7_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	ffesta_ffebad_1t (FFEBAD_INVALID_TYPEDECL_INIT, t);
      return (ffelexHandler) ffeexpr_rhs (ffesta_output_pool,
					  ffestb_local_.decl.
					  parameter ? FFEEXPR_contextPARAMETER
					  : FFEEXPR_contextINITVAL,
					  (ffeexprCallback)
					  ffestb_decl_ents_8_);
...
ffestb_decl_entsp_1_ (ffelexToken t)
{
  switch (ffelex_token_type (t))
	...
	default:
	  ffesta_ffebad_1st (FFEBAD_INVALID_STMT_FORM, "FUNCTION",
			     ffesta_tokens[1]);
	  break;
	}
      break;
...
ffestb_decl_funcname_5_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
	...
	ffestc_R1219 (ffesta_tokens[1], ffestb_subrargs_.name_list.args,
		      ffestb_subrargs_.name_list.close_paren,
		      ffestb_local_.decl.type, ffestb_local_.decl.kind,
		      ffestb_local_.decl.kindt, ffestb_local_.decl.len,
		      ffestb_local_.decl.lent, ffestb_local_.decl.recursive,
		      NULL);
      if (ffestb_local_.decl.recursive != NULL)
	ffelex_token_kill (ffestb_local_.decl.recursive);
      if (ffestb_local_.decl.kindt != NULL)
...
bad_i:				/* :::::::::::::::::::: */
  ffesta_ffebad_1sp (FFEBAD_INVALID_STMT_FORM, "PARAMETER", ffesta_tokens[0],
		     i, t);
  return (ffelexHandler) ffelex_swallow_tokens (t,
						(ffelexHandler) ffesta_zero);
}
...
ffestb_decl_R539maybe_5_ (ffelexToken t)
{
  ...
  switch (ffelex_token_type (t))
    ...
    case FFELEX_typeOPEN_PAREN:
      ...
      ffestt_implist_kill (ffestb_local_.decl.imps);
      next =
	(ffelexHandler) ffestt_tokenlist_handle (ffestb_local_.decl.toklist,
						 (ffelexHandler)
						 ffestb_local_.decl.
						 imp_handler);
      ffestt_tokenlist_kill (ffestb_local_.decl.toklist);
