...
#ifdef L_gcov
void
__gcov_init (struct gcov_info *p __attribute__ ((unused)))
{
}
...
void
__gcov_merge_add (gcov_type * counters __attribute__ ((unused)),
...
void
__gcov_merge_single (gcov_type * counters __attribute__ ((unused)),
		     unsigned n_counters __attribute__ ((unused)))
{
}
#endif
...
void
__gcov_merge_delta (gcov_type * counters __attribute__ ((unused)),
		    unsigned n_counters __attribute__ ((unused)))
{
}
#endif
