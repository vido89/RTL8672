...
static void queue_pattern (rtx, struct queue_elem ***, const char *, int);
...
static const char *
alter_test_for_insn (struct queue_elem *ce_elem, struct queue_elem *insn_elem)
{
...
alter_output_for_insn (struct queue_elem *ce_elem,
		       struct queue_elem *insn_elem, int alt, int max_op)
{
