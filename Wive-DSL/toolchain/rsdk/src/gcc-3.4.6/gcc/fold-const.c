...
static void decode (HOST_WIDE_INT *, unsigned HOST_WIDE_INT *,
		    HOST_WIDE_INT *);
...
force_fit_type (tree t, int overflow)
{
  ...
  return
    ((overflow | (low ^ TREE_INT_CST_LOW (t)) |
      (high ^ TREE_INT_CST_HIGH (t))) != 0);
}

	       ...
	       unsigned HOST_WIDE_INT * lv, HOST_WIDE_INT * hv, int arith)
{
  ...
  if (count >= (HOST_WIDE_INT) prec)
    ...
    {
      *hv &=
	~((HOST_WIDE_INT) (-1) << (prec - count - HOST_BITS_PER_WIDE_INT));
...
int
div_and_round_double (enum tree_code code, int uns, unsigned HOST_WIDE_INT lnum_orig,	/* num == numerator == dividend */
		      HOST_WIDE_INT hnum_orig, unsigned HOST_WIDE_INT lden_orig,	/* den == denominator == divisor */
  ...
  switch (code)
	...
	if (((unsigned HOST_WIDE_INT) habs_den
	    ...
	    || (((unsigned HOST_WIDE_INT) habs_den
		 == (unsigned HOST_WIDE_INT) htwice) && (labs_den < ltwice)))
	  {
	    if (*hquo < 0)
	      /* quo = quo - 1;  */
	      add_double (*lquo, *hquo,
			  (HOST_WIDE_INT) - 1, (HOST_WIDE_INT) - 1, lquo,
			  hquo);
	    else
	      /* quo = quo + 1; */
	      add_double (*lquo, *hquo, (HOST_WIDE_INT) 1, (HOST_WIDE_INT) 0,
...
negate_expr (tree t)
{
  ...
  switch (TREE_CODE (t))
	...
	TREE_CONSTANT_OVERFLOW (tem)
      ...
      if (!TREE_OVERFLOW (tem) || TREE_UNSIGNED (type) || !flag_trapv)
	return tem;
      break;
	    ...
	    tree * minus_litp, int negate_p)
{
  ...
  *minus_litp = 0;
  ...
  if (TREE_CODE (in) == INTEGER_CST || TREE_CODE (in) == REAL_CST)
    *litp = in;
  else if (TREE_CODE (in) == code || (!FLOAT_TYPE_P (TREE_TYPE (in))
...
int_const_binop (enum tree_code code, tree arg1, tree arg2, int notrunc)
{
  ...
  switch (code)
    ...
    case RROTATE_EXPR:
      int2l = -int2l;
    case LROTATE_EXPR:
      lrotate_double (int1l, int1h, int2l, TYPE_PRECISION (type), &low, &hi);
      break;
	...
	low = (((unsigned HOST_WIDE_INT) int1h
		< (unsigned HOST_WIDE_INT) int2h)
	       || (((unsigned HOST_WIDE_INT) int1h
		    == (unsigned HOST_WIDE_INT) int2h) && int1l < int2l));
      else
	low = (int1h < int2h || (int1h == int2h && int1l < int2l));
  ...
  TREE_OVERFLOW (t)
	...
	: (force_fit_type (t, (!uns || is_sizetype) && overflow)
	   && !no_overflow)) | TREE_OVERFLOW (arg1) | TREE_OVERFLOW (arg2));

  /* If we're doing a size calculation, unsigned arithmetic does overflow.
     So check if force_fit_type truncated the value.  */
  if (is_sizetype
      && !TREE_OVERFLOW (t)
      && (TREE_INT_CST_HIGH (t) != hi || TREE_INT_CST_LOW (t) != low))
    TREE_OVERFLOW (t) = 1;
...
size_htab_hash (const void *x)
{
  ...
  return (TREE_INT_CST_HIGH (t) ^ TREE_INT_CST_LOW (t)
	  ^ htab_hash_pointer (TREE_TYPE (t)) ^ (TREE_OVERFLOW (t) << 20));
}
		    ...
		    tree arg1)
{
  ...
  if (POINTER_TYPE_P (type) || INTEGRAL_TYPE_P (type))
      ...
      if (TREE_CODE (arg1) == REAL_CST)
	{
	  ...
	  TREE_OVERFLOW (t) = TREE_OVERFLOW (arg1) | force_fit_type (t, 0);
	  TREE_CONSTANT_OVERFLOW (t)
	    = TREE_OVERFLOW (t) | TREE_CONSTANT_OVERFLOW (arg1);
	  return t;
	}
...
fold_convert (tree type, tree arg)
{
  ...
  if (TREE_CODE (arg) == ERROR_MARK
      || TREE_CODE (type) == ERROR_MARK || TREE_CODE (orig) == ERROR_MARK)
    return error_mark_node;
  ...
  if (INTEGRAL_TYPE_P (type) || POINTER_TYPE_P (type)
  ...
  else if (TREE_CODE (type) == COMPLEX_TYPE)
    {
	  ...
	  || POINTER_TYPE_P (orig) || TREE_CODE (orig) == REAL_TYPE)
...
operand_equal_p (tree arg0, tree arg1, int only_const)
{
  ...
  if (TREE_CONSTANT (arg0) && TREE_CONSTANT (arg1))
      ...
      case VECTOR_CST:
	{
	  ...
	  if (TREE_CONSTANT_OVERFLOW (arg0) || TREE_CONSTANT_OVERFLOW (arg1))
	    return 0;
	...
	return (operand_equal_p (TREE_REALPART (arg0), TREE_REALPART (arg1),
				 only_const)
		&& operand_equal_p (TREE_IMAGPART (arg0),
				    TREE_IMAGPART (arg1), only_const));
  ...
  switch (class)
    ...
    case '2':
      return (twoval_comparison_p
	      (TREE_OPERAND (arg, 0), cval1, cval2, save_p)
...
distribute_bit_expr (enum tree_code code, tree type, tree arg0, tree arg1)
{
  ...
  if (operand_equal_p (TREE_OPERAND (arg0, 0), TREE_OPERAND (arg1, 0), 0))
    ...
    if (operand_equal_p (TREE_OPERAND (arg0, 0), TREE_OPERAND (arg1, 1), 0))
    {
      common = TREE_OPERAND (arg0, 0);
      left = TREE_OPERAND (arg0, 1);
    ...
    if (operand_equal_p (TREE_OPERAND (arg0, 1), TREE_OPERAND (arg1, 0), 0))
    {
    ...
    if (operand_equal_p (TREE_OPERAND (arg0, 1), TREE_OPERAND (arg1, 1), 0))
    {
      common = TREE_OPERAND (arg0, 1);
      left = TREE_OPERAND (arg0, 0);
      right = TREE_OPERAND (arg1, 0);
			    ...
			    tree lhs, tree rhs)
{
  ...
  rhs = fold (const_binop (BIT_AND_EXPR,
			   const_binop (LSHIFT_EXPR,
					fold_convert (unsigned_type, rhs),
					size_int (lbitpos), 0), mask, 0));

  return build (code, compare_type,
		build (BIT_AND_EXPR, unsigned_type, lhs, mask), rhs);
}

...
sign_bit_p (tree exp, tree val)
{
  ...
  if (TREE_CODE (val) != INTEGER_CST || TREE_CONSTANT_OVERFLOW (val))
    return NULL_TREE;
...
simple_operand_p (tree exp)
{
  ...
  return (TREE_CODE_CLASS (TREE_CODE (exp)) == 'c'
	  || (DECL_P (exp)
	      ...
	      && !TREE_THIS_VOLATILE (exp) && !DECL_NONLOCAL (exp)
  ...
  if (TREE_CODE (exp) == INTEGER_CST)
    {
      in_p = in_p == (integer_onep (range_binop (GE_EXPR, integer_type_node,
		      ...
		      integer_onep (range_binop
				    (LE_EXPR, integer_type_node, exp, 1, high,
				     1)));
      low = high = 0;
      exp = 0;
    }
...
fold_truthop (enum tree_code code, tree truth_type, tree lhs, tree rhs)
{
  ...
  if (lcode == BIT_AND_EXPR && integer_onep (TREE_OPERAND (lhs, 1)))
    lcode = NE_EXPR, lhs =
      build (NE_EXPR, truth_type, lhs, integer_zero_node);

  if (rcode == BIT_AND_EXPR && integer_onep (TREE_OPERAND (rhs, 1)))
    rcode = NE_EXPR, rhs =
      build (NE_EXPR, truth_type, rhs, integer_zero_node);
  ...
  if (simple_operand_p (ll_arg)
      && simple_operand_p (lr_arg) && !FLOAT_TYPE_P (TREE_TYPE (ll_arg)))
    {
      int compcode;
	  ...
	  && operand_equal_p (lr_arg, rr_arg, 0))
	{
	  ...
	  compcode = (code == TRUTH_AND_EXPR)
	    ? lcompcode & rcompcode : lcompcode | rcompcode;
	}
  ...
  if (BRANCH_COST >= 2
      ...
      && simple_operand_p (rl_arg) && simple_operand_p (rr_arg))
    {
	...
	return build (NE_EXPR, truth_type,
		      build (BIT_IOR_EXPR, TREE_TYPE (ll_arg),
			     ll_arg, rl_arg), integer_zero_node);
  ...
  if (!integer_zerop (result)
      && simple_cst_equal (const_binop (BIT_AND_EXPR, result, l_const, 0),
			   const_binop (BIT_AND_EXPR, result, r_const,
					0)) != 1)
    {
...
optimize_minmax_comparison (tree t)
{
  ...
  switch (TREE_CODE (t))
    ...
    case LE_EXPR:
      return
	invert_truthvalue (optimize_minmax_comparison
			   (invert_truthvalue (t)));
...
extract_muldiv_1 (tree t, tree c, enum tree_code code, tree wide_type)
{
  ...
  switch (tcode)
    ...
    case WITH_RECORD_EXPR:
      if ((t1 =
	   extract_muldiv (TREE_OPERAND (t, 0), c, code, wide_type)) != 0)
    ...
    case RSHIFT_EXPR:
	  ...
	  && TYPE_PRECISION (TREE_TYPE (size_one_node)) >
	  TREE_INT_CST_LOW (op1) && TREE_INT_CST_HIGH (op1) == 0
	  && 0 != (t1 =
		   fold_convert (ctype,
				 const_binop (LSHIFT_EXPR, size_one_node, op1,
					      0))) && !TREE_OVERFLOW (t1))
	return
	  extract_muldiv (build
			  (tcode == LSHIFT_EXPR ? MULT_EXPR : FLOOR_DIV_EXPR,
			   ctype, fold_convert (ctype, op0), t1), c, code,
			  wide_type);
      break;
	  ...
	  || integer_zerop (const_binop (TRUNC_MOD_EXPR, op1, c, 0)))
	{
	  ...
	  if (op1 == 0 || (TREE_OVERFLOW (op1) && !flag_wrapv))
	    break;
	}
      else
	break;
    ...
    case EXACT_DIV_EXPR:
      ...
      if (same_p && (t1 = extract_muldiv (op0, c, code, wide_type)) != 0)
	return fold (build (tcode, ctype, fold_convert (ctype, t1),
		     ...
		     tree type, tree arg0, tree arg1)
{
  ...
  if (fcode == BUILT_IN_SQRT
      || fcode == BUILT_IN_SQRTF || fcode == BUILT_IN_SQRTL)
    {
...
fold_inf_compare (enum tree_code code, tree type, tree arg0, tree arg1)
{
  ...
  switch (code)
	...
	return NULL_TREE;
      return omit_one_operand (type,
			       fold_convert (type, integer_zero_node), arg0);

    case LE_EXPR:
      /* x <= +Inf is always true, if we don't case about NaNs.  */
      if (!HONOR_NANS (mode))
	return omit_one_operand (type,
				 fold_convert (type, integer_one_node), arg0);
		      ...
		      tree result_type)
{
  ...
  if ((code == NE_EXPR || code == EQ_EXPR)
	  ...
	  == GET_MODE_BITSIZE (TYPE_MODE (TREE_TYPE (arg00))))
	{
	  ...
	  return
	    fold (build
		  (code == EQ_EXPR ? GE_EXPR : LT_EXPR, result_type,
		   fold_convert (stype, arg00), fold_convert (stype,
							      integer_zero_node)));
	}
...
reorder_operands_p (tree arg0, tree arg1)
{
  ...
  if (TREE_CONSTANT (arg0) || TREE_CONSTANT (arg1))
    return true;
  return !TREE_SIDE_EFFECTS (arg0) && !TREE_SIDE_EFFECTS (arg1);
}
...
fold (tree expr)
{
  ...
  if ((code == PLUS_EXPR || code == MULT_EXPR || code == MIN_EXPR
       ...
       || code == BIT_AND_EXPR) && tree_swap_operands_p (arg0, arg1, true))
  ...
  if (TREE_CODE_CLASS (code) == '1')
	...
	return build (COMPOUND_EXPR, type, TREE_OPERAND (arg1, 0),
		...
		|| (TREE_CODE_CLASS (TREE_CODE (arg1)) == '<'
		   ...
		   || ((*lang_hooks.decls.global_bindings_p) () == 0
		       && !CONTAINS_PLACEHOLDER_P (arg0))))
	return fold_binary_op_with_conditional_arg (code, type, arg1, arg0,
						    /*cond_first_p= */ 0);
      else if (TREE_CODE (arg0) == COMPOUND_EXPR)
	return build (COMPOUND_EXPR, type, TREE_OPERAND (arg0, 0),
		      fold (build
			    (code, type, TREE_OPERAND (arg0, 1), arg1)));
      else
	...
	return fold_binary_op_with_conditional_arg (code, type, arg0, arg1,
						    /*cond_first_p= */ 1);
    }
  ...
  switch (code)
	  ...
	  || TREE_CODE (TREE_OPERAND (t, 0)) == CONVERT_EXPR)
	{
	  ...
	  if (TYPE_MAIN_VARIANT (inside_type) ==
	      TYPE_MAIN_VARIANT (final_type) && ((inter_int && final_int)
						 || (inter_float
						     && final_float))
	  ...
	  && !(TREE_CODE (TREE_OPERAND (TREE_OPERAND (t, 0), 0)) ==
	       ...
	       DECL_BIT_FIELD (TREE_OPERAND
			       (TREE_OPERAND (TREE_OPERAND (t, 0), 0), 1))))
	{
	  ...
	  && TREE_CODE (TREE_OPERAND (TREE_OPERAND (t, 0), 1)) == INTEGER_CST)
	{
	  ...
	  if (TREE_UNSIGNED (TREE_TYPE (and))
	    ...
	    change = 1;
		   ...
		   <= HOST_BITS_PER_WIDE_INT && host_integerp (and1, 1))
	    {
		...
		{
		  tree uns =
		    (*lang_hooks.types.unsigned_type) (TREE_TYPE (and0));
      ...
      if (wins)
	{
	  if (TREE_CODE (arg0) == INTEGER_CST)
	      ...
	      else
		{
		  ...
		  TREE_TYPE (t) = type;
		  TREE_OVERFLOW (t)
		    = (TREE_OVERFLOW (arg0) | force_fit_type (t, overflow));
		  TREE_CONSTANT_OVERFLOW (t)
	...
	return fold (build1 (ABS_EXPR, type, TREE_OPERAND (arg0, 0)));
      ...
      else if (TREE_CODE (arg0) == NOP_EXPR && TREE_CODE (type) == REAL_TYPE)
	{
	...
	return
	  fold (build
		(TREE_CODE (arg0), type,
		 fold (build1 (CONJ_EXPR, type, TREE_OPERAND (arg0, 0))),
      ...
      else
	{
	  ...
	  if (operand_equal_p (arg0, arg1, 0) && SCALAR_FLOAT_TYPE_P (type))
    ...
    associate:
      ...
      if (!wins && (!FLOAT_TYPE_P (type) || flag_unsafe_math_optimizations))
	{
	  ...
	  if (2 < ((var0 != 0) + (var1 != 0)
		...
		code = PLUS_EXPR;
	      ...
	      minus_lit0 =
		associate_trees (minus_lit0, minus_lit1, code, type);
	...
	return fold (build (PLUS_EXPR, type, arg0, TREE_OPERAND (arg1, 0)));
	  ...
	  && negate_expr_p (arg1) && reorder_operands_p (arg0, arg1))
      ...
      if (!FLOAT_TYPE_P (type))
	{
	  ...
	  /* Fold A - (A & B) into ~B & A.  */
	  if (!TREE_SIDE_EFFECTS (arg0) && TREE_CODE (arg1) == BIT_AND_EXPR)
	    {
	...
	return fold (build (MULT_EXPR, type,
			    TREE_OPERAND (arg0, 0), negate_expr (arg1)));
      if (TREE_CODE (arg1) == NEGATE_EXPR && negate_expr_p (arg0))
	return fold (build (MULT_EXPR, type,
			    negate_expr (arg0), TREE_OPERAND (arg1, 0)));
      ...
      else
	{
	  ...
	  if (!HONOR_SNANS (TYPE_MODE (TREE_TYPE (arg0))) && real_onep (arg1))
	    return non_lvalue (fold_convert (type, arg0));
	  ...
	  if (flag_unsafe_math_optimizations)
				      ...
				      TREE_VALUE (TREE_OPERAND (arg1, 1)), 0))
		{
		  ...
		  || fcode1 == BUILT_IN_POWF || fcode1 == BUILT_IN_POWL)
		{
		  tree arg10 = TREE_VALUE (TREE_OPERAND (arg1, 1));
		  tree arg11 = TREE_VALUE (TREE_CHAIN (TREE_OPERAND (arg1,
								     1)));
		  ...
		  || fcode0 == BUILT_IN_POWF || fcode0 == BUILT_IN_POWL)
		{
		  tree arg00 = TREE_VALUE (TREE_OPERAND (arg0, 1));
		  tree arg01 = TREE_VALUE (TREE_CHAIN (TREE_OPERAND (arg0,
								     1)));
	      ...
	      if (!optimize_size && operand_equal_p (arg0, arg1, 0))
		{
		  tree powfn;
      ...
      if (TREE_CODE (arg1) == REAL_CST)
	{
      ...
      if (flag_unsafe_math_optimizations && TREE_CODE (arg0) == RDIV_EXPR)
	return fold (build (RDIV_EXPR, type, TREE_OPERAND (arg0, 0),
			    fold (build (MULT_EXPR, type,
					 TREE_OPERAND (arg0, 1), arg1))));

      /* Convert A/(B/C) to (A/B)*C.  */
      if (flag_unsafe_math_optimizations && TREE_CODE (arg1) == RDIV_EXPR)
	return fold (build (MULT_EXPR, type,
      ...
      if (flag_unsafe_math_optimizations)
	{
	  ...
	  if (fcode == BUILT_IN_EXP
	      ...
	      || fcode == BUILT_IN_POW10F || fcode == BUILT_IN_POW10L)
	    {
	  ...
	  if (fcode == BUILT_IN_POW
	      || fcode == BUILT_IN_POWF || fcode == BUILT_IN_POWL)
	    {
	      tree powfn = TREE_OPERAND (TREE_OPERAND (arg1, 0), 0);
	      tree arg10 = TREE_VALUE (TREE_OPERAND (arg1, 1));
	  ...
	  && !TREE_SIDE_EFFECTS (TREE_OPERAND (arg0, 1)))
	{
	  ...
	  /* This case if tricky because we must either have commutative
	    ...
	    return fold (build (TREE_CODE (arg0), type,
				fold (build (code, type, a00, a10)), a01));
	}
      ...
      if (FLOAT_TYPE_P (TREE_TYPE (arg0)))
	{
	  ...
	  if (TREE_CODE (arg1) == REAL_CST)
		  ...
		  && !HONOR_SNANS (TYPE_MODE (TREE_TYPE (arg1))))
		{
		  ...
		  return omit_one_operand (type, fold_convert (type, t),
					   arg0);
		}
	  ...
	  if (TREE_CODE (arg1) == REAL_CST
	      && flag_unsafe_math_optimizations && !flag_errno_math)
	    {
		  ...
		  && (code == EQ_EXPR || code == NE_EXPR))))
	{
      ...
      if (TREE_CODE (arg1) == INTEGER_CST
	  && TREE_CODE (arg0) != INTEGER_CST && tree_int_cst_sgn (arg1) > 0)
	{
	  switch (code)
	    {
	    case GE_EXPR:
	...
	return optimize_minmax_comparison (t);
      ...
      /* If we are comparing an ABS_EXPR with a constant, we can
         ...
         and a comparison, and is probably faster.  */
	       ...
	       && !TREE_CONSTANT_OVERFLOW (tem))
	return fold (build (TRUTH_ANDIF_EXPR, type,
			    build (GE_EXPR, type, TREE_OPERAND (arg0, 0),
				   tem), build (LE_EXPR, type,
						TREE_OPERAND (arg0, 0),
						arg1)));
	      ...
	      fold (build (code, type,
			   build (BIT_AND_EXPR, TREE_TYPE (arg0),
				  build (RSHIFT_EXPR,
					 ...
					 TREE_OPERAND (arg0, 1),
					 TREE_OPERAND (TREE_OPERAND (arg0, 0),
						       1)),
				  fold_convert (TREE_TYPE (arg0),
						integer_one_node)), arg1));
	...
	return tem;
	  ...
	  && TREE_CODE (TREE_OPERAND (arg0, 1)) == INTEGER_CST)
	{
	  tree dandnotc = fold (build (BIT_AND_EXPR, TREE_TYPE (arg0),
	  ...
	  && TREE_CODE (TREE_OPERAND (arg0, 1)) == INTEGER_CST)
	{
	  tree candnotd = fold (build (BIT_AND_EXPR, TREE_TYPE (arg0),
				       TREE_OPERAND (arg0, 1),
				       build1 (BIT_NOT_EXPR, TREE_TYPE (arg1),
					       arg1)));
	  tree rslt = code == EQ_EXPR ? integer_zero_node : integer_one_node;
      ...
      if (TREE_CODE (arg1) == INTEGER_CST && TREE_CODE (arg0) != INTEGER_CST)
	{
	  ...
	  if (twoval_comparison_p (arg0, &cval1, &cval2, &save_p)
				   ...
				   TYPE_MAX_VALUE (TREE_TYPE (cval2)), 0))
	    {
	      ...
	      tree high_result = fold (build (code, type,
					      eval_subst (arg0, cval1, maxval,
							  cval2, minval),
					      arg1));
	      tree equal_result = fold (build (code, type,
					       eval_subst (arg0, cval1,
							   maxval, cval2,
							   maxval),
					       arg1));
	      tree low_result = fold (build (code, type,
	      ...
	      || TREE_CODE (arg1) == COMPLEX_CST))
	{
      ...
      if ((code == EQ_EXPR || code == NE_EXPR)
	  && integer_zerop (arg1) && TREE_CODE (arg0) == CALL_EXPR)
	{
      ...
      if (TREE_CODE (arg0) == INTEGER_CST && TREE_CODE (arg1) == INTEGER_CST)
	{
      ...
      /* Assume a nonexplicit constant cannot equal an explicit one,
         ...
         a label can come out as 0.  */
	       ...
	       && !integer_zerop (arg1)
	       && TREE_CONSTANT (arg0)
	       && TREE_CODE (arg0) == ADDR_EXPR && code == EQ_EXPR)
	t1 = build_int_2 (0, 0);
#endif
      ...
      if (TREE_CODE (arg0) == INTEGER_CST)
	{
	  ...
	  if (!VOID_TYPE_P (TREE_TYPE (tem)) || VOID_TYPE_P (TREE_TYPE (t)))
	  ...
	  && !HONOR_SIGNED_ZEROS (TYPE_MODE (TREE_TYPE (arg1))))
	{
	  ...
	  if (integer_zerop (TREE_OPERAND (arg0, 1)) && integer_zerop (arg2))
		...
		return
		  pedantic_non_lvalue (fold_convert
	...
	return
	  fold (build
		(TREE_CODE (arg0), type,
		 ...
		 fold (build1
		       (REALPART_EXPR, type, TREE_OPERAND (arg0, 1)))));
      return t;
	...
	return
	  fold (build
		(TREE_CODE (arg0), type,
		 ...
		 fold (build1
		       (IMAGPART_EXPR, type, TREE_OPERAND (arg0, 1)))));
      return t;
