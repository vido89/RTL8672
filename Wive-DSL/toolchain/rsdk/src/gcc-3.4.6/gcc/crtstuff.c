...
extern void
__register_frame_info (const void *, struct object *)
...
static void __attribute__ ((used)) __do_global_ctors_aux (void)	/* prologue goes in .init section */
{
...
FORCE_CODE_SECTION_ALIGN asm (TEXT_SECTION_ASM_OP);
