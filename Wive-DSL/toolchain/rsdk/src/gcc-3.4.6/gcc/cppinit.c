...
/* A set of booleans indicating what CPP features each source language
   requires.  */
     ...
     static const struct lang_flags lang_defaults[] = {	/*              c99 c++ xnum std  //   digr  */
       /* GNUC89 */ {0, 0, 1, 0, 1, 1},
       /* GNUC99 */ {1, 0, 1, 0, 1, 1},
       /* STDC89 */ {0, 0, 0, 1, 0, 0},
       /* STDC94 */ {0, 0, 0, 1, 0, 1},
...
cpp_create_reader (enum c_lang lang, hash_table * table)
{
  ...
  _obstack_begin (&pfile->buffer_ob, 0, 0,
		  (void *(*)(long)) xmalloc, (void (*)(void *)) free);
...
mark_named_operators (cpp_reader * pfile)
{
  ...
  for (b = operator_array;
       b < (operator_array + ARRAY_SIZE (operator_array)); b++)
    {
...
static void
sanity_checks (cpp_reader * pfile)
{
  cppchar_t test = 0;
  ...
  if (CPP_OPTION (pfile, wchar_precision) <
