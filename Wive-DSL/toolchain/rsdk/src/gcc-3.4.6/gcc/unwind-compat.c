...
extern void __libunwind_Unwind_DeleteException (struct _Unwind_Exception *);
...
extern _Unwind_Word __libunwind_Unwind_GetCFA (struct _Unwind_Context *);
...
#ifdef __ia64__
extern _Unwind_Word __libunwind_Unwind_GetBSP (struct _Unwind_Context *);
...
extern _Unwind_Word __libunwind_Unwind_GetGR (struct _Unwind_Context *, int);
...
extern void __libunwind_Unwind_SetIP (struct _Unwind_Context *, _Unwind_Ptr);
