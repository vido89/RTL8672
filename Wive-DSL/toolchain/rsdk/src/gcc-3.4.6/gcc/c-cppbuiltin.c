...
/* Define NAME with value TYPE precision.  */
     static void builtin_define_type_precision (const char *name, tree type)
{
...
builtin_define_float_constants (const char *name_prefix,
				const char *fp_suffix, tree type)
{
...
/* Pass an object-like macro and a value to define it to.  The third
   ...
   constant.  */
void
builtin_define_with_value (const char *macro, const char *expansion,
			   int is_str)
{
  char *buf;
...
static void
builtin_define_with_value_n (const char *macro, const char *expansion,
			     size_t elen)
{
  char *buf;
  size_t mlen = strlen (macro);
...
{
  static const char *const values[] = { "127", "255",
    "32767", "65535",
