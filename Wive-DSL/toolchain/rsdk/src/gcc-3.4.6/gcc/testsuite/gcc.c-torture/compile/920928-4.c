...
static unsigned long int IDL_offset_vec[] = {
  ...
  (unsigned long int) ((unsigned char *) &((sec_rgy_unix_group_t *) 0)->gid -
		       (unsigned char *) 0),
  (unsigned long int) ((unsigned char *) &((sec_rgy_unix_group_t *) 0)->
		       members - (unsigned char *) 0),
  sizeof (rs_cache_data_t),
  (unsigned long int) ((unsigned char *) &((rs_cache_data_t *) 0)->site_id.
		       time_low - (unsigned char *) 0),
  (unsigned long int) ((unsigned char *) &((rs_cache_data_t *) 0)->site_id.
		       time_mid - (unsigned char *) 0),
  (unsigned long int) ((unsigned char *) &((rs_cache_data_t *) 0)->site_id.
		       time_hi_and_version - (unsigned char *) 0),
  sizeof (sec_rgy_unix_passwd_t),
  (unsigned long int) ((unsigned char *) &((sec_rgy_cursor_t *) 0)->source.
		       clock_seq_hi_and_reserved - (unsigned char *) 0),
  (unsigned long int) ((unsigned char *) &((sec_rgy_cursor_t *) 0)->source.
		       clock_seq_low - (unsigned char *) 0),
  (unsigned long int) ((unsigned char *) &((sec_rgy_cursor_t *) 0)->source.
		       node - (unsigned char *) 0),
  (unsigned long int) ((unsigned char *) &((sec_rgy_cursor_t *) 0)->handle -
		       (unsigned char *) 0),
  (unsigned long int) ((unsigned char *) &((sec_rgy_cursor_t *) 0)->valid -
		       (unsigned char *) 0),
  sizeof (struct {long int name_len;
		  sec_rgy_name_t name;
