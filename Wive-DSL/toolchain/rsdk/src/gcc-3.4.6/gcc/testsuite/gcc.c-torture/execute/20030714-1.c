...
void
RenderBox_setStyle (RenderBox * thisin, RenderStyle * _style)
{
...
void
RenderObject_setStyle (RenderBox * this, RenderStyle * _style)
{
  (void) this;
  (void) _style;
}
...
void
removeFromSpecialObjects (RenderBox * this)
{
  (void) this;
}

bool
RenderBox_isTableCell (RenderBox * this)
{
  (void) this;
  return false;
}
