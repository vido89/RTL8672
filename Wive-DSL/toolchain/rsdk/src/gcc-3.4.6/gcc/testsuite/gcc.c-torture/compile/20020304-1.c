  ...
  if (BGl_equalzf3zf3zz__r4_equivalence_6_2z00
	   ...
	   ((obj_t) (obj_t) ((long) (((long) (1) << 2) | 2)))))
	{
	  ...
	  }
	  {
	    ...
	    BgL_arg1586z00_1000 = make_pair (BgL_wherez00_41, BgL_bodyz00_40);
	    {
	      ...
	      ((&(((obj_t) (BgL_v1042z00_998))->vector_t.obj0))
	       [BgL_auxz00_4070] =
	       BgL_arg1586z00_1000,
      ...
      else
	{
	  ...
	  }
	  {
	    ...
	    ((&(((obj_t) (BgL_v1043z00_1005))->vector_t.obj0))
	     [BgL_auxz00_4088] =
	     BgL_bodyz00_40,
	     ((obj_t) (obj_t) ((long) (((long) (3) << 2) | 2))));
	  }
      ...
      if (((((long) BgL_formalsz00_39) & ((1 << 2) - 1)) == 3))
	{
	  if (BGl_equalzf3zf3zz__r4_equivalence_6_2z00
		...
		{
		  if (BGl_equalzf3zf3zz__r4_equivalence_6_2z00
		      (((((obj_t) ((long) BgL_cdrzd21979zd2_953 - 3))->
			 pair_t).cdr),
		       ((obj_t) (obj_t) ((long) (((long) (0) << 2) | 2)))))
		    {
		      goto BgL_tagzd21966zd2_943;
			...
			((((obj_t) ((long) BgL_cdrzd21979zd2_953 - 3))->
			  pair_t).cdr);
		      if (((((long) BgL_cdrzd21986zd2_956) & ((1 << 2) - 1))
			   == 3))
			{
			  if (BGl_equalzf3zf3zz__r4_equivalence_6_2z00
			      (((((obj_t)
				  ((long) BgL_cdrzd21986zd2_956 -
				   3))->pair_t).cdr),
			       ((obj_t) (obj_t)
				((long) (((long) (0) << 2) | 2)))))
			    {
				...
				BgL_auxz00_4120 =
				  ((((obj_t)
				     ((long) BgL_cdrzd21979zd2_953 -
				      3))->pair_t).cdr);
				BgL_cdrzd21994zd2_959 =
				  ((((obj_t) ((long) BgL_auxz00_4120 - 3))->
				    pair_t).cdr);
			      }
			      if (((((long) BgL_cdrzd21994zd2_959) &
				    ((1 << 2) - 1)) == 3))
				{
				  if (BGl_equalzf3zf3zz__r4_equivalence_6_2z00
				      (((((obj_t)
					  ((long) BgL_cdrzd21994zd2_959 -
					   3))->pair_t).cdr),
				       ((obj_t) (obj_t)
					((long) (((long) (0) << 2) | 2)))))
				    {
			  ...
			  if (BgL_testz00_4238)
			      ...
			      else
				{
				  if ((BgL_namedzf3zf3_42 !=
					...
					BgL_v1048z00_1018 =
					  create_vector (BgL_auxz00_4248);
				      }
				      {
					obj_t BgL_arg1602z00_1020;
					BgL_arg1602z00_1020 =
					  make_pair (BgL_wherez00_41,
						     BgL_bodyz00_40);
					{
					  int BgL_auxz00_4252;
					  BgL_auxz00_4252 =
			    ...
			    ((long) (((long) (1) << 2) | 2)))))
			{
			  ...
			  }
			  {
			      ...
			      make_pair (BgL_wherez00_41, BgL_bodyz00_40);
			    {
			      ...
			      ((&
				(((obj_t) (BgL_v1046z00_1014))->vector_t.
				 obj0))[BgL_auxz00_4287] =
			       BgL_arg1600z00_1016,
			       ((obj_t) (obj_t)
				((long) (((long) (3) << 2) | 2))));
			    }
      ...
      else
	{
	  if ((BgL_namedzf3zf3_42 !=
		...
		((&(((obj_t) (BgL_v1045z00_1013))->vector_t.obj0))
		 [BgL_auxz00_4332] =
		 BgL_bodyz00_40,
		 ((obj_t) (obj_t) ((long) (((long) (3) << 2) | 2))));
	      }
