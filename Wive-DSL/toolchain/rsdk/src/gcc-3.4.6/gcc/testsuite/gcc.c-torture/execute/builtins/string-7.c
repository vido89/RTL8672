...
int
  __attribute__ ((noinline)) test (long *buf3, char *buf4, char *buf6, int n)
{
  int i = 0;
  ...
  if (__builtin_mempcpy (buf2 + i++ + 8, buf7 + 1, 1)
      != buf2 + 11 || memcmp (buf2, "aBcdRSTUVWSlmnopq\0", 19) || i != 3)
    abort ();
  ...
  if (__builtin_mempcpy (buf2 + i++ + 8, buf7 + 1, n + 1)
      != buf2 + 12 || memcmp (buf2, "aBcdRSTUVWkSmnopq\0", 19) || i != 4)
    abort ();
