...
main (void)
{
  ...
  A = one ("text" "text");	/* { dg-warning "discards qualifiers" "case one" } */
  A = two ("text" "text");	/* { dg-warning "discards qualifiers" "case two" } */
  A = four ("text" "text");	/* { dg-warning "discards qualifiers" "case four" } */
