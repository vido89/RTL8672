...
void __attribute__ ((no_instrument_function)) sig_ill_handler (int sig)
{
  exit (0);
}
...
void __attribute__ ((no_instrument_function)) my_mcount ()
{
...
/* Paramter passing.
   ...
   i : gpr 7
*/
void __attribute__ ((noinline)) fcvi (char *s, vector int v, int i)
{
...
void __attribute__ ((noinline)) fcvv (char *s, vector int v, vector int w)
{
...
void __attribute__ ((noinline)) fcevv (char *s, ...)
{
  vector int a, c = { 6, 8, 10, 12 };
  vector int v, w;
  stack_frame_t *sp;
...
/* Paramter passing.
   ...
   w : slot 6-7
*/
void __attribute__ ((noinline)) fciievv (char *s, int i, int j, ...)
{
  vector int a, c = { 6, 8, 10, 12 };
  vector int v, w;
  stack_frame_t *sp;
...
void __attribute__ ((noinline)) fcvevv (char *s, vector int x, ...)
{
...
int __attribute__ ((no_instrument_function, noinline)) main1 ()
{
  char *s = "vv";
...
*/
void
fnp_cvvvv (char *s, vector int v, vector int w, vector int x, vector int y)
{
