...
main1 (void)
{
  ...
  foo ((vector unsigned int)
       {
       10, 11, 12, 13}, (vector unsigned int)
       {
       20, 21, 22, 23}, (vector unsigned int)
       {
       30, 31, 32, 33}, (vector unsigned int)
       {
       40, 41, 42, 43});
  /* In this call, in the Darwin ABI, the first argument goes into v2
  ...
  bar ((vector unsigned int)
       {
       10, 11, 12, 13}, 2, (vector unsigned int)
       {
       20, 21, 22, 23}, (vector unsigned int)
       {
       30, 31, 32, 33});
