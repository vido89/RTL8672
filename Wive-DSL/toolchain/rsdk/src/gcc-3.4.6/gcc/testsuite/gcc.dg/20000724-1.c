...
int
bar (int (*fn) (void *), void *arg, unsigned long flags)
{
  return 0;
}
...
asm ("\n"
     ...
     NT "pushl $0; pushl $0; pushl $0; pushl $0; pushl $0" NT
     "pushl $0; pushl $0; pushl $0; pushl $0; pushl $0" NT "movl %ecx, %eax"
     NT "call do_check" NT
     "popl %eax; popl %eax; popl %eax; popl %eax; popl %eax" NT
     "popl %eax; popl %eax; popl %eax; popl %eax; popl %eax" NT
