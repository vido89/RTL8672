	  ...
	  void checkSis (Sis x, int i)
	{
	    ...
	    void checkScsi (Scsi x, int i)
	  {
		...
		T (0, Sc)
		  ...
		  T (9, Sc)
		  T (10, Sc)
		  T (11, Sc) T (12, Sc) T (13, Sc) T (14, Sc) T (15, Sc)
#ifndef SKIP_ZERO_ARRAY
		  T (0, Ss)
#endif
		  T (1, Ss)
		  ...
		  T (9, Ss)
		  T (10, Ss)
		  T (11, Ss) T (12, Ss) T (13, Ss) T (14, Ss) T (15, Ss)
#ifndef SKIP_ZERO_ARRAY
		  T (0, Si)
#endif
		  T (1, Si)
		  ...
		  T (9, Si)
		  T (10, Si)
		  T (11, Si) T (12, Si) T (13, Si) T (14, Si) T (15, Si)
#undef T
...
#define T(N, TYPE) testit##TYPE##N ();
		  ...
		  T (11, Si)
		  T (12, Si)
		  T (13, Si) T (14, Si) T (15, Si) DEBUG_FINI if (fails != 0)
		  abort ();
