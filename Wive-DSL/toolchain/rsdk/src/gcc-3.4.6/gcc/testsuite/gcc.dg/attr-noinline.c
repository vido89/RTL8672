...
static void
function_declaration_both_before (void)
{
}
...
static void
function_declaration_both_after (void)
{
}
...
static inline void
function_declaration_noinline_before (void)
{
}				/* { dg-warning "follows declaration with attribute noinline" "" } */

static inline void
function_declaration_noinline_after (void)
{
}				/* { dg-warning "previous definition" "" } */
...
static void
  __attribute__ ((__noinline__)) function_declaration_inline_before (void)
{
...
static void
function_declaration_inline_noinline_before (void)
{
}
...
static void
function_declaration_inline_noinline_after (void)
{
}				/* { dg-warning "previous definition" "" } */
...
static void
function_declaration_noinline_inline_before (void)
{
}
