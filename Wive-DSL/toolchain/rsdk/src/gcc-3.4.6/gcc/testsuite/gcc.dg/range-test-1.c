...
T (1, unsigned int, x == 0 || x == 1,
   ...
   {
   -1U C 2 C 12 C 35 C 0x7fffffff C 0x80000000})
...
T (7, char *, x == (char *) -3UL || x == (char *) -4UL || x == (char *) -5UL,
   ...
   1UL C (char *)0 C (char *)1UL C (char *)35UL C (char *)0x7fffffffUL C (char
									  *)0x80000000UL})
...
T (10, signed char, x == 0 || x == -1 || x == -2 || x == -3,
   ...
   {
   -4 C - 5 C 1 C 2 C 3 C 35 C - 24}) T (11, int, x == 0 || x == 1,
					 {
					 0 C 1},

					 {
					 -1 C 2 C 12 C 35 C INT_MAX C
					 INT_MIN}) T (12, int, x == 0
						      || x == -1 || x == -2,
						      {
						      0 C - 1 C - 2},
...
T (17, unsigned int, (x >= -8U && x <= -3U) || x == -2U || x == -1U || x == 0
   || x == 1 || x == 2,
   {
...
T (18, int, (x >= -8 && x <= -3) || x == -2 || x == -1 || x == 0 || x == 1
   || x == 2,
   {
...
T (19, unsigned long, (x >= 0 && x <= 16) || (x >= 18 && x <= -1UL),
   ...
   C 0x80000000},
   {
   17}) T (20, char *, x == (char *) -1UL || x == 0,
	   {
	   (char *) -1UL C 0},

	   {
	   (char *) -6UL C (char *) - 20UL C (char *) - 2UL
	   C (char *)1UL C (char *)35UL C (char *)0x7fffffffUL C (char
								  *)0x80000000UL})
...
T (23, int, x == INT_MIN + 1 || x == INT_MIN + 2 || x == INT_MIN
   || x == INT_MAX,
...
T (24, signed char, x == SCHAR_MIN || x == SCHAR_MAX,
   ...
   { -1 C 0 C 1 C SCHAR_MAX - 1 C SCHAR_MAX - 2 C SCHAR_MIN + 1 C SCHAR_MIN +
   2 }) T (25, enum integers, x == int_smallest || x == int_largest,
	   { int_smallest C int_largest },

	   { int_minus1 C int_zero C int_one
	   C int_2ndsmallest C int_2ndlargest C int_3rdsmallest C
	   int_3rdlargest
	   })
...
/* This should be optimized into unconditional jump.  */
  T (o1, unsigned long, (x >= 0 && x <= 16) || (x >= 17 && x <= -1UL),
     { -3UL C - 6UL C -
     1UL C 0 C 1 C 2 C 12 C 15 C 16 C 17 C 18 C 19 C 35 C 0x7fffffff C
     0x80000000
     },
     { })
...
/* This should be eventually optimized into a single comparison.  */
  T (td1, unsigned char, x == 0 || x == 4 || x == 1 || x == 5 || x == 2
   || x == 6 || x == 3,
