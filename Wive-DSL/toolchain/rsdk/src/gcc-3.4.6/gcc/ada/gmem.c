...
int
__gnat_gmem_initialize (char *dumpname)
{
  char header[10];
...
void
__gnat_gmem_a2l_initialize (char *exename)
{
...
void
__gnat_gmem_read_next_frame (void **addr)
{
...
void
__gnat_gmem_symbolic (void *addr, char *buf, int *length)
{
