...
# CONFIG_RTL8670 is not set
CONFIG_RTL8671=y
# CONFIG_PCI is not set
# CONFIG_UCLINUX is not set
CONFIG_NEW_IRQ=y
CONFIG_NEW_TIME_C=y
CONFIG_LEXRA=y
CONFIG_NONCOHERENT_IO=y
# CONFIG_EOC is not set
CONFIG_DSL_CODESWAP=y
CONFIG_RTL8672=y
...
# CONFIG_8M_SDRAM is not set
# CONFIG_16M_SDRAM is not set
# CONFIG_4M_FLASH is not set
# CONFIG_64KB_CONF_PART is not set
CONFIG_GPIO_LED_TR068=y
# CONFIG_BOARD_001 is not set
CONFIG_BOARD_003=y

#
# Config MIPS16-Inst Option for Kernel Modules
#
# CONFIG_RTL867X_KERNEL_MIPS16 is not set
...
# CONFIG_CPU_RLX4181 is not set
CONFIG_CPU_RLX5181=y
# CONFIG_CPU_LX5280 is not set
...
CONFIG_IP_IGMPV3=y
CONFIG_IP_ROUTING_CACHE_DROP=y
...
# CONFIG_TCP_WESTWOOD is not set

#
#   IP: Netfilter Configuration
#
CONFIG_IP_NF_CONNTRACK=y
# CONFIG_NF_DROPOLDEST is not set
CONFIG_IP_NF_FTP=y
...
CONFIG_IP_NF_ALG_ONOFF=y
# CONFIG_IP_NF_QUEUE is not set
CONFIG_IP_NF_IPTABLES=y
CONFIG_IP_NF_MATCH_LIMIT=y
# CONFIG_IP_NF_MATCH_IPLIMIT is not set
# CONFIG_IP_NF_MATCH_UDPLIMIT is not set
...
CONFIG_RTL867X_IPTABLES_FAST_PATH=y
# CONFIG_DOS is not set
# CONFIG_CTC_E8_CLIENT_LIMIT is not set
...
# CONFIG_RE8601 is not set
CONFIG_RE8670=y
CONFIG_EXT_SWITCH=y
CONFIG_RE8305=y
# CONFIG_RE8306 is not set
# CONFIG_PORT_MIRROR is not set
# CONFIG_RE8650 is not set
...
# CONFIG_RTL867X_NETLOG is not set
...
# RTK VoIP Suite
#
# CONFIG_RTK_VOIP is not set
# CONFIG_RTK_VOIP_TX_ENHANCE is not set
# CONFIG_RTK_VOIP_RX_INPUT_QUEUE is not set
