...
#define tftp_full_usage \
	...
	"Get file to update firmware image or configuration data;\n" \
	"Put file to backup configuration data.\n\n" \
	"Options:\n" \
        USAGE_TFTP_GET(	\
        "\t-g\tGet file.\n" \
        ) \
	...
	"\t-i\tTransfer for firmware image.\n" \
	"\t-c\tTransfer for configuration data.\n" \
	"\t-f FILE\tTransfer remote FILE.\n"
#endif
...
#define traceroute_trivial_usage \
	"[-dnrv] [-i interface] [-m max_ttl] [-p port#] [-q nqueries]\n\
...
#define traceroute_full_usage \
	...
	"\t-v\tVerbose output\n" \
	"\t-i interface\tSpecifies  the  interface  through  which  traceroute should\n" \
	"\t\tsend packets. By default, the interface is selected according to the\n" \
	"\t\trouting table.\n" \
