...
//	gchar *reg_route;
	...
	gboolean registered;
	gboolean publish;
	int index; // index of proxies "in flash"
	ProxyRegStatus reg_status;
#ifdef BYPASS_RELAY
	int timeout_count;	// count that trying register but timeout  
#endif
} LinphoneProxyConfig;
...
//	LinphoneOnlineStatus presence_mode;
	...
	char dial_data[LINE_MAX_LEN];
#endif
	// off-hook alarm and auto-dial 
	struct timeval off_hook_start;
	struct timeval auto_dial_start;
...
#ifdef CONFIG_RTK_VOIP_IVR
	SYS_STATE_AUTH,
	SYS_STATE_AUTH_ERROR,
#endif
#ifdef BYPASS_RELAY
	SYS_STATE_AUTOBYPASS_WARNING,
#endif
	SYS_STATE_EDIT,
	SYS_STATE_EDIT_ERROR,
	SYS_STATE_RING,
	SYS_STATE_CONNECT,
	SYS_STATE_CONNECT_DAA_RING,
	SYS_STATE_CONNECT_EDIT,
	SYS_STATE_CONNECT_EDIT_ERROR,
	SYS_STATE_DAA_RING,
	SYS_STATE_DAA_CONNECT,
	SYS_STATE_TRANSFER_EDIT,
	SYS_STATE_TRANSFER_EDIT_ERROR,
	SYS_STATE_IN2CALLS_OUT,
	SYS_STATE_IN2CALLS_IN,
	SYS_STATE_IN3WAY,
...
typedef struct codec_mine_desc_s {
	const char *pszMineType;
	RtpPayloadType payloadType;
	unsigned int idxCodec;
} codec_mine_desc_t;
