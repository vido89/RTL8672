...
int voicerecord_main(int argc, char *argv[])
{
	...
	else
	{
		...
		printf("mode: DUMP_MODE_3 | [RECORD_PCM_HANDLER | RECORD_PCM_INTERFACE | RECORD_PCM_LEC]\n");
		printf("RECORD_PCM_HANDLER: 1, RECORD_PCM_INTERFACE: 4, RECORD_PCM_LEC: 8,\n");
		printf("DUMP_MODE_3: 16 \n");
	}
