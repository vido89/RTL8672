...
{
	{0, 0, 1, 2000, 0, 0, 0, 0, 0, 0, 0, 0, 2, 350, 440, 0, 0, 13, 13, 0, 0, 0},		// USA dial tone
	{0, 0, 1, 2000, 0, 0, 0, 4000, 0, 0, 0, 0, 2, 440, 480, 0, 0, 13, 13, 0, 0, 0},		// USA ring back tone
	{2, 0, 3, 500, 500, 500, 0, 0, 0, 1000, 0, 0, 3, 950, 1400, 1750, 0, 7, 7, 7, 0, 0},// USA sit-no circuit tone
	{2, 2, 3, 500, 500, 500, 0, 0, 0, 1000, 0, 0, 3, 950, 1400, 1750, 0, 7, 7, 7, 0, 0},// USA sit-no circuit tone (2 cycle)
	{0, 0, 1, 500, 0, 0, 0, 500, 0, 0, 0, 0, 2, 480, 620, 0, 0, 7, 7, 0, 0, 0},			// USA busy tone
	{0, 0, 2, 500, 1000, 0, 0, 500, 1000, 0, 0, 0, 2, 330, 880, 0, 0, 7, 7, 0, 0, 0},	// tone with 2 cadence
	{0, 0, 1, 1000, 0, 0, 0, 1000, 0, 0, 0, 0, 2, 330, 660, 0, 0, 7, 7, 0, 0, 0},		// tone with 1 cadence
	{1, 0, 1, 2000, 0, 0, 0, 0, 0, 0, 0, 0, 2, 425, 25, 0, 0, 7, 7, 0, 0, 0}			// AUSTRALIA dial tone
...
int tone_main(int argc, char *argv[])
{
	...
	if (argc == 3)
	{
		switch (atoi(argv[1]))
		{
			...
			case 4:
				printf("Play OFF Hook Alert tone\n");
				rtk_SetPlayTone(0, 0, DSPCODEC_TONE_OFFHOOKWARNING, 1, 0);
				break;
