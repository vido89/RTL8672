...
/* DAA NUM and Type*/
#if defined (CONFIG_RTK_VOIP_DRIVERS_SI3050) && defined (CONFIG_RTK_VOIP_DRIVERS_FXO)
#if (DAA_CH_NUM == 1)
...
#endif
#elif defined (CONFIG_RTK_VOIP_DRIVERS_VIRTUAL_DAA) && defined (CONFIG_RTK_VOIP_DRIVERS_FXO)
...
#define RTK_VOIP_DAA_NUM(f)			((((f) & DAA_NUM_MASK) >> 28) + 1)
...
#define RTK_VOIP_CH_NUM(f)		((((f) & SLIC_NUM_MASK) >> 30) + 1)+((((f) & DAA_NUM_MASK) >> 28) + 1)*(((f)& DAA_TYPE_MASK) == REAL_DAA_NEGO)
...
#define DAA_NUM				((RTK_VOIP_DAA_FEATURE >> 28) + 1)
