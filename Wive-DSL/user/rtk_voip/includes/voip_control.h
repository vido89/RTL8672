...
#define VOIP_MGR_FLUSH_FIFO				VOIP_MGR_BASE_CTL+107
#define VOIP_MGR_LINE_CHECK				VOIP_MGR_BASE_CTL+108
#define VOIP_MGR_HOOK_FIFO_IN				VOIP_MGR_BASE_CTL+109
#define VOIP_MGR_FXO_ON_HOOK				VOIP_MGR_BASE_CTL+110
#define VOIP_MGR_FXO_OFF_HOOK				VOIP_MGR_BASE_CTL+111
#define VOIP_MGR_SET_PCM_LOOP_MODE			VOIP_MGR_BASE_CTL+112
//add by Tim
#define VOIP_MGR_SET_WAN_CLONE_MAC			VOIP_MGR_BASE_CTL+113
// gpio
#define VOIP_MGR_GPIO					VOIP_MGR_BASE_CTL+114

#define VOIP_MGR_SET_MAX				VOIP_MGR_BASE_CTL+120

#define VOIP_MGR_GET_EBL				VOIP_MGR_BASE_CTL+1
#define VOIP_MGR_GET_SESSION 				VOIP_MGR_BASE_CTL+2
#define VOIP_MGR_GET_MAX				VOIP_MGR_BASE_CTL+120
...
typedef struct {
	...
	unsigned int value;		// GPIO read/write:
