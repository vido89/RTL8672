...
#else
/*alex_huang change setting here */
	#if 1	
...
#ifndef ALEX_REMOVE_FORBULID	
	if(TRUE == bDirtyBit)
#ifdef CONFIG_RTK_VOIP_PACKAGE_8186
		mib_set(MIB_VOIP_CFG, (void*)pVoipConfig, sizeof(voipCfgParam_t));
#else
		mib_set(CWMP_VOIP, (void*)pVoipConfig);
#endif
#endif
	return 1;
}
...
/*alex_huang modify here for build */	
#ifndef ALEX_REMOVE_FORBULID
	if(TRUE == bDirtyBit)
#ifdef CONFIG_RTK_VOIP_PACKAGE_8186
		mib_set(MIB_VOIP_CFG, (void*)pVoipConfig, sizeof(voipCfgParam_t));
