...
void SetupMenuConfigAutoDialTimeFrame( int param )
{
	...
	/* Draw title */
	GS_TextOut( 0, 0, szInputAutoDialPrompt, RES_strlen( szInputAutoDialPrompt ) );
	GS_TextOut( VRAM_WIDTH_IN_TEXT_UNIT - RES_strlen( szInputAutoDialRange ), 1, szInputAutoDialRange, RES_strlen( szInputAutoDialRange ) );

	/* Activate editor */
	edit_params.nDefaultTextLength = 0;
	edit_params.pszDefaultText = NULL;
	edit_params.nMaxTextLength = TXT_LEN_AUTO_DIAL_TIME;
