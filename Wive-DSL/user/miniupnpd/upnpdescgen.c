/* $Id: upnpdescgen.c,v 1.12 2008/05/23 09:06:59 adsmt Exp $ */
/* MiniUPnP project
...
static const char * const upnptypes[] =
{
	"string",
	"boolean",
// For current version of  Intel Device Spy (1.3.2777.23551), you must set all types to string below in the "#if TR_064" block for compatibility.
// But for Windows XP Internet Gateway device, they should be keep in original types.
#ifdef TR_064
