/* $Id: miniupnpd.c,v 1.13 2008/11/24 09:05:25 adsmt Exp $ */
/* MiniUPnP project
...
#ifdef TR_064
#define DEFAULT_ADVR_EXPIRE 1209600
#else
...
void syn_extIP(int signum)
{
	...
	{
		syslog(LOG_ERR, "syn_extIP: Failed to get ip address for interface %s. EXITING",
			ext_if_name);
		return;
	}
...
#ifdef TR_064  // TR_064 variables initiation.
