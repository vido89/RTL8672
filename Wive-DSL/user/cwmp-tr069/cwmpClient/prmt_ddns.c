...
int getDDNSCount( unsigned char ifindex );
int getDDNS( unsigned char ifindex, int id, MIB_CE_DDNS_T *c );
int updateDDNS( unsigned char ifindex, int id, MIB_CE_DDNS_T *p );
int delDDNS( unsigned char ifindex, int id );
int delSpecficDDNS( unsigned char ifindex );
void modifyDDNSIfIndex( unsigned char old_id, unsigned char new_id );
