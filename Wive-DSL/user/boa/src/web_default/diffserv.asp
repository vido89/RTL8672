...
function writePhbRule()
{
	...
	for (var k = 1; k <= 5; k ++) {
		...
		for (var i = 0; i < rule; i ++) {
			...
			//document.writeln('\t<\% match_dscp("' + phbs[j].val + '"); \%>');
...
<body>
<blockquote>
<h2><font color="#0000FF">Differentiated Services</font></h2>

<table border=0 width=600 cellspacing=4 cellpadding=0>
<tr><td colspan=4><font size=2>
 Entries in this table are used to assign the precedence for each incoming packet
 based on TCP/UDP port number, source/destination IP address/subnet masks.
</font></td></tr>
<tr><td colspan=4><hr size=1 noshade align=top></td></tr>
</table>

<form action=/goform/formDiffServ method=POST name=diffserv>
...
<tr><td colspan=4><hr size=1 noshade align=top></td></tr>
<tr>
	<td><font size=2><b>Differentiated Services:</b></td>
	<td><font size=2>
		<input type="radio" name=qoscap value=0 onClick="return adminClick()">Disabled&nbsp;&nbsp;
		<input type="radio" name=qoscap value=1 onClick="return adminClick()">Enabled
	</td>
</tr>
<TBODY id='diffservSetting'>
<tr>
	<td><font size=2><b>PHB Groups:</b></td>
	...
	<td><font size=2><b>Rate Limit:</b></td>
...
<tr>
	...
	<td></td>
	<td><font size=2><b>Min:</b> 100Kb; <b>Max</b>: Total Bandwidth Limit - 100Kb</td>
</tr>
<tr>
	<td><font size=2><b>Total Bandwidth Limit:</b></td>
	<td><font size=2><input type="text" name="totalbandwidth" size="6" maxlength="6" value="1024">Kb</td>
</tr>
<tr>
	<td><font size=2><b>Max Desired Latency:</b></td>
...
<p><input type="submit" value="Apply Changes" name=addqos onClick="return addClick(this.form.phb)">
