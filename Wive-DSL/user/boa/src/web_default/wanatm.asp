...
<BODY>
<blockquote>
<h2><font color="#0000FF">ATM Settings</font></h2>

<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr><td><font size=2>
    This page is used to configure the parameters for the ATM of your ADSL
    Router. Here you may change the setting for VPI, VCI, QoS etc ...
</font></td></tr>
<tr><td><hr size=1 noshade align=top></td></tr>
</table>

<form action=/goform/formWanAtm method=POST name="formAtm">
<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr><td>
	...
	<p><input type="submit" value="Apply Changes" name="changeAtmVc" onClick="return addClick()">&nbsp;&nbsp;
