...
-->
      ...
      <td width="65%"><font size=2><input type="button" value="Set WEP Key" name="wepKey" onClick="wepKeyClick('/admin/wlwep.asp')">
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="65%"><font size="2">
        Port <input type="text" name="radiusPort" size="4" maxlength="5" value=<% getInfo("rsPort"); %>>&nbsp;&nbsp;
