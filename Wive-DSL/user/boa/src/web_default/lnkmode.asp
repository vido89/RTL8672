...
<table border=0 width=500 cellspacing=4 cellpadding=0>
  ...
  <tr>
      <td width="30%"><font size=2><b><% show_lan("0"); %>:</b></td>
      <td width="35%">
      	<select name=p0>
      		<script>
      			linkOption();
  ...
  <tr>
      <td width="30%"><font size=2><b><% show_lan("1"); %>:</b></td>
      <td width="35%">
      	<select name=p1>
      		<script>
      			linkOption();
  ...
  <tr>
      <td width="30%"><font size=2><b><% show_lan("2"); %>:</b></td>
      <td width="35%">
      	<select name=p2>
      		<script>
      			linkOption();
  ...
  <tr>
      <td width="30%"><font size=2><b><% show_lan("3"); %>:</b></td>
      <td width="35%">
      	<select name=p3>
      		<script>
      			linkOption();
  ...
  <br>
      ...
      <input type="hidden" value="/lnkmode.asp" name="submit-url">
<script>
	<% initPage("linkMode"); %>
</script>
</form>
