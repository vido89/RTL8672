...
<table border=0 width="500" cellspacing=4 cellpadding=0>
  ...
  <tr>
      ...
      <td width="70%"><font size=2>
      <input type="radio" name=enable value=0 <% checkWrite("tr069-inform-0"); %> onClick="return periodicSel()">Disabled&nbsp;&nbsp;
      <input type="radio" name=enable value=1 <% checkWrite("tr069-inform-1"); %> onClick="return periodicSel()">Enabled</td>
  </tr>
  <tr>
