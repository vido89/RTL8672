#!/bin/bash
#
# RCSID $Id: kernel.patch.gen.sh,v 1.1.1.1 2003/08/18 05:39:37 kaohj Exp $
...
echo found $i
echo "RCSID \$Id: kernel.patch.gen.sh,v 1.1.1.1 2003/08/18 05:39:37 kaohj Exp $" >$patchdir/$l
