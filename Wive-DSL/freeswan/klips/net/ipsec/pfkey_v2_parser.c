 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parser.c,v 1.1.1.1 2003/08/18 05:39:37 kaohj Exp $
 */
...
char pfkey_v2_parser_c_version[] = "$Id: pfkey_v2_parser.c,v 1.1.1.1 2003/08/18 05:39:37 kaohj Exp $";
