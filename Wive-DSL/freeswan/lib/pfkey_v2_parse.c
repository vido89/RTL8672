 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parse.c,v 1.1.1.1 2003/08/18 05:39:36 kaohj Exp $
 */
...
char pfkey_v2_parse_c_version[] = "$Id: pfkey_v2_parse.c,v 1.1.1.1 2003/08/18 05:39:36 kaohj Exp $";
