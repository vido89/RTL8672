 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_ext_bits.c,v 1.1.1.1 2003/08/18 05:39:36 kaohj Exp $
 */
...
char pfkey_v2_ext_bits_c_version[] = "$Id: pfkey_v2_ext_bits.c,v 1.1.1.1 2003/08/18 05:39:36 kaohj Exp $";
