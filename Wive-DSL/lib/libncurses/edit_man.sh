...
TERMINFO="/opt/Wive-DSL-2.6/lib/libncurses/filesystem/share/terminfo"

MKDIRS="sh /opt/Wive-DSL-2.6/lib/libncurses/mkdirs.sh"
...
*.[0-9]*)
	...
	if test ! -f /opt/Wive-DSL-2.6/lib/libncurses/man_alias.sed ; then
cat >>/opt/Wive-DSL-2.6/lib/libncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TPUT@,tput,
CF_EOF2
		echo "...made /opt/Wive-DSL-2.6/lib/libncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /opt/Wive-DSL-2.6/lib/libncurses/man_alias.sed | sort -u`
	...
	sed	-f /opt/Wive-DSL-2.6/lib/libncurses/man_alias.sed \
		< $i >$TMP
